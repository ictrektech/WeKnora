...
func NewRemoteChat(config *ChatConfig) (Chat, error) {
	...
	case api.APIOpenAICompletions:
		return withRemoteEndpointLimiterKey(openaicompletions.New(openaicompletions.Config{
			Endpoint:       endpoint,
			Settings:       resolved.OpenAICompletions,
			ThinkingLevels: resolved.ThinkingLevels,
			Reasoning:      resolved.Spec.Reasoning,
		}), resolved.BaseURL, resolved.RemoteModel), nil
	case api.APIOpenAIResponses:
		return withRemoteEndpointLimiterKey(openairesponses.New(openairesponses.Config{
			Endpoint:       endpoint,
	...
	case api.APIAnthropicMessages:
		return withRemoteEndpointLimiterKey(anthropicmessages.New(anthropicmessages.Config{
			Endpoint:       endpoint,
	...
	case api.APIGoogleGenerativeAI:
		return withRemoteEndpointLimiterKey(googlegenai.New(googlegenai.Config{
			Endpoint:       endpoint,
