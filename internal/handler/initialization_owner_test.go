...
func (s *stubInitializationKBService) CancelDisabledFeatureTasks(
	context.Context, *types.KnowledgeBase, bool, bool,
) error {
	return nil
}

func (s *stubInitializationKBService) RecoverEnabledMultimodalTasks(context.Context, *types.KnowledgeBase) (int, error) {
	return 0, nil
}
