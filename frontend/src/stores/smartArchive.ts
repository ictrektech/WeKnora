...
export const useSmartArchiveStore = defineStore('smartArchive', () => {
  ...
  return { documents, customers, reminders, reminderCandidates, notifications, settings, current, searchResult, searchPage, searchTotal, loading, importProgress, loadDocuments, refreshDocuments, loadSettings, loadDocument, upload, loadEntities, loadReminders, loadReminderCandidates, createReminderFromCandidate, loadNotifications, markNotificationRead, deleteNotification, search, refreshSearch, updateDocument, retryExtraction, retryMirror, archive, restore, deleteDocument, bulkAction, updateReminder, bulkDeleteReminders, bulkIgnoreReminderCandidates, connectBatch, disconnect }
})
