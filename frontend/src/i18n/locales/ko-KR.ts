export default {
  ...
  contractReview: {
    ...
    cancel: '취소',
    cancelReview: '검토 취소',
    cancelReviewConfirm: '이 계약 검토를 취소할까요? 중간 결과는 보존되며 나중에 다시 시도할 수 있습니다.',
    ...
    evidenceLocatorUnsupported: '안정적인 근거 위치를 제공하지 않아 신뢰할 수 있는 강조 표시를 사용하지 않습니다.',
    evidenceLocatorFailed: '근거 위치를 불러오지 못했습니다. 안정적인 강조 표시를 사용할 수 없습니다.',
    locateFailed: '조항을 찾지 못했습니다',
    resultTabs: '검토 결과 탭',
    errorDetailsUnavailable: '오류 세부 정보가 제공되지 않았습니다.',
    unknownRisk: '위험도 알 수 없음',
    summaryUnavailable: '개요를 사용할 수 없습니다. 발견된 문제의 세부 정보를 확인하세요.',
    qualityWarnings: '결과 확인 안내',
    summaryDetailsMismatch: '개요의 위험 수와 문제 세부 정보가 일치하지 않습니다.',
    issuesNotLoaded: '문제 세부 정보가 아직 로드되지 않아 문제가 없다고 확인할 수 없습니다.',
