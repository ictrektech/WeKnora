export default {
  smartArchive: {
    ...
    notificationUpdateFailed: "알림 상태를 업데이트하지 못했습니다.",
    notificationDeleteFailed: "알림을 삭제하지 못했습니다.",
    bulkDeleteReminders: "알림 일괄 삭제",
    bulkDeleteRemindersConfirm: "선택한 {count}개의 알림을 삭제하시겠습니까?",
    bulkDeleteRemindersActiveConfirm:
      "선택한 알림 중 {active}개가 예약되어 있습니다. 삭제하면 향후 알림이 즉시 중지됩니다. 계속하시겠습니까?",
    bulkDeleteRemindersSuccess: "{count}개의 알림을 삭제했습니다.",
    bulkIgnoreCandidates: "선택 항목 무시",
    bulkIgnoreCandidatesConfirm:
      "선택한 {count}개의 항목을 무시하시겠습니까? 알림은 생성되지 않지만 기록은 보존됩니다.",
    bulkIgnoreCandidatesSuccess: "{count}개의 항목을 무시했습니다.",
    eyebrow: "아카이브",
    title: "계약 스마트 아카이브",
    subtitle: "문서, 고객 정보와 중요한 날짜를 한곳에서 관리합니다.",
    importFiles: "파일 가져오기",
    importing: "가져오는 중",
    importStarted: "가져오기를 시작했습니다.",
    importFailed: "가져오기에 실패했습니다.",
    invalidFiles:
      "지원하지 않는 파일을 건너뛰었습니다. PDF, Word, Excel, JPG, PNG, WEBP를 지원합니다.",
    loading: "로드 중…",
    ...
    documentsDescription:
      "계약, 대여 계약, 출고 문서 및 원문 증거. 이미지 OCR을 지원합니다.",
    customers: "고객",
    customersDescription: "문서에서 정규화한 고객.",
    reminders: "알림",
    remindersDescription: "중요한 날짜를 확인한 뒤 알림을 만들고 활성화합니다.",
    candidatesTitle: "확인할 항목",
    candidatesDescription:
      "감지된 일정은 제안일 뿐이며 자동으로 알림을 만들지 않습니다.",
    noCandidates: "확인할 항목이 없습니다",
    candidateNeedsReview: "필드를 먼저 검토하세요",
    candidateReview: "알림 확인",
    createReminder: "알림 만들기",
    reminderCreated: "알림이 만들어졌습니다. 준비되면 활성화하세요.",
    offsetDays: "며칠 전",
    reminderTime: "알림 시간",
    assignee: "담당자",
    assigneeDefault: "기본 담당자",
    eventDate: "이벤트 날짜",
    suggestedReminderDate: "권장 알림 날짜",
    returnDue: "반납 예정일",
    cancel: "취소",
    reviewQueue: "검토 대기열",
    reviewQueueDescription: "확인이 필요한 필드와 문서 연결.",
    searchPlaceholder: "검색어나 협약 번호를 입력하세요",
    searchAction: "검색",
    dateFrom: "가져온 시작 날짜",
    dateTo: "가져온 종료 날짜",
    typeFilter: "문서 유형으로 필터링",
    allTypes: "전체 유형",
    allStatuses: "모든 상태",
    selectedStatuses: "상태 {count}/7",
    archiveView: "아카이브 범위",
    currentDocuments: "현재 문서",
    archivedDocuments: "보관 문서",
    showArchived: "보관 문서 표시",
    clearFilters: "필터 지우기",
    noMatchingDocuments: "필터와 일치하는 문서가 없습니다.",
    loadMore: "더 불러오기",
    loadedCount: "{loaded}/{total}개 로드됨",
    selectAll: "현재 목록 전체 선택",
    selectedCount: "{count}개 선택됨",
    bulkArchive: "선택 항목 보관",
    bulkRestore: "선택 항목 복원",
    bulkDelete: "영구 삭제",
    bulkArchiveConfirm: "선택한 문서 {count}개를 보관하시겠습니까?",
    bulkRestoreConfirm: "선택한 문서 {count}개를 복원하시겠습니까?",
    bulkDeleteConfirm:
      "선택한 문서 {count}개를 영구 삭제하시겠습니까? 복구할 수 없으며 관련 알림도 취소됩니다.",
    bulkActionSuccess: "문서 {count}개를 처리했습니다.",
    bulkActionPartial:
      "{succeeded}개 처리, {failed}개 실패했습니다. 목록을 새로 고쳐 확인하세요.",
    bulkActionFailed: "일괄 작업에 실패했습니다.",
    emptyDocuments: "문서가 없습니다",
    emptyDocumentsDescription:
      "PDF, Word, Excel, JPG, PNG 또는 WEBP를 가져오면 필드를 추출합니다.",
    noEntities: "기록 없음",
    noReminders: "만들어진 알림이 없습니다",
    notifications: "알림",
    markRead: "읽음 처리",
    refresh: "새로 고침",
    reidentify: "다시 인식",
    ...
    updated: "업데이트",
    archive: "보관",
    archiveConfirm: "“{name}”을 보관하시겠습니까?",
    archiveFailed: "아카이브를 보관하지 못했습니다.",
    restore: "복원",
    restoreConfirm: "“{name}”을 복원하시겠습니까?",
    restoreFailed: "아카이브를 복원하지 못했습니다.",
    delete: "삭제",
    ...
    activate: "활성화",
    handle: "처리 완료",
    reminderFailed: "알림을 업데이트하지 못했습니다.",
    queueEmpty: "검토 대기열이 비어 있습니다",
    queueEmptyDescription: "낮은 신뢰도 필드가 표시됩니다.",
    noVerifiedFields:
      "확인 가능한 필드가 없습니다. 다시 인식하거나 수동으로 검토하세요.",
    documentTypes: {
      contract: "계약",
      loan_agreement: "대여 계약",
      outbound_order: "출고",
      return_order: "반납",
      renewal: "갱신",
      payment: "지급",
  ...
  legalAssistant: {
    ...
    title: "법무 어시스턴트",
    homeGreeting:
      "안녕하세요, 저는 LexAI입니다. 오늘 어떤 법률 업무를 도와드릴까요?",
    description:
      "계약서, 법령, 내부 자료에서 근거를 빠르게 찾고 추적 가능한 법률 업무 답변을 만듭니다.",
    sessions: "법무 세션",
  ...
  legalWorkspaceSettings: {
    ...
    introDescription:
      "켜면 워크스페이스 구성원이 왼쪽 탐색에서 법률 워크스페이스를 열고 계약 검토를 사용할 수 있습니다.",
    enableLabel: "법률 워크스페이스 사용",
    enableDescription:
      "끄면 메뉴만 숨겨집니다. 계약 검토 기록과 업로드한 원문은 보존됩니다.",
    saveSuccess: "법률 워크스페이스 설정이 저장되었습니다",
    saveFailed: "법률 워크스페이스 설정을 저장하지 못했습니다: {message}",
    deleteTitle: "법률 워크스페이스 데이터 삭제",
    deleteDescription:
      "이 워크스페이스의 모든 계약 검토, 원문, 조항 및 결과를 영구적으로 삭제합니다. 되돌릴 수 없습니다.",
    deleteButton: "모든 데이터 삭제",
    deleteConfirmTitle: "법률 워크스페이스 데이터를 삭제할까요?",
    deleteConfirmBody:
      "현재 워크스페이스의 모든 계약 검토, 업로드한 원문, 조항 및 결과가 영구적으로 삭제되며 복구할 수 없습니다. 위의 사용 중지 전환은 데이터를 삭제하지 않습니다. 계속할지 확인하세요.",
  ...
  contractReview: {
    ...
    title: "계약 검토",
    subtitle: "계약서를 업로드하고 조항별 위험, 권고 사항과 근거를 확인하세요.",
    newReview: "새 검토",
    active: "진행 중",
    archived: "보관됨",
    document: "문서",
    ...
    noReviewsDescription: "계약서를 업로드해 첫 검토를 시작하세요.",
    noArchivedReviews: "보관된 검토가 없습니다",
    noArchivedDescription: "보관된 검토가 여기에 표시됩니다.",
    draftNoDocument: "업로드된 문서 없음",
    rename: "이름 변경",
    renamePrompt: "새 검토 제목을 입력하세요",
    archive: "보관",
    unarchive: "복원",
    delete: "삭제",
    deleteConfirm: "이 검토를 삭제할까요?",
    selectAll: "모두 선택",
    selectedCount: "{count}개 선택됨",
    bulkArchive: "선택 항목 보관",
    bulkRestore: "선택 항목 복원",
    bulkDelete: "선택 항목 삭제",
    bulkArchiveConfirm: "선택한 검토를 보관할까요?",
    bulkArchiveRunningConfirm: "실행 중인 검토가 있습니다. 그래도 보관할까요?",
    bulkRestoreConfirm: "선택한 검토를 복원할까요?",
    bulkDeleteConfirm: "선택한 검토를 삭제할까요?",
    bulkDeleteRunningConfirm: "실행 중인 검토가 있습니다. 그래도 삭제할까요?",
    bulkActionSuccess: "일괄 작업이 완료되었습니다",
    bulkActionPartial: "일부 항목만 업데이트되었습니다",
    bulkActionFailed: "일괄 작업에 실패했습니다",
    dropContract: "계약서를 여기에 놓으세요",
    uploadFormats: "PDF 또는 DOCX, 크기는 시스템 제한을 따릅니다",
    chooseFile: "파일 선택",
    singleDocument: "단일 문서",
    uploadingFile: "파일 업로드 중…",
    invalidFile: "PDF 또는 DOCX 파일을 선택하세요.",
    uploadFailed: "파일 업로드에 실패했습니다",
    aiReview: "AI 검토",
    reviewPanelTitle: "검토 결과",
    readyToReview: "문서 준비 완료",
    readyDescription: "검토 설정을 선택해 계약서를 분석하세요.",
    uploadFirst: "먼저 계약서를 업로드하세요",
    uploadFirstDescription:
      "검토를 시작하기 전에 PDF 또는 DOCX를 업로드하세요.",
    model: "검토 모델",
    useDefaultModel: "모델 자동 선택",
    noAvailableModels: "사용 가능한 KnowledgeQA 모델이 없습니다",
    modelUnavailable: "사용할 수 없음",
    modelsLoadFailed:
      "모델 목록을 불러오지 못했습니다. 기본 모델을 사용합니다.",
    playbook: "검토 규칙",
    representedParty: "대리 당사자",
    preparingDocument: "문서 준비 중…",
    startReview: "검토 시작",
    progressiveResults: "분석이 진행되면 결과가 순차적으로 표시됩니다.",
    reviewFailed: "검토 실패",
    retry: "다시 시도",
    reviewAgain: "다시 검토",
    reconfigureReview: "검토 설정 변경",
    reconfigureDescription:
      "대리 당사자, 규칙 또는 모델을 바꾼 후 다시 실행하세요.",
    cancel: "취소",
    cancelReview: "검토 취소",
    cancelReviewConfirm:
      "이 계약 검토를 취소할까요? 중간 결과는 보존되며 나중에 다시 시도할 수 있습니다.",
    cancelReviewSuccess: "검토가 취소되었습니다",
    cancelReviewFailed: "검토를 취소하지 못했습니다",
    reviewCancelled: "검토가 취소되었습니다",
    configureModel: "모델 설정",
    overallRisk: "전체 위험도",
    overviewPending: "검토가 완료되면 개요가 표시됩니다.",
    contractType: "계약 유형",
    keyRecommendations: "주요 권고 사항",
    priorityFocus: "우선 확인",
    ...
    zoomOut: "축소",
    zoomIn: "확대",
    loadingDocument: "문서 불러오는 중…",
    documentContent: "계약서 원문",
    retryDocument: "문서 다시 불러오기",
    documentLoadFailed: "문서를 불러오지 못했습니다",
    unsupportedDocumentType: "지원하지 않는 문서 형식입니다",
    loadingEvidenceLocator: "안정적인 근거 위치를 불러오는 중…",
    retryEvidenceLocator: "근거 위치 다시 시도",
    evidenceLocatorUnsupported:
      "안정적인 근거 위치를 제공하지 않아 신뢰할 수 있는 강조 표시를 사용하지 않습니다.",
    evidenceLocatorFailed:
      "근거 위치를 불러오지 못했습니다. 안정적인 강조 표시를 사용할 수 없습니다.",
    locateFailed: "조항을 찾지 못했습니다",
    resultTabs: "검토 결과 탭",
    errorDetailsUnavailable: "오류 세부 정보가 제공되지 않았습니다.",
    unknownRisk: "위험도 알 수 없음",
    summaryUnavailable:
      "개요를 사용할 수 없습니다. 발견된 문제의 세부 정보를 확인하세요.",
    qualityWarnings: "결과 확인 안내",
    summaryDetailsMismatch:
      "개요의 위험 수와 문제 세부 정보가 일치하지 않습니다.",
    issuesNotLoaded:
      "문제 세부 정보가 아직 로드되지 않아 문제가 없다고 확인할 수 없습니다.",
    summaryMissing: "검토가 완료되었지만 개요 요약이 제공되지 않았습니다.",
    detectedParties: "식별된 당사자",
    facts: "주요 사실",
    sourceRevision: "원문 버전",
    category: "문제 분류",
    findingType: "문제 유형",
    confidence: "신뢰도",
    evidenceRefs: "근거 {count}개",
    evidenceStatus: "근거 위치",
    evidenceQuote: "원문 근거",
    noEvidenceQuote: "원문 근거가 제공되지 않았습니다.",
    noSuggestionDetails: "수정 제안이 제공되지 않았습니다.",
    quality: {
      complete: "완전함",
      partial: "부분적으로 완전함",
      inconsistent: "확인 필요",
    ...
    categories: {
      ...
      parties: "당사자",
      payment: "지급",
      delivery_acceptance: "인도 및 검수",
      acceptance: "인도 및 검수",
      liability_remedies: "책임 및 구제",
      liability: "책임 및 구제",
      term_termination: "기간 및 종료",
      term: "기간 및 종료",
      ip_confidentiality: "지식재산 및 기밀유지",
      intellectual_property: "지식재산",
      privacy_security: "개인정보 및 보안",
      data_security: "데이터 및 보안",
      guarantee: "이행 보증",
    ...
    findingTypes: {
      ...
      missing: "누락",
      ambiguous_language: "모호한 표현",
      ambiguity: "모호함",
      one_sided_term: "일방적 조항",
      excessive_exposure: "과도한 위험 노출",
      conflicting_term: "조항 충돌",
      contradiction: "모순",
      missing_definition: "정의 누락",
    ...
    loadFailed: "불러오기 실패",
    createFailed: "검토를 만들지 못했습니다",
    saveFailed: "저장 실패",
    startFailed: "검토를 시작하지 못했습니다",
  ...
  localBrowser: {
    ...
    pauseHint:
      "브라우저 작업을 중단하고 재개할 수 있도록 페이지를 유지합니다. 대화는 중단하지 않습니다.",
    stopHint:
      "이 작업에서 만든 탭을 닫고 빌린 탭을 반환합니다. 브라우저와 페어링은 유지합니다.",
    openPage: "페이지 열기",
    switchPage: "페이지 전환",
    readPage: "페이지 확인",
    listTabs: "탭 목록",
    ...
    invalidArguments:
      "브라우저 도구 인수가 잘못되었거나 불완전합니다. 에이전트가 수정해야 합니다.",
    commandInterrupted:
      "작업이 중단되었습니다. 페이지를 확인한 뒤 미리보기에서 재개하세요.",
    actionFailedHint:
      "브라우저 작업이 완료되지 않았습니다. 페이지를 확인하고 다시 시도하세요.",
    previewStale: "화면이 갱신되지 않음",
    previewIdle: "마지막 화면 유지 중",
    previewLive: "화면 동기화 중",
    previewLoading: "화면 가져오는 중",
    helpHint:
      "인증 또는 권한 승인이 필요합니다. 미리보기를 클릭하여 이동하세요.",
    settingsTitle: "브라우저 연결",
    settingsDescription:
      "BrowserSkill로 내 Chrome을 연결하면 대화에서 실제 웹페이지를 조작할 수 있습니다.",
    openSettings: "연결 설정 열기",
    settingsHint:
      "개인 설정에서 BrowserSkill을 연결하면 로컬 브라우저를 사용할 수 있습니다.",
    unavailable:
      "서버에서 로컬 브라우저가 활성화되지 않았습니다. 관리자에게 문의하세요.",
    source: "브라우저 연결 대상",
    sandbox: "샌드박스 브라우저",
    local: "로컬 브라우저",
    paused: "일시 중지됨",
    ...
    copied: "복사됨",
    windowHint:
      "작업은 표시된 탭 그룹에서 실행됩니다. 기존 탭에는 권한이 필요합니다.",
    ...
    reconnectHint:
      "인증이 저장되어 있습니다. Chrome과 확장 프로그램을 열면 자동으로 다시 연결됩니다.",
    ...
    pairBrowser: "브라우저 연결",
    packageUnavailable:
      "관리자에게 호환되는 확장 프로그램 패키지를 요청하세요.",
    manualCopy: "아래 링크를 복사하세요. 5분 동안 한 번만 사용할 수 있습니다.",
    pairingReady:
      "복사되었습니다. 5분 안에 확장 프로그램에 붙여넣으세요. 한 번만 사용할 수 있습니다.",
    copyAgain: "다시 복사",
    usageTitle: "사용 방법",
    usageStep1Title: "확장 프로그램 설치",
    usageStep1Text:
      "확장 압축을 풀고 Chrome 확장 프로그램 페이지에서 개발자 모드를 켜 로드하세요.",
    usageStep2Title: "브라우저 연결",
    usageStep2Text:
      "페어링 링크를 복사해 확장 프로그램의 원격 연결에 붙여넣고 서버를 확인하세요. 한 번 연결하면 공간 내 모든 대화에서 공유됩니다.",
    usageStep3Title: "대화에서 작업 요청",
    usageStep3Text:
      "입력창에서 로컬 브라우저를 켜고 웹 작업을 요청하세요. 표시된 탭 그룹에서 실행됩니다.",
    usageStep4Title: "미리보기로 확인하고 이어가기",
    usageStep4Text:
      "대화에 작은 미리보기가 나타납니다. 클릭하면 작업 탭으로 이동합니다. 중단된 작업은 다시 연결해도 일시정지 상태이므로 미리보기에서 계속하세요. 기존 탭에는 권한이 필요합니다.",
    running: "실행 중",
  ...
  chatHeader: {
    ...
    clearConfirmBody:
      "현재 대화의 모든 메시지를 지울까요? 대화는 유지되지만 복구할 수 없습니다.",
    deleteConfirmTitle: "대화 삭제",
    deleteConfirmBody:
      "현재 대화를 삭제할까요? 삭제 후에는 복구할 수 없습니다.",
  ...
  contextualGuide: {
    ...
    tenantModels: {
      needChatModelFirst:
        "에이전트를 만들기 전에 대화 모델(KnowledgeQA)을 추가하세요.",
      steps: {
        intro: {
          title: "먼저 모델을 구성하세요",
  ...
  batchManage: {
    ...
    deleteConfirmTitle: "대화 삭제",
    deleteConfirmBody:
      "선택한 {count}개의 대화를 삭제하시겠습니까? 삭제 후 복구할 수 없습니다.",
    deleteAllConfirmBody:
      "모든 대화를 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.",
    deleteSuccess: "삭제 성공",
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      rootRow: "루트",
      rootRowTip:
        "지식 베이스 루트 디렉터리, 하위 폴더에 없는 문서가 여기에 있습니다",
    ...
    videosFilteredNoVLM:
      "{count}개의 동영상 파일을 건너됨 (동영상 업로드 미지원)",
    unsupportedTypesHint:
      "일부 문서 유형({types})에 사용 가능한 파서 엔진이 없어 처리할 수 없습니다",
    ...
    metadataCapabilityHint:
      "문서 요약과 검색 후 문서 수준 답변 컨텍스트에 사용됩니다. 인덱스에 포함되지 않으며 검색 순위에 영향을 주지 않습니다",
    ...
    summaryRefreshQueued:
      "요약 새로고침이 대기열에 추가되었으며 완료되면 자동으로 업데이트됩니다",
    indexFailed: "인덱스 동기화 실패",
    chunkSavedIndexFailed:
      "내용은 저장되었지만 인덱스 동기화에 실패했습니다. 인덱스 재시도를 사용하세요.",
    chunkEditConflict:
      "다른 사용자가 이 청크를 수정했습니다. 목록을 새로고침했으니 다시 시도하세요.",
    retryIndex: "인덱스 재시도",
    ...
    revertRevisionConfirm:
      "v{revision}(으)로 되돌리시겠습니까? 새 버전이 생성됩니다.",
    ...
    staleGeneratedQuestions:
      "이전 콘텐츠를 기준으로 생성된 질문입니다. 필요하면 다시 생성하세요",
    ...
    rebuildConfirm:
      '문서 "{fileName}"을(를) 재구축하시겠습니까? 기존 청크가 삭제되고 다시 파싱됩니다.',
    ...
    cancelParseConfirmBody:
      '"{title}"의 파싱을 중지하시겠습니까? 이미 저장된 청크는 유지되며 "다시 빌드"를 통해 다시 파싱할 수 있습니다. 최적화 단계(요약 / Q&A / 지식 그래프)의 대기 중인 작업은 즉시 취소됩니다.',
    ...
    moveNoTargets:
      "호환되는 지식베이스가 없습니다 (동일한 유형과 임베딩 모델 필요)",
    moveModeReuseVectors: "벡터 재사용 (빠름)",
    moveModeReuseVectorsDesc:
      "청크와 벡터 인덱스를 직접 이동합니다. 청킹 설정이 동일할 때 사용합니다.",
    moveModeReparse: "재해석",
    moveModeReparseDesc:
      "대상 지식베이스의 청킹 설정으로 문서를 다시 해석합니다.",
    moveConfirm: "이동 확인",
    ...
    batchDelete: "선택 삭제",
    batchDownload: "선택 항목 다운로드",
    batchDownloading: "다운로드 준비 중…",
    batchDownloadHint:
      "한 번에 최대 200개 문서, 원본 합계 512 MiB를 ZIP으로 다운로드합니다. 전체 선택은 불러온 문서만 포함하며, 원본이 없는 웹 페이지는 건너뜁니다. ZIP은 폴더 구조를 유지합니다.",
    batchDownloadStarted:
      "ZIP 저장을 시작했습니다. 압축을 푼 후 파일과 폴더를 업로드하세요.",
    ...
    batchDownloadTooLarge:
      "선택한 파일 합계가 512 MiB를 초과합니다. 항목을 줄인 뒤 나눠 다운로드하세요.",
    selectLoaded: "불러온 문서 선택",
    confirmBatchDeleteDocument:
      "선택한 {count}개 문서를 삭제하시겠습니까? 삭제 후 복구할 수 없습니다.",
    deleteSubmitted: "삭제 요청이 제출되었습니다. 완료를 기다리는 중입니다.",
    deletePending:
      "삭제가 아직 완료되지 않았습니다. 잠시 후 새로고침하여 결과를 확인하세요.",
    deleteTaskFailed:
      "삭제에 실패했습니다. 문서의 오류 세부 정보를 확인한 후 다시 시도하세요.",
    deleteStatusUnavailable:
      "삭제 결과를 확인할 수 없습니다. 잠시 후 새로고침하여 문서 상태를 확인하세요.",
    ...
    reparseFailedDocumentsSuccess:
      "실패한 문서 {count}개를 다시 처리하도록 제출했습니다",
    ...
    batchTagSubtitle:
      "선택한 {count}개 문서에 태그를 일괄 설정합니다 (기존 태그는 대체됩니다)",
    ...
    confirmBatchReparseDocument:
      "선택한 {count}개 문서를 재구축하시겠습니까? 기존 내용이 삭제되고 각 문서가 다시 파싱됩니다.",
    ...
    operationNotSupportedForType:
      "현재 지식베이스 유형에서는 이 작업을 지원하지 않습니다",
    allFilesSkippedNoEngine:
      "선택한 모든 파일이 사용 가능한 파싱 엔진이 없어 건너뛰었습니다",
    filesSkippedNoEngine:
      "{count}개 파일이 사용 가능한 파싱 엔진이 없어 건너뛰었습니다",
    allUploadSuccess: "모든 파일 업로드 성공 ({count}개)",
    partialUploadSuccess:
      "일부 파일 업로드 성공 (성공: {success}, 실패: {fail})",
  ...
  uploadConfirm: {
    ...
    tabTags: "문서 태그",
    tagsDescription:
      "이 배치로 가져오는 모든 문서에 적용할 태그를 여러 개 선택할 수 있습니다",
    tagsPlaceholder: "태그 선택(복수 선택 가능)",
    tagsEmpty:
      "현재 지식 베이스에 태그가 없습니다. 업로드 후 태그 관리에서 만들 수 있습니다.",
    tagsLoadFailed:
      "태그를 불러오지 못했습니다. 나중에 문서 목록에서 설정할 수 있습니다.",
    ...
    multimodalSetupHint:
      "이미지가 포함되어 있습니다. 멀티모달을 활성화하고 모델을 선택하세요",
    asrSetupHint:
      "오디오가 포함되어 있습니다. 음성 인식을 활성화하고 모델을 선택하세요",
    vlmModelRequired: "멀티모달 모델을 설정하세요",
    asrModelRequired: "음성 인식 모델을 설정하세요",
    vlmModelSelectRequired:
      "멀티모달이 활성화되었습니다. VLM 모델을 선택하세요",
    asrModelSelectRequired:
      "음성 인식이 활성화되었습니다. ASR 모델을 선택하세요",
    pdfForceScanned: {
      label: "스캔 PDF로 파싱",
      description:
        "웹 인쇄, 스캔본, 이미지 위주 PDF에 적합합니다. 모든 페이지를 이미지로 렌더링한 뒤 OCR/VLM으로 처리합니다. 처리 시간과 모델 호출 비용이 늘어날 수 있습니다.",
    },
    continueAdd: "계속 추가",
  ...
  knowledgeStages: {
    ...
    rowSelectHint:
      "클릭하여 세부 정보 보기, 왼쪽 화살표로 하위 항목 펼치기/접기",
    ...
    head: {
      ...
      postprocessTasks:
        "후처리: 실행 중 {running} / 실패 {failed} / 완료 {completed}",
      completedWithActiveTrace:
        "처리는 완료되었지만 {n}개의 Trace 작업이 아직 활성 상태입니다",
      attempt: "시도",
      updated: "갱신",
    },
    tab: {
    ...
    detail: {
      ...
      metadataHint:
        "Langfuse trace ID 등 관측용 보조 필드입니다. 단계별 입출력은 입력/출력 탭에서 확인하세요.",
      metadataEmpty:
        "이 span에는 메타데이터가 없습니다. 단계 입출력은 입력/출력 탭을, Langfuse trace 필드는 개요 탭을 확인하세요.",
      error: "오류",
      empty: "데이터 없음",
      inProgress: "진행 중",
      elapsed: "경과",
      placeholderHint:
        "이 단계에는 상세한 span 기록이 없으며, 추정된 상태만 표시됩니다.",
      showJson: "JSON 펼치기",
      hideJson: "JSON 접기",
  ...
  agent: {
    ...
    empty: {
      ...
      description:
        "첫 번째 에이전트를 생성하려면 오른쪽 상단에 있는 버튼을 클릭하세요.",
    ...
    delete: {
      ...
      confirmMessage:
        '"{name}" 에이전트를 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
      confirmButton: "삭제 확인",
    },
    messages: {
    ...
    editor: {
      ...
      postCreateHint: {
        title: "생성 완료",
        footer:
          '설정을 계속 조정하고 공유·배포 채널을 구성한 뒤 "저장 후 닫기"를 클릭하세요.',
        integrationDesc:
          "통합 센터에서 IM, 웹 임베드 등 배포 채널을 설정하세요",
      },
      basicInfo: "기본정보",
      ...
      knowledgeConfigDesc:
        "에이전트가 액세스할 수 있는 지식베이스 범위 및 FAQ 전략 구성",
      ...
      queryMissingInFallback:
        "폴백 프롬프트에는 {'{{'}query{'}}'} 플레이스홀더가 포함되어야 합니다.",
      description: "설명",
      ...
      citationEnabledDesc:
        "최종 답변에 지식베이스와 웹 출처를 표시합니다. 꺼도 검색과 근거 활용은 계속 작동합니다.",
      mode: "작동 모드",
      webSearch: "웹 검색",
      ...
      rerankModel: "리랭크 모델",
      rerankModelDesc:
        "지식베이스 검색 결과를 재정렬하여 답변 정확도를 높입니다",
      rerankModelPlaceholder: "ReRank 모델을 선택하세요.",
      rerankModelOptionalHint:
        "현재 범위에 RAG 유형의 지식베이스가 없으므로 선택 사항입니다. 이후 RAG 지식베이스가 추가되면 워크스페이스 기본 ReRank 모델로 자동 폴백되지만, 명시적으로 설정하는 것을 권장합니다.",
      ...
      fallbackResponsePlaceholder:
        "죄송합니다. 이 질문에는 답변해 드릴 수 없습니다.",
      fallbackPrompt: "폴백 프롬프트",
      fallbackPromptPlaceholder:
        "시스템 기본 프롬프트를 사용하려면 비워 두세요.",
      skillsConfig: "스킬",
      skillsConfigDesc:
        "먼저 실행 샌드박스를 선택한 뒤 아래 목록에서 스킬을 고르세요. 해당 샌드박스에 없는 스킬은 「설치」가 보이며, 설치한 뒤에만 선택할 수 있습니다.",
      skillsSelection: "스킬 목록",
      skillsSelectionDesc:
        "워크스페이스 카탈로그의 스킬이 모두 표시됩니다. 이 샌드박스에 설치된 것은 바로 쓸 수 있고, 나머지는 먼저 「설치」해야 합니다.",
      skillsAll: "전체",
      skillsSelected: "지정",
      skillsNone: "비활성화",
      selectSkillsDesc:
        "이 에이전트에서 쓸 스킬을 선택하세요. 설치되지 않은 스킬은 선택할 수 없으며, 오른쪽 「설치」를 먼저 누르세요.",
      skillsAllListHint:
        "「전체」에는 이 샌드박스에 이미 설치된 스킬만 포함됩니다. 설치되지 않은 스킬은 「설치」한 뒤에야 포함됩니다.",
      ...
      sandboxNoConfigs:
        "이 워크스페이스에 샌드박스가 없어 스킬 스크립트가 실행되지 않습니다.",
      selectSkills: "스킬 선택",
      skillsInfoTitle: "스킬과 샌드박스는 어떻게 연동되나요?",
      skillsInfoContent:
        "스킬은 사전 설치된 전문 지식 모듈이며, 스크립트는 선택한 샌드박스에서 격리 실행됩니다. 목록은 해당 샌드박스에 설치된 스킬에서 가져옵니다. 세션 샌드박스가 한 번 만들어지면 첨부 파일, 산출물, 회수는 그 설정에 고정되며, 여기서 바꾸면 이후에 새로 만들어지는 세션에만 영향을 줍니다.",
    },
    selector: {
      title: "에이전트 선택",
      current: "현재 선택",
  ...
  settings: {
    ...
    autoCheckUpdateDesc:
      "활성화하면 시작 시 최신 버전을 자동으로 확인하고 백그라운드에서 다운로드합니다.",
    ...
    sandbox: {
      title: "샌드박스 설정",
      description:
        "에이전트 스킬 스크립트의 격리 실행 환경을 구성합니다. 각 에이전트는 설정을 하나 선택합니다.",
      pageHintTitle: "샌드박스란?",
      pageHint:
        "샌드박스는 에이전트 스킬 스크립트가 실행되는 격리 환경입니다. 워크스페이스에 Docker, E2B, CubeSandbox 설정을 여러 개 둘 수 있고, 각 에이전트가 하나를 선택합니다. 스킬은 「스킬 관리」 페이지에서 선택한 설정의 이미지에 설치됩니다. 선택하지 않으면 스크립트는 실행되지 않습니다.",
      editorDescription:
      ...
      scriptPolicyDesc:
        "끄면 이 워크스페이스의 에이전트는 스킬 내용만 읽을 수 있습니다. 이미 실행 중인 원격 샌드박스는 해당 세션이 종료된 후 해제됩니다.",
      backendDescriptions: {
        ...
        docker:
          "이 WeKnora 호스트의 Docker에서 세션마다 장수명 컨테이너를 유지합니다. 스크립트와 파일이 같은 컨테이너에 남습니다",
      },
      dockerDisabledAlert: "이 배포에서는 Docker 샌드박스가 켜져 있지 않습니다",
      dockerDisabledHint:
        "로컬 docker.sock은 호스트 root와 같습니다. 단일 머신 프라이빗 설치에서는 시스템 관리자가 설정 → 시스템 설정 → 네트워크 보안에서 켤 수 있습니다.",
      dockerDisabledCard:
        "이 배포에서 Docker 샌드박스가 꺼져 있어 이 구성은 컨테이너를 만들지 않습니다",
      dockerHostRisk:
        "비우거나 unix:// 를 쓰면 WeKnora가 있는 머신의 Docker 데몬을 사용하며, 그 권한은 해당 머신의 root와 같습니다. 프라이빗 단일 노드에만 쓰세요. 여러 워크스페이스가 같은 호스트를 쓰는 경우에는 Cube 또는 E2B를 쓰세요. 원격 tcp:// 는 TLS 인증서 디렉터리가 필요합니다.",
      addConfig: "샌드박스 추가",
      ...
      noConfigs:
        "아직 샌드박스가 없습니다. 워크스페이스 설정을 선택하지 않은 에이전트는 스킬 스크립트를 실행하지 않습니다.",
      identityFieldHint:
      ...
      connectionLockedBySkills:
        "이 샌드박스에는 이미 Skill이 있습니다. 연결, 자격 증명, DNS를 바꾸면 스킬 스냅샷의 환경이 달라지고, DNS는 템플릿을 재구축해야 적용됩니다. 새 샌드박스를 만드세요.",
      connectionLockedByInFlight:
        "Skill을 설치하거나 제거하는 중입니다. 끝날 때까지 연결, 자격 증명, DNS를 바꿀 수 없습니다.",
      viewSandboxes: "실행 인스턴스",
      inventoryTitle: "실행 인스턴스",
      inventoryDrawerDesc:
        "이 설정이 아직 점유한 샌드박스와 영향을 받는 세션·에이전트입니다.",
      ...
      confirmDeleteWithAgents:
        '샌드박스 "{name}"을(를) 삭제할까요? {agents}다음 스킬 실행에서 실패합니다.',
      ...
      templateLoadHint:
        "클러스터 연결을 입력한 뒤 새로고침하세요. WeKnora 표준 템플릿이 없으면 「만들기」를, DNS나 이미지를 바꾼 뒤에는 「삭제 후 재구축」을 누르세요.",
      ...
      standardTemplateReplaced:
        "기존 표준 템플릿을 삭제했고 재구축을 시작했습니다. 준비될 때까지 기다리세요.",
      templateNotReady:
      ...
      templateStepHint:
        "이 단계에서는 클러스터에 이미 있는 템플릿만 나열하며 자동으로 만들지 않습니다. 표준 템플릿이 없으면 「WeKnora 표준 템플릿 만들기」를, DNS나 이미지를 바꾼 뒤에는 「삭제 후 재구축」을 누르세요. 템플릿이 준비된 뒤에 계속할 수 있습니다.",
      loadingTemplates: "Loading templates from the cluster...",
      templateBuildingHint:
        "표준 템플릿을 구축하는 중입니다. 목록이 자동으로 새로고침됩니다.",
      templateUntaggedHint:
        "빌드는 끝났지만 default 태그가 붙은 빌드가 없어 샌드박스 생성 시 이 템플릿을 찾을 수 없습니다. E2B에서 템플릿을 삭제하고 새로고침하면 WeKnora가 다시 빌드합니다.",
      ...
      createStandardTemplateHint:
        "현재 연결 설정(DNS 포함)으로 구축합니다. 설정을 바꾼 뒤에는 카드에서 재구축하세요.",
      weknoraDesktopTemplate: "WeKnora 데스크톱 템플릿",
      createDesktopTemplate: "만들기",
      createDesktopTemplateHint:
        "공식 데스크톱 이미지로 XFCE 그래픽 데스크톱을 구축합니다. CLI 템플릿보다 훨씬 크니 GUI가 필요할 때만 만드세요.",
      replaceStandardTemplate: "재구축",
      replaceStandardTemplateConfirm:
        "현재 설정(DNS 포함)으로 WeKnora 표준 템플릿을 다시 만듭니다. 새 템플릿이 준비되기 전에는 기존에 쓸 수 있는 템플릿을 삭제하지 않습니다.",
      desktopTemplateProvisioning:
        "WeKnora 데스크톱 템플릿을 만들고 있습니다. 잠시 후 새로고침해 상태를 확인하세요.",
      desktopTemplateReplaced:
        "기존 데스크톱 템플릿을 삭제했고 재구축을 시작했습니다. 준비될 때까지 기다리세요. CLI 템플릿은 그대로 둡니다.",
      desktopTemplateTag: "데스크톱",
      replaceDesktopTemplateConfirm:
        "현재 설정(DNS 포함)으로 WeKnora 데스크톱 템플릿을 다시 만듭니다. 새 템플릿이 준비되기 전에는 기존에 쓸 수 있는 데스크톱 템플릿을 삭제하지 않으며, CLI 템플릿은 그대로 둡니다.",
      templateLockedBySkills:
        "이 샌드박스에는 이미 Skill이 설치되어 있습니다. 스킬 환경이 현재 스냅샷에 묶여 있어 런타임 템플릿을 바꾸거나 재구축할 수 없습니다. 새 샌드박스를 만들고 새 템플릿에서 Skill을 다시 설치하세요.",
      templateLockedByInFlight:
        "Skill을 설치하거나 제거하는 중입니다. 끝날 때까지 런타임 템플릿을 바꾸거나 재구축할 수 없습니다.",
      ...
      cubeDnsServersHelp:
        "선택 사항입니다. WeKnora 표준 템플릿에 기록되는 nameserver IP입니다. 비워 두면 클러스터 기본값(보통 119.29.29.29)을 사용합니다. 공용 DNS로 UDP/53이 나가지 않으면 Cube 호스트 /etc/resolv.conf에서 도달 가능한 주소를 넣고, 10/8, 172.16/12, 192.168/16은 피하세요. 이미 있는 표준 템플릿은 카드에서 「재구축」을 눌러야 변경이 적용됩니다.",
      cubeDnsServersPlaceholder: "예: 8.8.8.8, Enter로 추가",
      e2bApiKeyHelp:
        "E2B 대시보드의 API Keys 페이지에서 생성하며 보통 e2b_ 로 시작합니다.",
      e2bApiKeyWhere: "E2B 대시보드에서 API 키 발급받기",
      apiKeyPlaceholder: "API 키를 붙여넣으세요",
      secretConfigured:
        "키가 설정되어 있습니다(다시 표시되지 않음). 새 값을 입력하면 교체됩니다",
      ...
      httpTimeoutHelp:
        "백엔드 관리 API 호출을 기다리는 상한입니다. 초과하면 엔드포인트를 사용할 수 없는 것으로 간주합니다. 비워 두면 30초입니다.",
      ...
      defaultTimeoutHelp:
        "스킬 스크립트 한 번이 실행될 수 있는 최대 시간이며, 초과하면 강제 종료됩니다. 비워 두면 60초입니다.",
      terminalIdleDisconnect: "터미널 유휴 해제 (초)",
      terminalIdleDisconnectHelp:
        "터미널을 연 뒤 키보드 입력이나 PTY 출력이 이 시간 동안 없으면 연결을 끊어 샌드박스가 TTL에 따라 일시 중지되도록 합니다. 비워 두면 900초이며, 최소 60초, 최대 24시간입니다.",
      ...
      recheck: "다시 검증",
      deepCheckIntro:
        "전체 검증은 임시 샌드박스를 만들어 스크립트를 실행하고 외부 통신까지 확인한 뒤 삭제합니다.",
      deepCheckConfirm:
      ...
      checkScopeConnection:
        "이번에는 컨트롤 플레인만 확인했습니다. 엔드포인트는 응답하고 자격 증명도 유효하지만, 스크립트가 실제로 실행되는지는 아직 확인되지 않았습니다.",
      checkScopeFull:
        "엔드포인트, 자격 증명, 템플릿, 샌드박스 내 실행, 외부 통신까지 모두 실제로 검증했습니다.",
      checkScopePolicyRestricted:
        "네트워크 정책으로 외부 통신이 제한되어 외부 연결은 실제로 확인하지 않았습니다. 엔드포인트, 자격 증명, 템플릿, 샌드박스 내 실행은 검증했습니다.",
      checkPendingHint:
        "{names}은(는) 전체 검증으로만 확인할 수 있습니다. 임시 샌드박스를 실제로 만들어 스크립트를 한 번 실행한 뒤 삭제합니다.",
      skipReasons: {
        ...
        egress_restricted_by_policy:
          "네트워크 정책에 의해 제한됨(이 구성은 기본적으로 외부 통신을 차단함)",
      },
      checks: {
      ...
      skillRolloutHint:
        "스킬을 설치하거나 삭제하면 새 이미지가 만들어집니다. 이미 열린 세션을 새 이미지로 바꿀지 여기서 정합니다.",
      skillRolloutNextTurn:
        "이미 열린 세션은 다음 대화 턴에서 샌드박스를 다시 만듭니다",
      skillRolloutNewSession:
        "이미 열린 세션은 기존 샌드박스를 유지하고, 새 세션만 새 이미지를 사용합니다",
      ...
      skillUploadHint:
        "설치하면 현재 이미지에 스킬을 쓰고 새 스냅샷을 만듭니다. 몇 분이 걸릴 수 있습니다. 현재 대화 턴은 중단되지 않으며, 이미 열린 세션은 다음 턴에서 새 이미지로 샌드박스를 다시 만들고 그때 세션 작업 공간 초안이 지워집니다.",
      skillUploadHintNewSession:
        "설치하면 현재 이미지에 스킬을 쓰고 새 스냅샷을 만듭니다. 몇 분이 걸릴 수 있습니다. 이미 열린 세션은 세션이 끝날 때까지 기존 샌드박스를 유지하며, 이번에 설치한 스킬은 새로 시작한 세션에만 적용됩니다.",
      skillSourceSection: "소스에서 설치",
      skillSourceSectionHint:
        "ClawHub, GitHub 또는 SkillHub 링크, 혹은 {'@'}owner/slug를 붙여넣으세요. 압축 파일은 {size} MB를 넘을 수 없습니다.",
      skillUploadSection: "로컬 번들 업로드",
      skillUploadSectionHint:
        "SKILL.md가 포함된 zip을 아래로 끌어다 놓거나 클릭해서 선택하세요. 압축 파일은 {size} MB를 넘을 수 없습니다.",
      skillSourcePlaceholder:
        "ClawHub는 {'@'}owner/slug, GitHub/SkillHub는 전체 URL을 붙여넣으세요",
      ...
      skillBundleTooManyFiles:
        "스킬 디렉터리의 파일은 {count}개를 넘을 수 없습니다.",
      skillBundleTooManyZipEntries:
        "압축 파일 항목은 {count}개를 넘을 수 없습니다.",
      ...
      skillDeleteHint:
        "삭제하면 이미지에서 스킬 디렉터리를 제거하고 새 스냅샷을 만듭니다. 현재 대화 턴은 중단되지 않으며, 이미 열린 세션은 다음 턴에서 새 이미지로 샌드박스를 다시 만들고 그때 세션 작업 공간 초안이 지워집니다.",
      skillDeleteHintNewSession:
        "삭제하면 이미지에서 스킬 디렉터리를 제거하고 새 스냅샷을 만듭니다. 이미 열린 세션은 세션이 끝날 때까지 기존 샌드박스를 유지하며, 이 스킬은 새로 시작한 세션에서만 빠집니다.",
      skillRemoveInProgress: "제거 중",
      skillRemoveWaiting:
        "이미지에서 제거를 시작했습니다. 진행 상황을 기다리는 중…",
      skillRemoveDone:
        "샌드박스에서 「{name}」을(를) 제거했습니다. 스킬은 카탈로그에 남아 있으니 나중에 다시 설치할 수 있습니다.",
      skillRemoveStage: {
      ...
      imageInfoUsingBase:
        "아직 설치된 스킬이 없습니다. 세션은 선택한 런타임 템플릿으로 시작됩니다.",
      ...
      installCommandWaiting:
        "명령 출력을 기다리는 중입니다. 경과 시간은 계속 업데이트됩니다.",
      skillFiles: "파일 보기",
      skillFilesTitle: "파일",
      ...
      skillRetry: "다시 설치",
      skillRetryHint:
        "저장된 번들로 재시도합니다. 다시 업로드할 필요가 없습니다",
      ...
      skillEmpty:
        "아직 설치된 스킬이 없습니다. 레지스트리 URL을 붙여넣거나 zip을 업로드하세요.",
      ...
      skillEnv: {
        ...
        workspaceHint:
          "자기 값을 설정하지 않은 모든 구성원이 여기의 값을 사용합니다. 구성원은 설정의 「샌드박스 키」에서 자기 값을 설정할 수 있습니다.",
        required: "필수",
        isSet: "설정됨",
        notSet: "설정되지 않음",
        ...
        clear: "삭제",
        clearConfirm:
          "{name}의 워크스페이스 공용 값을 삭제할까요? 선언은 유지됩니다. 자기 값이 없는 구성원은 이후 이 값이 비어 있습니다.",
        clearSuccess: "워크스페이스 공용 값을 삭제했습니다.",
        valueTooLong: "값 하나는 {max}바이트를 초과할 수 없습니다.",
      },
      skillGuidance: {
        placeholder:
          "필요한 CLI, 설치 문서, 환경 제약 등 설치 안내를 추가하세요",
        send: "안내 보내기",
        retry: "안내를 포함하여 재설치",
        pending: "처리 대기",
        injected: "반영됨",
        ...
        unavailable:
          "현재 단계에서는 입력할 수 없습니다. 완료 후 안내를 포함하여 재설치할 수 있습니다.",
        failed:
          "안내를 보내지 못했습니다. 입력 내용은 유지됩니다. 다시 시도하세요.",
      },
    },
    skills: {
      title: "스킬 관리",
      description:
        "스킬은 워크스페이스 카탈로그에 속합니다. 먼저 등록한 뒤 하나 이상의 샌드박스에 설치할 수 있습니다. 에이전트는 현재 샌드박스에서 준비된 스킬만 사용할 수 있습니다.",
      helpTooltip:
        "카탈로그 스킬은 아무 샌드박스에도 설치하지 않아도 됩니다. 스크립트를 실행하려면 에이전트가 쓰는 샌드박스 이미지에 설치해야 합니다. Docker, Cube, E2B 이미지는 호환되지 않으므로 샌드박스마다 따로 설치합니다.",
      ...
      addStepInstall: "설치",
      addStepRegisterDesc:
        "소스를 붙여넣거나 zip을 업로드해 먼저 워크스페이스 카탈로그에 등록합니다.",
      addStepInstallDesc:
        "파싱된 스킬을 확인한 뒤 설치할 샌드박스를 선택하세요. 건너뛰고 나중에 목록에서 설치할 수도 있습니다.",
      addFinish: "완료",
      addFileSelected: "{name} 선택됨",
      addClearFile: "지우기",
      emptyDesc:
        "아직 스킬이 없습니다. 추가한 뒤 하나 이상의 샌드박스에 설치하세요.",
      emptyNoSandboxHint:
        "샌드박스가 없습니다. 스크립트 스킬은 이미지에 설치되기 전에는 실행되지 않습니다.",
      installSkill: "스킬 추가",
      installDrawerDesc: "「{name}」 이미지에 설치합니다.",
      installToSandbox: "샌드박스에 설치",
      installToSandboxDesc:
        "각 샌드박스 백엔드는 따로 설치해야 합니다. Docker, Cube, E2B 이미지는 호환되지 않습니다.",
      pickSandboxes: "설치할 샌드박스",
      pickSandboxesHint:
        "스킬은 선택한 샌드박스가 사용하는 이미지에 기록됩니다. Docker, Cube, E2B 이미지는 호환되지 않으므로 샌드박스마다 따로 설치합니다. 지금 건너뛰고 나중에 카탈로그에서 설치할 수 있습니다.",
      ...
      installPartial:
        "일부 샌드박스에서 설치를 시작했습니다. {failed}곳은 시작하지 못했습니다.",
      installOutdated: "카탈로그와 버전이 다름",
      loadFailed: "불러오지 못했습니다",
      noConfigsDesc:
        "샌드박스가 없습니다. 스킬을 설치하려면 먼저 이미지가 필요합니다.",
      addDrawerDesc:
        "소스를 붙여넣거나 zip을 업로드해 카탈로그에 등록합니다. 지금 샌드박스에 설치할 수도 있습니다.",
    ...
    capabilityUnavailable:
      "현재 배포에서는 이 기능을 지원하지 않습니다. 사용 가능한 페이지로 돌아갔습니다.",
    weknoraCloud: {
      title: "WeKnora Cloud",
      description:
        "WeKnora Cloud APPID 및 APPSECRET 자격 증명을 설정합니다. 자격 증명은 모델 서비스와 문서 파싱 엔진에 사용됩니다.",
      viewDocs: "문서 보기",
      unconfigured:
        "자격 증명이 설정되지 않았습니다. APPID와 APPSECRET을 입력하세요.",
      configured: "자격 증명이 설정되었으며 정상 작동 중입니다.",
      expired: "WeKnora Cloud 자격 증명 만료",
      expiredDefault:
        "서비스 재시작 후 암호화 키가 변경되어 저장된 자격 증명을 복호화할 수 없습니다. 다시 입력하세요.",
      reconfigure: "재설정",
      appIdLabel: "APPID",
      ...
      credentialUnconfigured:
        "WeKnoraCloud 자격 증명이 설정되지 않았습니다. APPID와 APPSECRET을 먼저 설정하세요.",
      checkingStatus: "자격 증명 상태 확인 중...",
      goToSettings: "설정으로 이동",
      modelHintConfigured:
        "WeKnoraCloud 자격 증명이 설정되었습니다. 지원 모델은",
      modelHintDocsLink: "API 문서",
      modelsSection: {
        title: "클라우드 모델",
        descReady:
          "WeKnora Cloud의 네 가지 표준 모델을 등록하여 대화, 검색, 재정렬, 비전에 사용합니다.",
        descPending:
          "위에서 자격 증명을 먼저 저장한 후 여기서 모델을 추가하세요.",
        statusAdded: "추가됨",
        ...
        confirmAddAll:
          "누락된 클라우드 모델 {count}개를 한 번에 추가하시겠습니까?",
      ...
      addModelsEmbeddingFailed:
        "Embedding 연결 테스트 실패, 벡터 차원을 가져올 수 없습니다",
    ...
    parser: {
      title: "파서 엔진",
      description:
        "문서 파서 엔진 상태 및 구성. 이 설정은 서버 환경변수보다 우선 적용됩니다. 비워두면 환경변수 기본값을 사용합니다.",
      ...
      retry: "재시도",
      noEngineDetected:
        "파서 엔진이 감지되지 않았습니다. DocReader 서비스가 정상적으로 실행 중인지 확인하세요.",
      disconnected: "연결 끊김",
      connected: "연결됨",
      available: "사용 가능",
      unavailable: "사용 불가",
      ...
      currentAddr: "현재",
      envVarHint:
        "수정하려면 환경변수 DOCREADER_ADDR, DOCREADER_TRANSPORT (grpc/http)를 설정하고 서비스를 재시작하세요.",
      ...
      parseMethodHint:
        "자동 모드는 스캔 PDF에는 OCR을 사용하고 디지털 PDF에서는 원본 텍스트를 추출합니다.",
      ...
      ensureDocreaderConnected:
        "DocReader 서비스가 환경변수로 구성되고 연결되었는지 확인하세요",
      checkDoneStatusUpdated:
        "현재 파라미터로 검사 완료. 위 상태가 업데이트되었습니다.",
      ...
      vlmServerUrlHint:
        "Backend가 vlm-http-client 또는 hybrid-http-client인 경우 필요",
      paddleocrVlEndpointPlaceholder: "예: http://your-paddleocr-vl:8080",
      paddleocrVlEndpointHint:
        "PaddleOCR-VL 전체 서비스(pipeline) 주소를 입력하세요. /layout-parsing 접미사는 불필요합니다",
      paddleocrVlCloudTokenPlaceholder: "PaddleOCR-VL AI Studio Token",
    },
    storageBackend: {
      description:
        "파일과 이미지에 사용하는 스토리지 인스턴스를 관리합니다. 같은 유형의 인스턴스를 여러 개 구성할 수 있습니다.",
    ...
    storage: {
      title: "스토리지 엔진",
      description:
        "문서 및 이미지 저장 방식을 구성합니다. 엔진 파라미터를 설정하면 지식베이스에서 사용할 엔진만 선택합니다.",
      basicSection: "기본",
      modeSection: "배포 모드",
      ...
      localDesc:
        "서버 로컬 파일시스템에 파일을 저장합니다. 단일 노드 배포에만 적합합니다.",
      available: "사용 가능",
      needsConfig: "구성 필요",
      configurable: "구성 가능",
      ...
      minioDesc:
        "S3 호환 자체 호스팅 오브젝트 스토리지, 내부 네트워크 및 프라이빗 클라우드 배포에 적합합니다.",
      minioDocker: "Docker 배포",
      minioRemote: "원격 MinIO",
      minioDockerDetected:
        "Docker 배포 MinIO 환경변수가 감지되었습니다. 연결 정보는 환경변수로 제공되므로 수동 입력이 필요 없습니다.",
      minioDockerNotDetected:
        "MinIO 환경변수(MINIO_ENDPOINT 등)가 감지되지 않았습니다. Docker Compose 구성을 확인하세요.",
      minioRemoteHint:
        "원격 MinIO 서비스에 연결합니다. 연결 정보를 수동으로 입력해야 합니다.",
      cosTitle: "Tencent Cloud COS",
      cosDesc:
        "Tencent Cloud 오브젝트 스토리지, 퍼블릭 클라우드 배포에 적합하며 CDN 가속을 지원합니다.",
      ...
      tosDesc:
        "Volcengine 오브젝트 스토리지(TOS), 퍼블릭 클라우드 배포에 적합합니다.",
      tosAccessKeyPlaceholder: "Volcengine Access Key",
      tosSecretKeyPlaceholder: "Volcengine Secret Key",
      s3Title: "AWS S3",
      s3Desc:
        "AWS S3 및 호환 오브젝트 스토리지 서비스, 퍼블릭 클라우드 배포에 적합합니다.",
      s3AccessKeyPlaceholder: "AWS Access Key",
      s3SecretKeyPlaceholder: "AWS Secret Key",
      s3DefaultCredentialsHint:
        "두 키를 모두 비워 두면 AWS 기본 자격 증명 체인(IAM 역할, IRSA / 웹 자격 증명, 환경 변수 또는 공유 구성)을 사용합니다.",
      s3EndpointPlaceholder:
        "선택 사항; 비워 두면 AWS 리전 기본 엔드포인트 사용",
      ks3Title: "Kingsoft Cloud KS3",
      ks3Desc:
        "Kingsoft Cloud 오브젝트 스토리지 서비스(KS3), 퍼블릭 클라우드 배포에 적합합니다.",
      ...
      obsDesc:
        "Huawei Cloud 오브젝트 스토리지 서비스(OBS), 퍼블릭 클라우드 배포에 적합합니다.",
      ...
      ossDesc:
        "Alibaba Cloud 오브젝트 스토리지 서비스(OSS), 퍼블릭 클라우드 배포에 적합합니다.",
  ...
  webSearchSettings: {
    ...
    noProvidersDesc:
      "웹 검색 프로바이더를 추가하여 에이전트가 인터넷에서 실시간 정보를 가져올 수 있도록 합니다.",
    setAsDefaultDesc:
      "에이전트가 검색 엔진을 지정하지 않은 경우 이 프로바이더가 기본적으로 사용됩니다",
    proxyUrlLabel: "HTTP 프록시",
    proxyUrlPlaceholder: "예: http://127.0.0.1:7890 (선택 사항)",
    proxyUrlHelp:
      "검색 API 접근에 프록시가 필요한 경우 입력합니다. 비우면 HTTP_PROXY/HTTPS_PROXY를 사용합니다.",
    apiKeyLabel: "API 키",
  ...
  vectorStoreSettings: {
    title: "벡터 데이터베이스 엔진",
    description:
      "지식 베이스 검색을 위한 벡터 데이터베이스 인스턴스를 등록하고 관리합니다.",
    basicSection: "기본",
    ...
    emptyDesc:
      "구성된 벡터 데이터베이스가 없습니다. '데이터베이스 추가'를 클릭하여 시작하세요.",
    ...
    testing: "테스트 중...",
    immutableNotice:
      "엔진 타입, 연결 정보, 인덱스 설정은 생성 후 변경할 수 없습니다.\n변경이 필요하면 삭제 후 다시 생성하세요.",
    insecureSkipVerifyWarning:
      "TLS 인증서 검증을 끄면 중간자 공격에 노출됩니다. 자체 서명 인증서를 쓰는 개발 클러스터에서만 사용하고, 운영 환경에서는 절대 사용하지 마세요.",
    validation: {
      nameRequired: "이름은 필수입니다",
      engineTypeRequired: "엔진 타입은 필수입니다",
      fieldRequired: "{field}은(는) 필수입니다",
      indexNamePattern:
        "영문자로 시작해야 합니다. 영문, 숫자, 밑줄, 하이픈만 허용 (최대 128자)",
    },
    toasts: {
  ...
  memorySettings: {
    title: "내 기억",
    description:
      "어시스턴트가 대화를 넘어 기억하고 있는 내용입니다. 언제든지 확인, 수정, 삭제할 수 있으며 삭제한 기억은 다시 사용되지 않습니다.",
    workspaceDisabled:
      "이 워크스페이스에서는 장기 기억이 꺼져 있습니다. 관리자가 켜야 이 스위치가 적용됩니다.",
    enableLabel: "내 장기 기억 사용",
    enableDescription:
      "끄면 어시스턴트가 기억을 읽거나 추가하지 않습니다. 기존 기억은 유지되며 다시 켜면 계속 사용됩니다.",
    agentDisabledHint:
      "개별 에이전트도 장기 기억을 따로 끌 수 있습니다. 꺼 둔 에이전트와의 대화에서는 기억을 읽지도 추가하지도 않으며, 다른 에이전트는 영향을 받지 않습니다.",
    usage: {
      title: "기억이 사용되는 시점",
    ...
    rejectGuess: "아니에요",
    pendingHint:
      "질문에서 추론된 내용입니다. 확인하기 전까지는 사용되지 않습니다.",
    trackingHint:
      "반복해서 묻고 있지만 아직 「장기 관심사」가 될 횟수에 도달하지 않은 주제입니다. 그때까지는 대화에 사용되지 않습니다.",
    documentsHint:
      "답변에 반복해서 등장하는 문서이며, 검색이 조금 더 이쪽을 선호합니다. 추적을 멈추면 가중치가 사라지고, 두 번 더 인용되면 다시 나타납니다.",
    supersededHint:
      "이 내용은 새로 갱신된 기억으로 대체되어 대화에 다시 들어가지 않으며, 변경 기록으로만 남습니다.",
    archivedHint:
      "보관된 기억은 대화에 다시 들어가지 않습니다. 인당 한도를 넘으면 덜 쓰인 항목이 자동으로 접힙니다.",
    pendingEmptyTitle: "확인할 항목이 없습니다",
    pendingEmptyDescription:
      "질문에서 사용자에 대해 추론한 내용이 생기면 여기에서 확인을 기다립니다.",
    trackingEmptyTitle: "관찰 중인 주제가 없습니다",
    trackingEmptyDescription:
      "자동 추출이 켜지면 자주 묻는 방향을 먼저 세고, 횟수가 충분해지면 장기 관심사로 기억합니다.",
    documentsEmptyTitle: "자주 쓰는 자료가 없습니다",
    documentsEmptyDescription:
      "같은 문서가 답변에 두 번 이상 인용되면 여기에 나타납니다.",
    supersededEmptyTitle: "대체된 기억이 없습니다",
    supersededEmptyDescription:
      "같은 주제가 새 표현으로 덮이면 이전 내용이 여기에 남습니다. 이 페이지에서 직접 수정하면 그 자리에서 갱신되며 이 목록에는 생기지 않습니다.",
    archivedEmptyTitle: "보관된 기억이 없습니다",
    archivedEmptyDescription:
      "사용 중인 기억이 한도(기본 200개)를 넘으면 덜 쓰인 항목이 자동으로 접힙니다. 만료 시각이 있는 할 일도 기한이 지나면 여기로 옵니다.",
    ...
    consolidate: "정리",
    consolidateConfirm:
      "뜻이 비슷한 항목을 합칩니다. 이전 내용은 「대체됨」에 남습니다. 계속할까요?",
    consolidateSuccess:
      "정리 완료: {merged}개 그룹 병합, 만료 {expired}개 보관, 기한 지난 할 일 {demoted}개 우선순위 낮춤",
    consolidateTooFewItems: "기억이 아직 적어 정리할 필요가 없습니다",
    consolidateNoCandidates: "뜻이 비슷해 합칠 만한 기억이 없습니다",
    consolidateModelDeclined:
      "모델이 확인한 결과 서로 다른 내용이라 합치지 않았습니다",
    consolidateTooSoon: "방금 정리했습니다. 잠시 후 다시 시도해 주세요.",
    consolidateModelUnavailable:
      "모델을 사용할 수 없어 잘못 합치지 않도록 아무것도 바꾸지 않았습니다",
    consolidateFailed: "정리하지 못했습니다",
    clear: "전체 삭제",
    clearConfirm:
      "모든 기억, 관찰 중인 주제, 자주 쓰는 자료가 영구 삭제되며 되돌릴 수 없습니다. 계속하시겠습니까?",
    deleteConfirm: "이 기억을 영구 삭제할까요?",
    add: "추가",
    addPlaceholder:
      "어시스턴트가 기억했으면 하는 내용을 한 문장으로 적어 주세요",
    addTitle: "기억 추가",
    addKindLabel: "유형",
    addContentLabel: "내용",
    emptyTitle: "아직 기억이 없습니다",
    emptyDescription:
      '대화에서 "기억해 줘: ..."라고 말하거나 위에서 직접 추가하세요.',
    kinds: {
      profile: "내 정보",
      preference: "선호",
      fact: "사실",
    ...
    kindHints: {
      ...
      interest:
        "자주 묻는 방향을 이해하는 데 쓰이며, 매 턴 인용되지는 않습니다",
    },
    origins: {
      explicit: "직접 요청",
      extracted: "자동 정리",
  ...
  envVarSettings: {
    title: "샌드박스 키",
    description:
      "스킬과 샌드박스에 쓰는 개인 키이며, WeKnora 시스템이나 배포 설정이 아닙니다.",
    helpAria: "샌드박스 키 설명",
    introPersonalTitle: "나만의 값",
    introPersonalBody:
      "내 대화와 실행에만 주입됩니다. 다른 구성원은 볼 수 없고, 그들의 값이 내 값을 대체하지도 않습니다.",
    introRuntimeTitle: "실행할 때만 전달",
    introRuntimeBody:
      "스킬이 실행되거나 해당 샌드박스에서 명령을 실행할 때 주입됩니다. 대화에서 바로 제공할 수도 있습니다. 저장한 뒤에는 다시 표시되지 않습니다.",
    loading: "불러오는 중…",
    loadFailed: "샌드박스 키를 불러오지 못했습니다.",
    retry: "다시 시도",
    noConfigTitle: "샌드박스가 없습니다",
    noConfigDescription:
      "이 워크스페이스에는 아직 샌드박스 백엔드가 없어 설정할 키가 없습니다.",
    sandboxTitle: "선택한 샌드박스에서 항상 전달되는 값",
    sandboxHint:
      "그 샌드박스에서 실행하는 명령에만 전달됩니다. 대부분은 필요 없고, 대화에서 바로 제공할 수도 있습니다.",
    sandboxEmpty: "아직 추가한 값이 없습니다.",
    sandboxPick: "어느 샌드박스에 쓸지",
    skillTitle: "스킬이 필요한 키",
    skillHint:
      "각 스킬이 필요하다고 선언한 값입니다. 여기에 미리 저장하거나 대화에서 바로 제공할 수 있습니다. 워크스페이스 관리자는 스킬 카드에서 공용 값을 넣을 수도 있습니다.",
    skillEmptyTitle: "아직 키가 필요한 스킬이 없습니다",
    skillEmptyDesc:
      "자격 증명을 선언하는 스킬을 설치하면 여기에 입력란이 나타납니다.",
    ...
    nameInvalid:
      "이 이름은 사용할 수 없습니다. PATH처럼 샌드박스가 예약한 이름이나 WEKNORA_로 시작하는 이름은 허용되지 않습니다.",
    ...
    delete: "삭제",
    deleteConfirm:
      "{name}을 삭제할까요? 이후 이 샌드박스에서 실행하는 것에는 전달되지 않습니다.",
    deleteSuccess: "변수를 삭제했습니다.",
    clear: "내 값 삭제",
    clearConfirm:
      "{name}에 설정한 내 값을 삭제할까요? 이후에는 워크스페이스 공용 값이 있으면 다시 적용됩니다.",
  ...
  memoryWorkspaceSettings: {
    title: "장기 기억",
    description:
      "구성원이 말한 개인 정보, 선호, 사실, 진행 중인 일을 어시스턴트가 대화를 넘어 기억하도록 합니다.",
    introTitle: "기본값은 꺼짐이며 직접 켜야 합니다",
    introDescription:
      '장기 기억은 구성원이 대화에서 말한 내용을 보관하므로 기본으로 켜지지 않습니다. 켜면 구성원마다 기억 공간이 분리되며 "내 기억"에서 확인, 수정, 삭제하거나 전체를 끌 수 있습니다. 사용 중인 내 정보와 선호는 이후 매 턴에 들어가고, 사실과 진행 중인 일은 질문과 관련될 때만 불러옵니다.',
    enableLabel: "이 워크스페이스에서 장기 기억 사용",
    enableDescription:
      "끄면 이 워크스페이스의 모든 대화가 기억을 읽거나 쓰지 않습니다.",
    writeModeLabel: "기억 저장 방식",
    writeModeDescription: "무엇을 기억할지 결정합니다.",
    writeModeExplicit: "명시적 요청만",
    writeModeAuto: "자동 정리",
    writeModeExplicitHint:
      "구성원이 명시적으로 기억을 요청한 내용과 기억 페이지에서 직접 추가한 항목만 저장하며 추가 모델 호출이 없습니다.",
    writeModeAutoHint:
      "여기에 더해 대화가 끝난 뒤 백그라운드에서 모델을 한 번 호출해 구성원이 한 말에서 오래 남길 내용을 정리합니다.",
    extractModelLabel: "정리 모델",
    extractModelDescription: "비워 두면 해당 대화에서 사용한 모델을 씁니다.",
    extractDelayLabel: "정리 지연",
    extractDelayDescription:
      "대화가 끝난 뒤 정리를 시작하기까지의 대기 시간입니다. 잠시 기다리면 사용자가 연달아 보낸 여러 메시지를 모델 호출 한 번으로 처리할 수 있습니다.",
    extractMinIntervalLabel: "정리 간 최소 간격",
    extractMinIntervalDescription:
      "같은 사람에 대한 두 번의 정리 사이 최소 간격으로, 비용을 제한합니다. 간격 안에 생긴 메시지는 버려지지 않고 다음 정리로 넘어갑니다.",
    vectorRecallLabel: "의미로 기억 검색",
    vectorRecallDescription:
      "표현이 아니라 의미로도 검색합니다. 사용자가 다르게 표현해도 기존 기억을 찾을 수 있습니다. 턴마다 임베딩 호출이 한 번 추가되며, 시간 초과 시 표현 기반 검색으로 되돌아갑니다.",
    embeddingModelLabel: "기억 Embedding 모델",
    embeddingModelDescription:
      "의미 검색은 이 모델 하나만 사용하며, 지식베이스마다 묶인 Embedding과는 무관합니다. 비워 두면 표현만으로 검색합니다. 바꾸면 새로 쓰는 기억은 바로 새 모델을 쓰고, 기존 기억은 새 벡터가 생길 때까지 표현으로만 찾습니다.",
    conditioningLabel: "검색에 기억 반영",
    conditioningDescription:
      "기억이 답변 프롬프트에만 붙는 것이 아니라 질의 재작성과 문서 순위에도 반영됩니다.",
    interestThresholdLabel: "장기 관심사가 되기까지의 질문 수",
    interestThresholdDescription:
      "같은 주제가 이만큼 반복된 뒤에야 기록됩니다. 1로 두면 스쳐 가는 질문까지 모두 기록되어 보통 너무 시끄럽습니다.",
    instructionsLabel: "사용자 정의 정리 규칙",
    instructionsDescription:
      '정리 프롬프트에 덧붙는 워크스페이스 규칙으로, 제품이 알 수 없는 정책을 표현합니다. 예: "고객 이름은 절대 기록하지 않는다".',
    instructionsPlaceholder: "한 줄에 규칙 하나, 예: 고객 이름은 기록하지 않기",
    maxItemsLabel: "구성원당 기억 상한",
    maxItemsDescription:
      '초과하면 중요도와 사용 시점이 낮은 항목부터 보관 처리되며 "내 기억"에서 계속 확인할 수 있습니다.',
    toasts: {
  ...
  chatHistorySettings: {
    title: "메시지 관리",
    description:
      "채팅 기록 지식베이스를 구성하여 대화 메시지를 자동으로 벡터화 인덱싱하여 시맨틱 검색을 지원합니다",
    enableLabel: "메시지 인덱싱 활성화",
    enableDescription:
      "활성화하면 새 대화 메시지가 자동으로 지식베이스에 인덱싱되어 벡터 검색을 지원합니다",
    embeddingModelLabel: "Embedding 모델",
    embeddingModelDescription:
      "메시지 벡터화에 사용할 Embedding 모델을 선택하세요",
    embeddingModelLocked:
      "이미 인덱싱된 메시지가 있어 Embedding 모델을 변경할 수 없습니다 (인덱스 데이터 초기화 필요)",
    statsTitle: "인덱스 통계",
    statsIndexedMessages: "인덱싱된 메시지",
    statsNotConfigured: "메시지 인덱싱 미설정",
    statsNotConfiguredDesc:
      "활성화하고 Embedding 모델을 선택하면 대화 메시지가 자동으로 벡터화 인덱싱됩니다",
    toasts: {
  ...
  retrievalSettings: {
    title: "검색 설정",
    description:
      "전역 검색 파라미터를 설정합니다. 지식베이스 검색과 메시지 검색이 이 설정을 공유합니다",
    ...
    rerankModelRequired:
      "Rerank 모델을 선택하세요. 검색 기능에 이 모델이 필요합니다.",
    toasts: {
  ...
  graphSettings: {
    ...
    customInstructionsDescription:
      "구조화된 출력 규칙은 유지하면서 도메인 범위와 엔티티 속성 지침을 추가합니다",
    customInstructionsPlaceholder:
      "예: 계약 당사자, 금액, 이행 기한 및 책임을 중점적으로 추출…",
  ...
  inviteRegister: {
    ...
    bannerHint:
      "아래 정보를 입력해 가입을 완료하세요. 등록이 끝나면 자동으로 팀에 합류합니다.",
  ...
  auth: {
    ...
    subtitle:
      "RAG Q&A, ReAct 에이전트, Wiki 지식베이스 — 대규모 언어 모델 기반 엔터프라이즈 지식 프레임워크",
    ...
    passwordMustContainSpecialChar:
      "비밀번호에는 특수문자가 포함되어야 합니다: {specialChars}",
    ...
    workspaceOnboarding: {
      title: "작업 공간 선택",
      description:
        "작업 공간을 만들어 시작하거나 기존 작업 공간의 초대를 수락하세요.",
      create: "공간 만들기",
      invitations: "초대 보기",
      loadingPolicy: "사용 가능한 공간 참여 방식을 확인하고 있습니다…",
      policyLoadFailed:
        "공간 권한을 불러올 수 없습니다. 네트워크를 확인한 후 다시 시도하세요.",
      retry: "다시 불러오기",
      inviteOnlyTitle: "작업 공간 초대 대기",
      inviteOnlyDescription:
        "개인 공간 만들기가 비활성화되어 있습니다. 관리자가 보낸 초대를 확인하고 수락하세요.",
      inviteOnlyNotice:
        "이 계정은 초대를 통해서만 기존 공간에 참여할 수 있습니다",
      help: "지금 작업 공간을 만들거나 나중에 돌아와 초대를 수락할 수 있습니다.",
      inviteOnlyHelp:
        "초대가 없다면 등록 이메일을 공간 관리자에게 전달하고 초대를 요청하세요.",
    },
  },
  authStore: {
    errors: {
  ...
  common: {
    ...
    github: "GitHub",
    githubStarTip:
      "GitHub에서 저장소로 이동합니다. 유용하다면 Star를 부탁드립니다",
    defaultUser: "사용자",
  },
  mentionDetail: {
    readOnlyFromAgent:
      "이 대화에서는 읽기 전용이며 지식베이스 목록에는 표시되지 않습니다.",
    faqCount: "Q&A {count}개",
    kbCount: "문서 {count}개",
    belongsToKb: "지식베이스: ",
    belongsToOrg: "스페이스: ",
    noCompatibleKbForAgent:
      "현재 에이전트의 도구와 범위 내 지식베이스의 기능이 일치하지 않아 참조할 수 있는 지식베이스가 없습니다.",
  ...
  input: {
    ...
    messages: {
      ...
      steerAttachmentPending:
        "첨부 파일 업로드가 완료되지 않았습니다. 잠시 후 다시 시도해주세요.",
      steerHasAttachments:
        "진행 중인 응답에는 첨부 파일을 추가할 수 없습니다. 먼저 제거하거나 응답이 끝난 뒤 보내주세요.",
      steerFailed: "메시지 추가에 실패했습니다. 다시 시도해주세요.",
      steerPromoteFailed: "지금 보내기에 실패했습니다. 다시 시도해주세요.",
      steerRemoveFailed:
        "대기 중인 메시지를 삭제하지 못했습니다. 다시 시도해주세요.",
      steerAlreadyInjected: "이 메시지는 이미 현재 응답에 반영되었습니다.",
      steerFollowUpTimeout:
        "다음 응답이 제때 시작되지 않았습니다. 다시 보내주세요.",
      steerNoActiveRun:
        "현재 진행 중인 응답이 없습니다. 메시지를 직접 보내주세요.",
    },
    webSearchDisabledByAgent:
      "현재 에이전트에 대해서는 네트워크 검색이 비활성화되어 있습니다.",
    ...
    imageUploadDisabledByAgent:
      "현재 에이전트에서 이미지 업로드가 활성화되지 않았습니다",
  ...
  embedPublish: {
    ...
    channelKeyHint:
      "보안상 채널 키는 목록 API에서 반환되지 않습니다. 저장하지 않았다면 재설정하여 새 키를 생성하세요(현재 브라우저 세션에 임시 저장).",
    ...
    resetKeyConfirmBody:
      "재설정 후 이전 채널 키는 즉시 무효화됩니다. 배포된 모든 임베드 코드를 새 키로 교체해야 합니다. 되돌릴 수 없습니다.",
    ...
    nameDefaultHint:
      "기본값은 「에이전트명 · 웹 페이지 임베드」입니다. 직접 수정할 수 있으며, 비워 두고 저장해도 기본 이름이 사용됩니다.",
    ...
    welcomeMessageDesc:
      "방문자가 임베드 채팅을 열고 첫 메시지를 보내기 전에 표시됩니다. 비우면 표시하지 않습니다",
    showSuggestedQuestions: "추천 질문",
    showSuggestedQuestionsDesc:
      "방문자 첫 메시지 전에 빠른 질문을 표시합니다(에이전트 설정 및 연결된 지식베이스에서 가져옴)",
    originsHint:
      "WeKnora 주소(B)가 아닌 임베드를 허용할 호스트 웹사이트(A)를 입력하세요. 한 줄에 하나의 Origin(예: https://shop.example.com), 최소 1개. *.example.com 지원.",
    ...
    rateLimitDesc:
      "방문자 IP 기준, 분당 최대 임베드 API 요청 수; 초과 시 일시 거부. 기본 30.",
    rateLimitDayLabel: "일일 요청 총 상한",
    rateLimitDayDesc:
      "채널 전체 일일 요청 총량(모든 방문자 IP 합산); 게시 토큰 유출 시 남용 비용 제한. 기본 10000.",
    publishTokenWarning:
      "게시 토큰은 임베드 페이지 소스에 평문으로 노출됩니다 — 호스트 사이트 방문자가 읽을 수 있습니다. 기밀 키가 아닌 공개 가능 키로 취급하세요: 민감 데이터 에이전트는 임베드하지 말고, 도메인 화이트리스트와 요청 상한을 설정하며, 유출 시 즉시 토큰을 교체하세요.",
    primaryColor: "테마 색상",
    pageTitle: "페이지 제목",
    ...
    headerTitleModeDesc:
      "고정: 항상 페이지 제목 표시. 세션: 첫 메시지 후 자동 제목; 생성 전까지 페이지 제목 사용.",
    tokenHint:
      "보안상 채널 키는 목록 API에서 반환되지 않습니다. 위젯 스크립트 복사 전 생성 또는 재설정 시 키를 저장하세요(현재 브라우저 세션에 임시 저장).",
    createdWithToken:
      "임베드 채널 생성됨 — 입력란에 새 키가 표시됩니다. 지금 복사하여 보관하세요",
    ...
    channelDisabled:
      "임베드 채널이 비활성화되었습니다. 에이전트 편집기 → 웹 페이지 임베드에서 다시 활성화하세요",
    loading: "로딩 중...",
    tabIframe: "iframe",
    tabWidget: "위젯",
    tabSecure: "보안 모드",
    ...
    preview: "미리보기",
    previewIframeHint:
      "iframe 임베드가 외부 페이지에서 어떻게 보이는지 시뮬레이션합니다(복사한 코드와 동일).",
    previewWidgetHint:
      "모의 호스트 페이지에서 플로팅 위젯을 표시합니다. 실제 사이트에서는 postMessage로 토큰을 전달합니다.",
    previewMockPage: "모의 호스트 페이지",
    previewLoading: "미리보기 로딩 중…",
    previewUnavailable:
      "미리보기를 사용할 수 없습니다. 채널이 활성화되어 있고 Redis가 사용 가능한지 확인하세요.",
    ...
    allowWebSearchDesc:
      "활성화하면 방문자 입력창에 웹 검색 버튼이 표시되며, 방문자가 직접 켜거나 끌 수 있습니다. 기본값은 꺼짐입니다. 연결된 에이전트에서 웹 검색이 활성화된 경우에만 버튼이 나타납니다.",
    allowFileUpload: "이미지 업로드 버튼 표시",
    allowFileUploadDesc:
      "활성화하면 방문자 입력창에 이미지 업로드 버튼이 표시됩니다. 연결된 에이전트에서 이미지 업로드가 활성화된 경우에만 버튼이 나타납니다.",
    ...
    agentWebSearchDisabledHint:
      "현재 에이전트에서 웹 검색이 활성화되지 않았습니다. 방문자에게 웹 검색 버튼이 표시되지 않습니다. 에이전트 설정에서 웹 검색을 먼저 활성화하세요.",
    agentImageUploadDisabledHint:
      "현재 에이전트에서 이미지 업로드가 활성화되지 않았습니다. 방문자에게 업로드 버튼이 표시되지 않습니다. 에이전트 설정에서 이미지 업로드를 먼저 활성화하세요.",
    ...
    stepDeploy: "배포",
    deployIntro:
      "임베드 방식을 선택하고 아래 코드를 사이트에 붙여넣으세요. 인증이 필요하면 하단의 채널 키 영역에서 확인하거나 재설정하세요.",
    ...
    embedSecureDesc:
      "권장: 게시 토큰은 자체 백엔드에만 두고 페이지는 단기 토큰만 받아 브라우저에 장기 비밀키가 노출되지 않습니다.",
    deployAfterSaveHint:
      "저장 후 여기에서 채널 키와 임베드 코드를 복사할 수 있습니다.",
    widgetTokenNote:
      "위젯 스크립트에는 채널 키가 포함되어야 합니다; iframe은 로드 시 자동으로 자격증명을 교환합니다.",
    secureTokenNote:
      "페이지에 게시 토큰이 없고 백엔드 토큰 엔드포인트(data-token-endpoint)를 가리킵니다. 백엔드가 30분 단기 토큰을 반환하고 위젯은 만료 전 자동 갱신합니다.",
    secureServerLabel:
      "서버 측 토큰 엔드포인트 예시(게시 토큰은 서버에만 보관)",
    tabServerNode: "Node.js",
    tabServerGo: "Go",
    enabled: "채널 활성화",
    deleteConfirm:
      "이 임베드 채널을 삭제하시겠습니까? 배포된 코드가 작동하지 않습니다.",
    defaultLocale: "기본 언어",
    defaultLocaleDesc:
      "방문자가 채팅을 열 때 사용할 UI 언어; 비우면 브라우저 또는 Widget setLocale()을 따릅니다.",
  ...
  knowledgeEditor: {
    activity: {
      title: "활동 기록",
      description:
        "이 지식 베이스의 주요 변경 사항과 백그라운드 작업 시작 기록입니다. 보존 기간은 감사 로그 정책을 따릅니다.",
      allOutcomes: "모든 결과",
      allActions: "모든 작업",
      refresh: "새로고침",
      retry: "다시 시도",
    ...
    wiki: {
      ...
      contentInstructionsTip:
        "요약, 페이지 및 인덱스의 강조점과 문체를 지정합니다. 인용 및 병합 규칙은 시스템에서 유지합니다.",
      contentInstructionsPlaceholder:
        "예: 책임자, 일정 및 위험을 우선적으로 표시…",
      extractionInstructionsLabel: "Wiki 추출 중점",
      extractionInstructionsTip:
        "시스템 JSON 및 인용 규칙을 바꾸지 않고 우선할 엔티티와 개념을 지정합니다.",
      extractionInstructionsPlaceholder:
        "예: 제품, 버전, 조직, 담당자 및 핵심 기술 개념을 우선…",
      extractionGranularityTip:
        "문서당 추출되는 Wiki 엔티티/개념 수를 제어합니다. 세밀할수록 인덱스가 간결하고, 거칠수록 포괄적입니다",
      granularityFocused: "집중",
      granularityStandard: "표준",
      granularityExhaustive: "상세",
      granularityFocusedHint:
        "문서의 주요 주체만 추출합니다 (예: 이력서 → 인물과 프로젝트). 가장 깔끔하지만 부수 엔티티는 누락될 수 있습니다.",
      granularityStandardHint:
        "주요 주체 + 상세히 논의된 부수 엔티티/개념. 지나가듯 언급된 용어는 생략합니다. 권장 기본값입니다.",
      granularityExhaustiveHint:
        "스쳐 지나가는 기술 스택 언급을 포함해 명명된 모든 엔티티와 개념을 추출합니다. KB를 용어집으로 사용할 때 적합합니다.",
    },
    indexing: {
      title: "인덱싱 전략",
      description:
        "문서 업로드 후 처리 파이프라인을 구성합니다. 각 인덱싱 방식을 독립적으로 켜거나 끌 수 있습니다",
      searchTitle: "RAG 검색",
      searchDesc:
        "문서를 청크 분할, 벡터화, 키워드 인덱싱하여 하이브리드 검색을 지원합니다",
      wikiTitle: "Wiki 지식베이스",
      wikiDesc:
        "상호 연결된 Wiki 지식 페이지를 자동 생성하여 구조화된 지식 체계를 구축합니다",
      graphTitle: "지식 그래프",
      graphDesc:
        "엔티티와 관계를 추출하여 지식 그래프를 구축하고 그래프 검색을 지원합니다",
      atLeastOne: "최소 하나의 인덱싱 전략을 활성화해야 합니다",
      embeddingRequired: "RAG 검색에는 Embedding 모델 설정이 필요합니다",
      lockedTip:
        "지식베이스에 콘텐츠가 있어 인덱싱 전략을 변경할 수 없습니다. 변경하려면 먼저 지식베이스를 비우세요.",
      rebuildConfirmTitle: "인덱스 재구축",
      rebuildConfirmBody:
        "인덱싱 전략이 변경되었습니다. 기존 {count}개 문서를 재처리하시겠습니까? 시간이 다소 걸릴 수 있습니다.",
    ...
    wikiBrowser: {
      ...
      editConflictHint:
        "저장 충돌: 페이지가 다른 사용자에 의해 v{ver}(으)로 업데이트되었습니다. 최신 버전을 불러오거나 덮어쓸 수 있습니다(덮어쓴 버전은 기록에 남습니다).",
      ...
      revisionEmpty:
        "기록이 없습니다 — 내용이 변경되면 스냅샷이 자동 기록됩니다",
      revisionRaw: "원문 보기",
      ...
      revertBtn: "이 버전으로 롤백",
      revertConfirm:
        "v{ver}(으)로 롤백하시겠습니까? 현재 내용은 먼저 기록으로 저장됩니다.",
      ...
      tabGraph: "그래프",
      tabGraphTip:
        "Wiki 페이지 간의 링크 관계 그래프(페이지 링크 그래프)입니다. '지식 베이스 설정 → 지식 그래프'에서 구성하는 LLM 기반 엔티티-관계 지식 그래프와는 다른 개념입니다.",
      ...
      deleteFolderNotEmpty:
        "디렉터리가 비어 있지 않습니다. 먼저 페이지와 하위 디렉터리를 제거하세요.",
      moveFolderSuccess: "디렉터리가 이동되었습니다",
      moveFolderFailed: "디렉터리 이동 실패",
      moveFolderIntoSelf:
        "디렉터리를 자기 자신이나 하위 디렉터리로 이동할 수 없습니다",
      ...
      emptyDesc:
        "Wiki를 활성화하고 문서를 업로드하면 지식 페이지가 자동 생성됩니다",
      ...
      graphNoData:
        '그래프 데이터가 없습니다. 먼저 문서를 업로드하세요. (여기는 Wiki 페이지 간의 링크 관계를 표시하며, "지식 베이스 설정 → 지식 그래프"에서 구성하는 엔티티-관계 그래프와는 다릅니다.)',
      showArrows: "화살표 표시",
      hideArrows: "화살표 숨기기",
      ...
      neighborsAllShown:
        "모든 {total}개 이웃이 이미 캔버스에 있습니다 (확장을 클릭하여 이 노드의 서브그래프에 집중)",
      neighborsNone: "이 페이지에는 연결된 이웃이 없습니다",
      neighborsCenterUnreachable:
        "이웃 {visible}/{total} 표시됨 ({hidden}개 연결 불가: 끊긴 링크, 필터됨 또는 삭제됨)",
      ...
      issueTitle:
        "이 페이지에는 {count}개의 대기 중인 지식 충돌 또는 오류가 있습니다",
    ...
    postCreateHint: {
      title: "생성 완료",
      footer:
        '설정을 계속 조정하고 공유·데이터 소스를 구성한 뒤 "저장 후 닫기"를 클릭하세요.',
      followUpDesc:
        '왼쪽에서 데이터 소스를 구성하거나 "공유 관리"에서 스페이스에 게시할 수 있습니다',
    },
    share: {
      description:
    ...
    faq: {
      ...
      batchDelete: "일괄 삭제",
      confirmBatchDelete:
        "선택한 FAQ 항목 {count}개를 삭제하시겠습니까? 삭제 후에는 복구할 수 없습니다.",
    ...
    models: {
      ...
      embeddingWikiOptionalDesc:
        "선택 사항입니다. 설정하면 Wiki 디렉터리 분류의 유사도 매칭에 사용되어 새 페이지가 기존 폴더를 더 잘 재사용합니다. 설정하지 않으면 전체 디렉터리 트리를 기준으로 분류합니다.",
    },
    chunking: {
      title: "청크 설정",
      description:
        "업로드된 문서가 임베딩되기 전에 분할되는 방식을 제어합니다. 대부분의 경우 기본값으로 충분합니다.",
      sizeLabel: "청크 크기",
      sizeDescription:
        "청크당 최대 문자 수 (100-4000). 기본값 512 ≈ 영어 100-130 토큰. FAQ는 200-400, 서술형 문서는 1000-2000.",
      characters: "문자",
      overlapLabel: "청크 중복",
      overlapDescription:
        "인접 청크 간 공유 문자 수 (0-500). 기본값 80 ≈ 청크 크기의 15% — 현재 연구 권장값. FAQ/구조화 데이터는 0, 긴 서술은 150-200.",
      separatorsLabel: "구분자",
      separatorsDescription:
        "분할 시 우선적으로 사용되는 문자/문자열. 우선순위가 높은 구분자를 먼저 시도; 기본 순서는 단락 → 문장 → 구두점.",
      ...
      parentChildDescription:
        "2단계 청킹: 작은 자식 청크는 벡터 매칭(정확한 히트), 큰 부모 청크는 LLM에 반환(풍부한 컨텍스트). 긴 문서(>10페이지)에 권장; 짧은 FAQ는 비활성화하여 저장 공간 절약.",
      parentChunkSizeLabel: "부모 청크 크기",
      parentChunkSizeDescription:
        "LLM에 반환되는 컨텍스트 청크 크기 (512-8192). 기본값 4096 ≈ 1000 영어 토큰, 모든 현대 LLM 컨텍스트에 적합.",
      childChunkSizeLabel: "자식 청크 크기",
      childChunkSizeDescription:
        "벡터 매칭에 사용되는 임베딩 청크 크기 (64-2048). 기본값 384 ≈ 80 토큰 — sentence-transformer / BGE 임베더의 최적점.",
      strategyLabel: "청킹 전략",
      strategyDescription:
        "문서를 청크로 분할하는 방법을 선택합니다. 자동 모드는 문서를 프로파일링하여 최적의 전략을 선택합니다.",
      strategyPlaceholder: "청킹 전략 선택 (비워 두면 길이로 분할)",
      strategies: {
        auto: {
          label: "자동",
          tooltip:
            "문서 프로파일러가 콘텐츠 구조에 따라 「헤딩 기준」, 「구조 인식」, 「길이 기준」 분할 중 하나를 자동 선택합니다.",
        },
        heading: {
          label: "헤딩 기준",
          tooltip:
            "Markdown 헤딩(#, ##, ###) 경계에서 분할하며 각 청크에 헤딩 경로가 부착됩니다. 잘 구조화된 Markdown 문서에 적합합니다.",
        },
        heuristic: {
          label: "구조 인식",
          tooltip:
            "페이지 구분자, 번호 매겨진 섹션, 다국어 챕터 마커(DE/EN/ZH), 대문자 제목 등 구조적 신호를 감지하여 분할합니다. Markdown 헤딩이 없는 PDF/스캔본에 적합합니다.",
        },
        legacy: {
          label: "길이 기준",
          tooltip:
            "구조를 무시하고 문자 수와 구분자로만 재귀 분할합니다 — 원래 동작. 위 전략들이 콘텐츠에서 잘못 작동할 때 사용하세요.",
        },
      },
      overlapWarning:
        "오버랩이 청크 크기에 비해 큽니다 — 청크가 대부분의 콘텐츠를 공유합니다.",
      advancedLabel: "고급 옵션",
      tokenLimitLabel: "청크당 토큰 제한",
      tokenLimitDescription:
        "청크당 토큰 하드 제한 (0-8192). 0 = 끄기 (문자 크기만). 임베딩 모델의 토큰 제한이 작을 때 활성화: MiniLM (256 tok)은 200, BGE/Cohere (512 tok)는 400. 현대 임베더(OpenAI, Voyage, Jina-v3)는 >2000 토큰 지원 — 0으로 두세요.",
      languagesLabel: "언어 힌트",
      languagesDescription:
        "휴리스틱 패턴을 선택한 언어(DE/EN/ZH)로만 제한합니다. 비어 있음 = 샘플에서 자동 감지. 동질적인 코퍼스는 명시적으로 설정하여 언어 간 오탐 방지.",
      ...
      debug: {
        ...
        sampleLabel: "샘플 텍스트",
        samplePlaceholder:
          "현재 구성으로 어떻게 청크되는지 보려면 Markdown / 일반 텍스트 스니펫을 붙여넣으세요…",
        presetLabel: "샘플 불러오기:",
        samples: {
        ...
        fallbackWarning:
          "전략 체인이 모두 실패함 — 현재 설정으로는 콘텐츠를 지능적으로 분할할 수 없음",
        profile: {
          lines: "줄",
          chars: "문자",
    ...
    multimodal: {
      title: "이미지 처리 설정",
      description:
        "이미지 콘텐츠 이해 기능을 설정하여 이미지 등 비텍스트 콘텐츠의 파싱 및 검색을 지원합니다",
    },
    asr: {
      title: "오디오 음성 인식",
      description:
      ...
      modelLabel: "ASR 모델",
      modelDescription:
        "오디오의 음성을 텍스트로 전사하는 모델 (예: OpenAI Whisper)",
      modelPlaceholder: "ASR 모델을 선택해주세요",
      languageLabel: "오디오 언어 힌트",
      languageDescription:
        "선택 사항입니다. 기본 언어를 지정하면 일부 ASR 모델의 인식이 향상되며, 비워 두면 자동 감지합니다.",
    ...
    advanced: {
      ...
      questionGeneration: {
        ...
        instructionsDescription:
          "안정적인 출력 형식을 유지하면서 대상, 상황 및 표현 방식을 지정합니다",
        instructionsPlaceholder:
          "예: 시험 문제 형식을 피하고 자연스러운 고객 지원 질문을 생성…",
      },
      autoTag: {
        label: "자동 태그 연결",
        description:
          "문서 파싱 후 현재 지식베이스의 기존 태그 중 적합한 태그를 연결합니다. 태그를 생성하거나 삭제하지 않으며 모델 호출이 한 번 추가됩니다.",
        modelLabel: "분류 모델",
        ...
        skipIfTaggedDescription:
          "활성화하면 업로드 시 수동으로 태그를 지정한 문서에는 자동 태그를 추가하지 않아 사용자의 분류 의도를 유지합니다.",
      },
      tableMetadataInstructions: {
        label: "테이블 메타데이터 지침",
        description: "CSV/Excel 요약에 비즈니스 배경과 필드 의미를 추가합니다",
        placeholder:
          "예: 판매 주문 테이블이며 금액 단위와 내부 상태 코드를 설명…",
      },
      multimodal: {
        label: "멀티모달 기능",
        ...
        customInstructionsDescription:
          "OCR 및 Markdown 형식은 유지하면서 시각적 우선순위를 추가합니다",
        customInstructionsPlaceholder:
          "예: 명판, 모델 번호, 경고 코드 및 표 단위를 중점적으로 인식…",
      },
    },
  },
  chat: {
    ...
    memoryHint:
      "이 답변이 참고한 장기 기억입니다. 삭제하면 다시 사용되지 않습니다.",
    ...
    connectingModelAndGeneratingAnswer:
      "모델에 연결하여 답변을 생성하고 있습니다…",
    modelStillResponding:
      "모델 응답이 평소보다 오래 걸리고 있습니다. 계속 기다리는 중…",
    ...
    sandbox: {
      ...
      notStarted:
        "터미널이 아직 실행되지 않았습니다. 시작하면 이 대화의 샌드박스에 연결하며, 샌드박스가 없거나 일시 중지된 경우 생성하거나 다시 시작합니다.",
      start: "터미널 시작",
      connecting: "샌드박스에 연결하는 중…",
      needsProvision:
        "이 대화에는 실행 중인 샌드박스가 없습니다. 생성하고 시작하면 새 샌드박스가 만들어지며 워크스페이스 설정에 따라 요금이 부과됩니다.",
      createAndStart: "생성 후 시작",
      noSandbox:
        "아직 샌드박스가 없고 현재 에이전트에 샌드박스 백엔드가 구성되지 않아 만들 위치를 정할 수 없습니다. 샌드박스가 구성된 에이전트로 전환하거나 코드 실행이 필요한 메시지를 보내세요.",
      unsupported: "현재 샌드박스 백엔드는 대화형 터미널을 지원하지 않습니다",
      disconnected: "연결이 끊어졌습니다",
      retry: "다시 연결",
      sessionEnded: "터미널 세션이 종료되었습니다",
      idleDisconnected:
        "터미널이 유휴 상태로 연결이 끊어졌습니다. 샌드박스는 TTL에 따라 일시 중지됩니다. 다시 연결할 수 있습니다.",
      authRevoked:
        "로그인 상태가 더 이상 유효하지 않아 터미널 연결이 끊어졌습니다. 다시 로그인한 뒤 재연결하세요.",
      artifactScope: "파일 범위",
      ...
      paused:
        "이 대화의 샌드박스가 일시 중지되었습니다. 터미널을 시작하면 다시 시작됩니다.",
    },
    ...
    fallbackHint:
      "지식 베이스에서 관련 내용을 찾지 못했습니다. 위는 모델의 직접 응답입니다.",
    ...
    attachmentTotalTooMany:
      "이미지와 첨부 파일은 합쳐서 최대 {max}개까지 가능합니다",
  ...
  tenant: {
    ...
    create: {
      ...
      dialogSubtitle:
        "워크스페이스는 자체 지식 베이스와 멤버를 가지며, 사용자가 자동으로 소유자가 됩니다.",
      nameLabel: "워크스페이스 이름",
      ...
      failed: "워크스페이스 생성 실패",
      disabled:
        "현재 시스템에서는 초대를 통해서만 공간에 참여할 수 있으며 직접 만들 수 없습니다.",
    },
    details: {
      idLabel: "워크스페이스 ID",
  ...
  system: {
    ...
    dbMigrationFailedDesc:
      "시작 시 데이터베이스 마이그레이션이 정상적으로 완료되지 않았습니다. 일부 테이블이나 인덱스가 생성되지 않았을 수 있으며, Wiki와 지식 그래프 기능 등이 동작하지 않을 수 있습니다. 먼저 아래 문제 해결 문서를 확인하여 직접 복구해 보고, 그래도 해결되지 않으면 이슈를 등록해 주세요.",
    ...
    globalSettings: {
      title: "시스템 설정",
      description:
        "플랫폼 전역 런타임 설정입니다. 저장하면 모든 워크스페이스에 즉시 적용됩니다. 시스템 관리자만 보고 수정할 수 있습니다.",
      loading: "로딩 중...",
      ...
      badgeOverrideTooltip:
        "이 값은 관리자가 DB에 저장하여 환경 변수 및 기본값을 덮어썼습니다.",
      modifiedAt: "마지막 수정: {value}",
      tagInputPlaceholder:
        "엔터로 항목 추가. 예: example.com / *.foo.com / 10.0.0.0/8",
      priorityHint: {
        disclosure: "설정 소스 및 우선순위",
        tier1:
          '이 페이지에서 저장한 항목("재정의됨" 배지가 붙은 항목)은 항상 우선 적용되며, 환경 변수는 무시됩니다.',
        tier2:
          "여기서 저장하지 않은 항목은 환경 변수를 따르며, 환경 변수도 없으면 내장 기본값을 사용합니다.",
        tier3:
          '특정 항목을 다시 환경 변수 기반으로 되돌리려면 해당 행의 "초기화" 버튼을 누르세요.',
      },
      sections: {
        access: {
          tab: "계정 및 액세스 {count}",
        ...
        tenant: {
          ...
          title: "워크스페이스 기본값",
          description:
            "기존 워크스페이스를 변경하지 않고 신규 워크스페이스의 초기 할당량과 호환 동작을 설정합니다.",
        },
        runtime: {
          tab: "런타임 및 동시성 {count}",
          title: "런타임 및 동시성",
          description:
            "백그라운드 워커 풀과 모델 서비스의 동시 처리 용량을 설정합니다.",
        ...
        security: {
          ...
          title: "네트워크 보안",
          description:
            "SSRF 허용 목록과 Docker 샌드박스 허용 여부(로컬 docker.sock은 호스트 root와 같음)를 관리합니다.",
        },
        other: {
          tab: "기타 {count}",
          title: "기타 설정",
      ...
      runtime: {
        title: "작업 큐 런타임",
        description:
          "백그라운드 작업 큐의 실시간 부하와 각 독립 워커 풀의 프로세스별 동시성 설정입니다. 5초마다 자동 새로고침됩니다.",
        refresh: "새로고침",
        ...
        unavailable:
          "현재 배포는 Redis / asynq 큐가 없습니다(Lite 모드) — 표시할 내용이 없습니다.",
        empty: "표시할 큐 데이터가 없습니다",
        detailsTitle: "큐 세부 정보",
        detailsDescription:
          "각 처리 경로의 실시간 부하와 대기 상태입니다. ‘최종 실패’는 재시도 한도를 초과하여 자동 실행이 중지된 작업입니다.",
        poolsTitle: "워커 풀",
        poolsDescription:
          "각 단계에 보장 용량이 있으며 핵심 파싱과 보강은 공유 탄력 풀도 사용할 수 있습니다.",
        ...
        footnote:
          "카드는 클러스터 실행 중/실시간 용량을 표시합니다. 프로세스별 설정은 재시작 후 적용되며 공유 풀은 핵심 파싱과 보강 큐만 처리합니다.",
        ...
        failedNotice: {
          ...
          description:
            "아래 표의 빨간색 '최종 실패' 숫자를 눌러 원인을 확인한 뒤, 수정 후 수동으로 재시도하세요.",
        },
        tasks: {
          title: "작업 상세 · {queue}",
          description:
            "모든 작업 상태를 확인합니다. 예약 및 재시도 작업은 다음 실행 순서로, 나머지는 최신 작업부터 표시됩니다.",
          listTitle: "{state} 작업",
          ...
          cancel: "작업 취소",
          cancelConfirm:
            "비즈니스 취소 흐름을 사용하여 같은 문서의 관련 작업도 중지합니다. 취소할까요?",
          runNow: "지금 실행",
          runNowConfirm:
            "재시도 횟수를 초기화하지 않고 즉시 대기 상태로 이동합니다. 계속할까요?",
          deleteRecord: "기록 지우기",
          deleteConfirm:
            "현재 큐에서만 기록을 제거합니다. 원래 작업은 실행되거나 완료되지 않으며 기록 로그는 유지됩니다. 지울까요?",
          purgeArchived: "실패 작업 모두 지우기",
          purgeArchivedConfirm:
            "현재 큐의 실패 기록 {count}건을 한 번에 제거합니다. 큐의 실패 작업만 정리하며 실행 중이거나 대기 중인 작업에는 영향이 없고, 이미 실패한 문서의 비즈니스 상태도 되돌리지 않습니다. 지울까요?",
          ...
          guides: {
            active:
              "실행 인스턴스와 시작 시간, 마감 및 고립 상태를 확인합니다. 안전한 비즈니스 취소가 가능한 작업만 취소할 수 있습니다.",
            pending:
              "아직 worker가 가져가지 않은 작업입니다. 취소 시 비즈니스 상태도 함께 갱신됩니다.",
            scheduled:
              "예약 작업을 즉시 실행하거나 지원되는 문서 작업을 안전하게 취소할 수 있습니다.",
            retry: "마지막 오류, 시도 횟수 및 다음 실행 시간을 확인하세요.",
            archived:
              "원인을 해결한 후 다시 실행하세요. 기록 삭제는 원래 작업을 완료하지 않습니다.",
            completed:
              "보존 기간이 설정된 최근 완료 작업만 표시되며 관리 작업은 없습니다.",
          },
          actionSuccess: {
            cancel: "작업을 취소했습니다",
        ...
        models: {
          title: "모델 동시성",
          description:
            "백그라운드 작업이 실제로 모델 서비스에 진입할 때의 동시성입니다. 위 섹션은 작업 스케줄링이고, 이 섹션은 별도의 모델 서비스 스로틀 단계입니다.",
          scope: "실행 중은 클러스터 전체 · 대기는 로컬",
          disabled:
            "백그라운드 모델 동시성 제어가 비활성화되어 있습니다. 전역 설정에서 모델 기본 동시성 상한을 구성하세요.",
          empty:
            "아직 모델 활동이 없습니다. 첫 백그라운드 호출 후 모델이 표시됩니다.",
      ...
      keyDescriptions: {
        auth: {
          ...
          complex_password_enabled:
            "복잡한 비밀번호를 사용할지 여부입니다. 활성화하면 비밀번호에 대문자, 소문자, 숫자 및 특수 문자가 포함되어야 합니다. 변경 사항은 즉시 적용되며, 새로 가입하는 사용자 또는 비밀번호를 새로 변경하거나 재설정하는 경우에만 적용됩니다. 특수 문자는 다음을 포함합니다: {specialChars}",
        },
        ssrf: {
          whitelist:
        ...
        sandbox: {
          docker_enabled:
            "Docker 샌드박스 백엔드를 허용할지 설정합니다. 로컬 docker.sock은 호스트 root와 같으므로 기본값은 꺼짐입니다. 시스템 관리자만 켤 수 있으며 저장 즉시 적용됩니다. 데몬 소켓을 마운트했거나 TLS가 있는 원격 tcp:// 를 쓰는 프라이빗 단일 노드에서만 켜세요.",
        },
        tenant: {
          max_owned_per_user:
          ...
          auto_accept_invitation:
            "켜면 워크스페이스 관리자가 이메일로 가입된 사용자를 초대할 때 상대가 바로 멤버가 되며, 받은편지함에서 수락할 필요가 없습니다. 끄면 「초대 발송 → 상대가 수락」 흐름을 유지합니다. 저장 즉시 적용됩니다.",
        },
        asynq: {
          core_concurrency:
            "문서 및 수동 파싱의 프로세스별 보장 동시성입니다. 공유 탄력 풀도 사용할 수 있습니다. 최소 1, 서비스 재시작이 필요합니다.",
          postprocess_concurrency:
            "파싱 마무리 및 보강 작업 분배 전용 프로세스별 동시성입니다. 최소 1, 서비스 재시작이 필요합니다.",
          enrichment_concurrency:
            "요약, 이미지, 그래프 및 질문 생성의 프로세스별 보장 동시성입니다. 공유 탄력 풀도 사용할 수 있습니다. 최소 1, 서비스 재시작이 필요합니다.",
          maintenance_concurrency:
            "동기화, 일괄 작업 및 정리의 프로세스별 동시성으로 사용자 파이프라인과 격리됩니다. 최소 1, 서비스 재시작이 필요합니다.",
          shared_concurrency:
            "핵심 파싱과 콘텐츠 보강이 적체에 따라 공유하는 프로세스별 탄력 동시성입니다. 최소 1, 서비스 재시작이 필요합니다.",
          wiki_concurrency:
      ...
      confirm: {
        ...
        bodyAuthRegistrationMode:
          "「{label}」을(를) {value}(으)로 변경하려고 합니다.\n\nself_serve로 전환하면 인터넷의 누구나 계정을 만들 수 있습니다. 의도된 동작인지 확인해 주세요.",
        bodySandboxDockerEnabled:
          "켜면 워크스페이스 관리자가 로컬 Docker 데몬을 샌드박스로 지정할 수 있습니다. 로컬 docker.sock은 호스트 root와 같습니다. 데몬을 마운트했거나 TLS가 있는 원격 tcp:// 를 쓰는 프라이빗 단일 노드에서만 사용하세요.",
      },
      listConfirm: {
        ssrf: {
          whitelist: {
      ...
      reset: {
        label: "초기화",
        tooltip:
          "UI 재정의 값을 제거하고 환경 변수 또는 내장 기본값으로 되돌립니다",
        confirmBtn: "초기화 확인",
        confirmBody:
          "「{label}」을(를) 초기화하시겠습니까? DB에 저장된 재정의 값이 삭제되고 환경 변수 또는 내장 기본값으로 되돌아갑니다.",
      ...
      createUser: {
        label: "사용자 생성",
        description:
          '새 로컬 사용자 계정을 개설합니다. 플랫폼의 기본 공간 모드가 "개인 공간 자동 생성"으로 설정된 경우, 스스로 가입한 사용자와 마찬가지로 개인 공간도 함께 만들어집니다.',
        action: "사용자 생성",
        dialogTitle: "새 사용자 생성",
        warning:
          "보안에 민감한 작업입니다. 새 사용자가 로그인할 때 사용할 사용자 이름과 이메일을 신중히 확인하세요.",
        ...
        missingPassword:
          "사용자는 생성되었지만 생성된 비밀번호가 반환되지 않았습니다. 비밀번호를 재설정해 접근을 복구하세요.",
        failed: "사용자 생성 실패",
        validation: {
        ...
        generated: {
          ...
          successBody:
            "이 사용자를 위한 무작위 비밀번호가 생성되었습니다. 이 비밀번호는 한 번만 표시됩니다.",
          usernameLabel: "사용자 이름",
          emailLabel: "이메일",
      ...
      bulkApply: {
        ...
        tooltip:
          "저장한 값은 기본적으로 새로 생성되는 워크스페이스에만 적용됩니다. 이 버튼을 누르면 현재 값을 모든 기존 워크스페이스에도 덮어씁니다.",
        confirmBtn: "적용 확인",
        confirmBody:
  ...
  mcp: {
    testResult: {
      ...
      requireApprovalTip:
        "활성화 시 에이전트가 이 도구를 호출하기 전에 승인을 기다립니다.",
      approvalSaveFailed: "승인 설정 저장 실패",
      toolEnabled: "도구 활성화",
      toolEnabledTip:
        "비활성화하면 에이전트가 이 도구를 보거나 호출하지 않습니다.",
  ...
  model: {
    ...
    editor: {
      ...
      displayNameDesc:
        "UI 표시용으로만 사용되며 실제 호출은 위의 모델 이름을 사용합니다.",
      ...
      customHeadersDesc:
        "원격 모델 API 호출 시 추가되는 HTTP 헤더입니다. 기업 게이트웨이 인증이나 추적 등에 사용할 수 있으며, Authorization / Content-Type 같은 예약 헤더는 무시됩니다.",
      ...
      dimensionOverrideDesc:
        "제공자 문서에서 이 모델이 dimensions 매개변수를 지원한다고 확인한 경우에만 켜세요.",
      ...
      desensitizeRulesDesc:
        "이 모델을 호출하기 전에 전화번호, 이메일, 신분증 번호, 비밀 키와 같은 구조화된 민감 정보를 치환합니다.",
      desensitizeNerLabel: "NER 비식별화 사용",
      desensitizeNerDesc:
        "규칙 기반 처리 후 이름과 위치도 탐지합니다. 비식별화 서비스에 NER 모델이 준비되어 있어야 합니다.",
      desensitizeImageLabel: "이미지 비식별화 사용",
      desensitizeImageDesc:
        "채팅에서 업로드한 이미지와 이 모델로 파싱하는 이미지를 먼저 비식별화 서비스가 가려 줍니다. 서비스가 이미지 OCR을 지원해야 합니다.",
      desensitizeServiceUrlLabel: "비식별화 서비스 URL",
      desensitizeVosHint:
        "같은 vos_default 네트워크에서는 다음 주소를 사용하세요:",
      desensitizeFailureDesc:
        "활성화된 상태에서 서비스가 응답하지 않으면 원문을 보내지 않고 모델 요청을 차단합니다.",
      desensitizeServiceUrlRequired:
        "비식별화를 활성화하면 서비스 URL이 필요합니다",
      desensitizeServiceUrlInvalid:
        "비식별화 서비스 URL 형식이 올바르지 않습니다",
      contextWindowLabel: "컨텍스트 창",
      contextWindowPlaceholder: "기본값 {value}",
      contextWindowDesc:
        "모델이 한 요청에 수용할 수 있는 토큰 수입니다. 에이전트 대화 압축이 이 한도를 사용합니다. 비워 두면 기본값 200000(200K)을 사용합니다. 공급자 문서의 실제 값을 입력하세요. 더 크게 설정하면 압축이 발생하지 않고 요청이 거부될 수 있습니다.",
      ...
      testDraftEditHint:
        "현재 연결 설정과 별도로 저장한 API 키를 사용하여 테스트합니다.",
      ...
      providers: {
        ...
        litellm: {
          label: "LiteLLM",
          description:
            "자체 호스팅 프록시로 OpenAI, Anthropic, Gemini, Bedrock 등 100+ 공급자를 연결합니다. 플레이스홀더 URL을 실제 주소로 바꾸세요. localhost는 SSRF_WHITELIST에 추가해야 합니다.",
        },
        requesty: {
          label: "Requesty",
        ...
        novita: {
          label: "Novita AI",
          description:
            "moonshotai/kimi-k2.5, zai-org/glm-5, minimax/minimax-m2.7, qwen/qwen3-embedding-0.6b 등",
        },
      },
  ...
  theme: {
    theme: "테마",
    themeDescription:
      "인터페이스의 표시 테마를 선택하세요. 시스템 설정에 따라 자동 전환을 지원합니다",
    light: "라이트",
    dark: "다크",
    system: "시스템 설정",
    selectTheme: "테마 선택",
  ...
  font: {
    uiFont: "인터페이스 글꼴",
    uiFontDescription:
      "메뉴, 본문, 버튼 등 인터페이스 대부분의 텍스트에 사용되는 글꼴입니다",
    monoFont: "코드 글꼴",
    monoFontDescription:
      "코드 블록, 터미널 명령, API 키, 파일 경로 등 기술 텍스트에 사용됩니다. 모든 문자가 같은 너비로 표시되어 0과 O, 1과 l을 구분할 수 있습니다.",
    selectFont: "글꼴 선택",
    ...
    fontSize: "글꼴 크기",
    fontSizeDescription:
      "인터페이스 전체(텍스트, 아이콘, 간격)를 확대/축소하며 즉시 적용됩니다",
    size: {
      small: "작게",
      normal: "보통",
      large: "크게",
  ...
  platform: {
    ...
    description:
      "RAG 검색, 에이전트 추론, Wiki 지식베이스로 문서를 진정으로 이해하고 활용합니다",
    rag: "RAG 강화 생성",
    agent: "ReAct 에이전트",
    wiki: "Wiki 지식베이스",
  ...
  modelSettings: {
    ...
    personalDesensitizationHint:
      "이 설정은 현재 계정과 현재 모델 구성에만 적용됩니다. 이름이나 주소가 같은 다른 모델 및 다른 사용자의 설정은 변경되지 않습니다. NER는 규칙 기반 비식별화 후에 실행됩니다.",
    title: "모델 설정",
    description:
    ...
    builtinModels: {
      title: "기본 제공 모델",
      description:
        "기본 제공 모델은 모든 워크스페이스에게 표시됩니다. 민감한 정보는 숨겨지며, 편집하거나 삭제할 수 없습니다.",
      descriptionAdmin:
        "기본 제공 모델은 모든 워크스페이스에게 표시됩니다. 시스템 관리자는 구성과 자격 증명을 편집할 수 있으며, 삭제는 배포 구성에서 관리됩니다.",
    ...
    usage: {
      ...
      description:
        '모델 "{name}"이(가) 다음 설정에서 사용 중입니다. 각 설정을 열어 다른 모델로 변경한 후 다시 삭제하세요.',
    ...
    debug: {
      title: "모델 테스트",
      description:
        "저장된 모델 설정으로 요청을 보냅니다. 편집 중인 변경 사항은 저장 후 반영됩니다.",
      groupModel: "모델 선택",
      groupInput: "테스트 입력",
      groupResult: "실행 결과",
      modelType: "모델 유형",
      ...
      documentsHint:
        "비어 있지 않은 각 줄은 ReRank 모델에 별도 문서로 전송됩니다",
      imageFile: "이미지 파일",
      audioFile: "오디오 파일",
      chooseFile: "파일 선택",
      parameters: "요청 매개변수",
  ...
  mcpServiceDialog: {
    ...
    oauthRevoke: "인증 해제",
    oauthAuthorizeHint:
      "「인증하기」를 클릭하면 현재 설정을 먼저 자동 저장한 후 인증을 시작합니다(사용자별 개별 인증).",
    apiKeyHeader: "요청 헤더 이름",
    apiKeyHeaderDesc:
      '비워 두면 기본값은 X-API-Key입니다. Bearer 방식은 Authorization을 입력하고 아래 비밀 값에 "Bearer <token>"을 작성하세요. 원시 토큰이 필요하면 Authorization에 토큰을 그대로 입력합니다.',
    ...
    toasts: {
      ...
      oauthRequired:
        "이 서비스는 OAuth 인증이 필요하여 OAuth 2.0으로 자동 전환했습니다. 저장 후 「인증하기」를 클릭하세요.",
    ...
    codeImport: {
      ...
      parse: "파싱 후 채우기",
      editOverwriteHint:
        "가져오기는 현재 양식을 덮어씁니다(저장된 자격 증명은 영향받지 않으며, 저장을 눌러야 적용됩니다)",
      errors: {
        ...
        stdioUnsupported:
          "stdio(command/args) 설정은 지원되지 않습니다. url이 포함된 원격 설정을 사용해 주세요",
      },
      toasts: {
        filled: "양식이 채워졌습니다. 확인 후 저장해 주세요",
        multipleServers:
          "여러 서비스가 감지되어 첫 번째 항목을 가져왔습니다: {name}",
      },
    },
  },
  promptTemplate: {
  ...
  organization: {
    ...
    rbac: {
      needTenantAdminTip:
        "이 작업은 현재 워크스페이스에서 admin 이상 역할이 필요합니다. 워크스페이스 소유자에게 문의하세요.",
      cannotCreate:
        "현재 워크스페이스 역할이 부족하여 공유 공간을 만들 수 없습니다",
      cannotJoin:
        "현재 워크스페이스 역할이 부족하여 공유 공간에 가입하거나 가입을 신청할 수 없습니다",
      cannotManage:
        "현재 워크스페이스 역할이 부족하여 공유 공간을 관리할 수 없습니다",
    },
    join: {
      title: "공유 공간에 참여하기",
    ...
    emptyDesc:
      "초대 코드를 사용하여 공유 공간을 만들거나 기존 공유 공간에 참여하세요.",
    createdByMe: "내가 생성한",
    joinedByMe: "내가 참여한",
    emptyCreated: "아직 공유 공간를 만들지 않았습니다.",
    emptyCreatedDesc:
      '새 공유 공간을 만들려면 "공유 공간 만들기"를 클릭하세요.',
    ...
    settings: {
      editTitle: "공유 공간 설정",
      membersDesc:
        "스페이스 구성원과 역할을 조회·관리합니다. 각 구성원은 하나의 워크스페이스를 의미하며, 같은 워크스페이스의 모든 사용자가 이 스페이스 접근 권한을 공유합니다.",
      ...
      sharedAgentsDesc:
        "이 공유 공간에 공유되었으며 대화에서 구성원이 사용할 수 있는 에이전트",
      sharedAgentsKbHint:
      ...
      noSharedAgentsTip:
        "관리자는 에이전트 설정에서 이 공유 공간에 에이전트를 공유할 수 있습니다.",
      ...
      inviteMembers: "회원 초대",
      inviteMembersDesc:
        "초대 코드 또는 링크를 통해 다른 사람을 공유 공간에 초대하세요.",
      inviteLink: "초대링크",
    ...
    editor: {
      ...
      nameTip:
        "구성원 식별이 용이하도록 팀 또는 프로젝트 이름 사용을 권장합니다.",
      descriptionTip:
        "회원들이 공유 공간을 이해할 수 있도록 공유 공간의 목적과 목표를 설명합니다.",
      ...
      viewAccess: "읽기 전용 권한",
      adminPerm1:
        "공유 공간 설정, 구성원, 에이전트과의 지식베이스 공유를 관리하세요.",
      ...
      joinDesc:
        "초대 코드를 통해 기존 공유 공간에 참여하고 지식베이스 및 에이전트에 액세스하세요.",
      joinIllustration:
        "공유 공간 관리자가 제공한 초대 코드를 입력하여 참여하세요.",
      inviteCodeTip:
        "초대코드는 공유 공간 관리자가 생성한 것이므로 관리자에게 문의하세요.",
    ...
    upgrade: {
      ...
      reason: "신청 이유(선택)",
      reasonPlaceholder:
        "더 높은 권한을 요청하는 이유를 간략하게 설명해주세요..",
      submitBtn: "신청 제출",
      submitSuccess:
        "권한 업그레이드 신청서가 제출되었으며 관리자의 검토를 기다리고 있습니다.",
    ...
    addMember: {
      ...
      dialogTitle: "회원 추가",
      tipTenant:
        "구성원의 최소 단위는 워크스페이스입니다: 한 워크스페이스가 가입하면 해당 워크스페이스의 모든 사용자가 이 스페이스 접근 권한을 공유합니다. 아래 결과는 워크스페이스 기준으로 중복 제거됩니다.",
      searchTenant: "워크스페이스 ID",
      searchTenantPlaceholder: "정확한 워크스페이스 ID 입력",
      searchTenantHint:
        "정확한 워크스페이스 ID로 조회하거나 초대 링크를 공유하세요.",
      selectRole: "역할 할당",
      confirmBtn: "추가",
      success: "회원이 추가되었습니다.",
      failed: "추가 실패",
  ...
  kbSettings: {
    ...
    storage: {
      title: "스토리지 엔진",
      selectDescription:
        "이 지식베이스를 바인딩할 구체적인 스토리지 인스턴스를 선택하세요.",
      defaultTag: "기본",
    ...
    parser: {
      title: "파서 엔진",
      description:
        "파일 유형별 문서 파서 엔진을 선택합니다. 미구성 파일 유형은 내장 파서를 사용합니다.",
      loading: "로딩 중...",
      noEngineAvailable:
        "사용 가능한 파서 엔진이 없거나 문서 파싱 서비스가 구성되지 않았습니다.",
      default: "기본",
      goConfig: "구성으로 이동 →",
  ...
  agentStream: {
    ...
    shellExec: {
      ...
      killed: "시간 초과로 종료됨",
      binarySuppressed:
        "바이너리 출력은 생략되었습니다. 파일은 산출물 디렉터리에 저장한 뒤 다운로드하세요.",
    },
    citation: {
    ...
    search: {
      ...
      candidatesBelowThreshold:
        "후보 {count}개를 찾았지만 관련성이 부족해 답변에 사용하지 않았습니다",
      foundResultsFromFiles: "{files}개 파일에서 {count}개 결과 발견",
      foundResults: "{count}개 결과 발견",
      foundMixedResults:
        "{count}개 결과 발견 ({docCount}개 문서, {webCount}개 웹)",
    ...
    attachmentParsing: {
      ...
      parsedWithSkipped:
        "첨부 파일 {parsed}개 파싱 완료, {skipped}개 미완료로 건너뜀",
  ...
  agentEditor: {
    builtinHint:
      "내장 에이전트입니다. 이름과 설명은 수정할 수 없지만, 설정 매개변수는 조정할 수 있습니다.",
    navGroups: {
      basic: "기본",
      knowledge: "지식 검색",
      capability: "기능 확장",
    ...
    questionSuggestions: {
      ...
      title: "대화 질문 추천",
      description:
        "대화 시작 질문과 답변 후 후속 질문을 에이전트 정책으로 통합 설정합니다.",
      startersTitle: "시작 질문",
      followUpsTitle: "답변 후 후속 질문",
      enableStarters: "시작 질문 표시",
      enableStartersDesc:
        "첫 질문 전에 운영 설정 또는 지식 기반 질문을 표시합니다.",
      enableFollowUps: "후속 질문 생성",
      enableFollowUpsDesc:
        "완료된 답변마다 비동기로 생성하며 추가 모델 사용량이 발생합니다.",
      sourceMode: "콘텐츠 소스",
      count: "표시 개수",
      ...
      instructionPlaceholder:
        "예: 실행 가능한 다음 단계 질문을 우선하고 광범위한 질문이나 답변 반복은 피하세요…",
    ...
    intentPrompts: {
      title: "의도 프롬프트",
      sectionDesc:
        "쿼리 의도별 시스템 프롬프트를 설정합니다. 사용자 정의가 없으면 기본 템플릿이 적용됩니다",
      intentLabel: "의도",
    ...
    desc: {
      ...
      systemPrompt:
        "에이전트의 동작과 역할을 정의하는 사용자 정의 시스템 프롬프트",
      promptInheritance:
        "템플릿 원문은 업데이트를 따르며, 수정한 내용은 사용자 지정 프롬프트로 저장됩니다. 에이전트 모드에서 역할과 작업 요구사항을 정의하며, 도구 권한과 각 요청의 소스 선택은 별도로 제어됩니다.",
      leaveEmptyDefault: "(비워두면 시스템 기본값 사용)",
      contextTemplate: "검색된 콘텐츠를 모델에 전달하기 전에 형식을 정의합니다",
      model: "에이전트가 사용할 대규모 언어 모델을 선택하세요",
      temperature:
        "출력의 무작위성을 제어합니다. 0이 가장 확정적, 1이 가장 무작위",
      maxTokens:
        "모델 응답의 최대 토큰 수. 「기본값」은 2048입니다. 「사용자 지정」은 입력한 값을 그대로 저장합니다.",
      maxTokensAgent:
        "각 추론 라운드에서 생성할 최대 토큰 수(도구 호출 JSON 포함). 「기본값」은 샌드박스 없으면 4096, 파일 쓰기/편집이 가능하면 24576입니다. 「사용자 지정」은 입력한 값을 그대로 저장합니다.",
      thinking: "모델의 확장 사고 기능 활성화 (모델 지원 필요)",
      conversationSection: "다중 턴 대화 및 질문 재작성 관련 매개변수 설정",
      conversationSectionAgent:
        "매 턴에 실어 보낼 이전 대화 분량 설정 (스마트 추론은 항상 다중 턴)",
      multiTurn: "활성화하면 대화 기록 컨텍스트가 유지됩니다",
      historyRounds: "컨텍스트로 유지할 최근 대화 라운드 수",
      retainRetrievalHistory:
        "이전 턴의 지식베이스 검색 결과를 유지합니다. 끄면 매 턴 새로 검색합니다",
      rewrite:
        "다중 턴 대화에서 사용자 질문을 자동으로 재작성하여 지시대명사 해소 및 생략 보완",
      memoryEnabled:
        "이 에이전트가 장기 기억을 읽고 추가하도록 허용합니다. 끄면 이 에이전트와의 대화에서 기억을 읽지도, 새로 추가하지도 않습니다. 공간 또는 개인 설정이 꺼져 있으면 여기서 켜도 적용되지 않습니다",
      queryUnderstandModel:
        "질문 이해(재작성과 의도 분류)에 사용할 모델입니다. 비워 두면 기본 대화 모델을 사용합니다.",
      rewriteSystemPrompt:
        "질문 재작성용 시스템 프롬프트 (비워두면 기본값 사용)",
      rewriteUserPrompt:
        "질문 재작성용 사용자 프롬프트 템플릿 (비워두면 기본값 사용)",
      selectTools: "Agent가 사용할 수 있는 도구를 선택하세요",
      maxIterations:
        "Agent가 한 작업에서 수행할 최대 추론 단계 수입니다. 「제한 없음」을 선택하면 모델이 스스로 끝나거나 직접 중지할 때까지 계속 실행됩니다.",
      kbScope: "에이전트가 접근할 수 있는 지식베이스 범위를 선택하세요",
      webSearch: "활성화하면 에이전트가 인터넷에서 정보를 검색할 수 있습니다",
      webSearchProvider:
        "이 에이전트의 검색 엔진을 지정합니다. 비워두면 기본 검색 엔진을 사용합니다",
      webSearchMaxResults: "검색당 반환되는 최대 결과 수",
      webFetchEnabled:
        "Rerank 후 상위 웹 페이지의 전체 콘텐츠를 자동으로 가져와 답변 품질을 향상시킵니다",
      ...
      fallbackStrategy:
        "지식베이스에서 관련 콘텐츠를 찾을 수 없을 때 처리 방식",
      fallbackResponse: "응답할 수 없을 때 반환할 고정 텍스트",
      fallbackPrompt:
        "지식베이스에서 답변을 찾을 수 없을 때 모델 응답을 유도하는 프롬프트",
    },
    tools: {
      thinking: "사고",
      ...
      wikiReadSourceDocDesc:
        "Wiki 페이지의 기반이 된 원본 문서를 깊이 있게 읽습니다",
      ...
      statusInactive:
        "{count}개의 체크된 도구가 현재 설정에서는 작동하지 않습니다",
      effectiveLabel: "최종 활성 도구",
      effectiveDesc:
        "현재 설정 기준 저장 시 에이전트가 실제 호출할 수 있는 도구 집합",
      effectiveEmpty: "사용 가능한 도구가 없어 일반 모델 대화로 동작합니다",
    },
    embed: {
      title: "웹 페이지 임베드",
      description:
        "에이전트를 웹 페이지에 임베드하여 방문자가 페이지 내 채팅창 또는 플로팅 버튼으로 대화할 수 있게 합니다. 지식베이스 범위는 이 에이전트 설정을 따릅니다.",
    },
    im: {
      title: "IM 통합",
      description:
        "에이전트를 Feishu, Slack, Telegram, DingTalk, Mattermost, QQBot, Yunzhijia 등 인스턴트 메시징 플랫폼에 연결",
      feishu: "Feishu",
      lark: "Lark",
      slack: "Slack",
      telegram: "Telegram",
      ...
      channelNameDefaultHint:
        "기본값은 플랫폼 이름이며, 직접 수정할 수 있습니다. 비워 두면 저장 시 플랫폼 이름이 사용됩니다",
      platform: "플랫폼",
      mode: "연결 모드",
      outputMode: "출력 모드",
      outputStream: "스트리밍",
      ...
      dingtalkCardTemplateIdHint:
        "open-dev.dingtalk.com/fe/card에서 AI 카드 템플릿을 만들면 타자기 효과 스트리밍 출력이 활성화됩니다",
      mattermostConsole: "Mattermost 통합",
      qqbotConsole: "QQ Open Platform",
      qqbotAPIBaseURLHint:
        "선택 사항. 비워두면 기본 프로덕션 API 엔드포인트를 사용합니다.",
      qqbotGatewayURLHint:
        "선택 사항. 비워두면 공용 WebSocket gateway를 자동으로 가져옵니다.",
      yunzhijiaConsole: "Yunzhijia Open Platform",
      yunzhijiaRobotDoc: "로봇 메시지 문서",
      yunzhijiaImageDoc: "개발자 플랫폼 (이미지)",
      yunzhijiaModeHint:
        "Webhook과 WebSocket을 지원하며 WebSocket 모드에는 공개 콜백 URL이 필요하지 않습니다.",
      ...
      yunzhijiaSecretHint:
        "설정하면 들어오는 콜백 요청이 HmacSHA1 서명으로 검증됩니다",
      ...
      yunzhijiaAppCredentialHint:
        "사용자가 보낸 이미지를 다운로드하기 위한 appAccessToken 발급에 사용됩니다.",
      yunzhijiaTimeout: "HTTP 타임아웃 (초)",
      yunzhijiaTimeoutHint:
        "메시지 전송 URL을 통한 응답 전송 타임아웃, 기본 10초",
      yunzhijiaAllowedHostSuffix: "허용 호스트 접미사",
      yunzhijiaAllowedHostSuffixHint:
        "보안을 위해 메시지 전송 URL 호스트를 이 접미사로 제한 (예: yunzhijia.com)",
      yunzhijiaSendMsgUrlRequired:
        "Yunzhijia 로봇 설정의 메시지 전송 URL을 입력하세요",
      mattermostModeHint:
        "Mattermost는 Webhook(아웃고잉 웹훅 + 봇 토큰)만 지원합니다.",
      ...
      wecomWSEndpointHint:
        "선택 사항. 프라이빗 WeCom 배포 시 사용자 정의 WebSocket 주소를 입력하세요. 비워두면 기본 퍼블릭 클라우드 주소를 사용합니다. 내부 네트워크 주소의 경우 SSRF_WHITELIST 환경 변수에 호스트명을 추가하세요.",
      wecomAPIBaseURLHint:
        "선택 사항. 프라이빗 WeCom 배포 시 사용자 정의 API 기본 URL을 입력하세요. 비워두면 기본 퍼블릭 클라우드 주소를 사용합니다. 내부 네트워크 주소의 경우 SSRF_WHITELIST 환경 변수에 호스트명을 추가하세요.",
      feishuAPIBaseURLHint:
        "선택 사항. 서버가 외부 인터넷에 직접 연결 가능하면 비워두세요. 프록시를 통해서만 접근 가능한 경우 역방향 프록시 URL(예: nginx, http://host:port)을 입력하세요. 내부 네트워크 주소는 SSRF_WHITELIST 환경 변수에 호스트명을 추가하세요.",
      fileKnowledgeBase: "파일 저장 지식 베이스",
      fileKnowledgeBasePlaceholder: "지식 베이스 선택 (선택 사항)",
      fileKnowledgeBaseHint:
        "설정 시 사용자가 보낸 파일이 자동으로 해당 지식 베이스에 저장됩니다",
      sessionMode: "세션 모드",
      sessionModeUser: "사용자별 (기본)",
      sessionModeThread: "스레드별",
      sessionModeHint:
        "사용자 모드: 각 사용자별 독립 대화. /clear로 새 대화 시작. 스레드 모드: 메시지 스레드별 독립 대화. 같은 스레드에서 여러 명이 함께 대화 가능.",
      wechatScanBind: "QR 코드를 스캔하여 WeChat 연결",
      wechatScanning: "WeChat으로 QR 코드를 스캔하세요",
      wechatBindSuccess: "WeChat이 연결되었습니다",
      wechatRebind: "다시 연결",
      wechatHint:
        "iOS WeChat 8.0.70+ 버전이 필요하며, 1:1 채팅 메시지만 지원됩니다",
    ...
    agentType: {
      ...
      kbIncompatibleWarn:
        "선택된 {count}개의 지식 베이스가 현재 유형과 호환되지 않습니다. 수동으로 조정해 주세요.",
    },
    mcp: {
      label: "MCP 서비스",
      ...
      authWaitTimeoutDesc:
        "대화 중 OAuth 인증이 필요할 때 인증 완료를 기다리는 최대 시간(초)이며, 초과하면 인증 요청을 건너뜁니다(OAuth를 사용하는 MCP 서비스에만 적용).",
    ...
    imageUpload: {
      ...
      sectionTitle: "첨부 업로드",
      sectionDesc:
        "채팅에서 이미지, 문서, 오디오 등 첨부 업로드·파싱 및 관련 모델을 설정합니다",
      label: "이미지 업로드",
      ...
      imageUnderstandingDesc:
        "이미지로만 구성된 PDF/PPT(스캔 문서)에서 텍스트를 추출할 수 없을 때 VLM OCR을 실행합니다. 파싱 시간이 늘어나며 기본값은 꺼짐입니다.",
      ocrMaxPagesLabel: "스캔 문서 OCR 최대 페이지 수",
      ocrMaxPagesDesc:
        "VLM OCR에 전달하는 스캔 문서의 최대 페이지 수입니다. 페이지가 많을수록 범위는 넓어지지만 느리고 비용이 큽니다. 0은 전역 기본값을 사용합니다.",
      useGlobalDefault: "0 = 전역 기본값",
      storageProvider: "이미지 저장소",
      storageProviderDesc:
        "업로드 이미지의 저장 엔진을 선택합니다. 비워두면 시스템 기본값을 사용합니다",
    ...
    audioUpload: {
      ...
      asrModel: "ASR 모델",
      asrModelDesc:
        "음성 인식 모델입니다. 설정하지 않으면 오디오 파일이 플레이스홀더로 전달됩니다",
    ...
    chatParser: {
      ...
      waitTimeoutDesc:
        "한 번의 답변에서 파싱 중인 첨부를 기다리는 최대 시간이며, 초과하면 미완료 첨부는 건너뜁니다. 대용량/스캔 파일은 늘리세요. 0은 전역 기본값을 사용합니다.",
    },
    faq: {
      title: "FAQ 우선 전략",
      ...
      thresholdDesc:
        "질문과 FAQ의 유사도가 이 값을 초과하면 FAQ 답변을 직접 사용합니다",
    ...
    dataAnalysis: {
      ...
      enableDesc:
        "검색된 청크가 CSV/Excel 파일에서 온 경우, 답변 전에 LLM에 DuckDB SQL 쿼리를 생성하도록 요청합니다. LLM 호출이 한 번 더 발생하고 수 초의 지연이 추가되므로 SQL 스타일 분석이 실제로 필요할 때만 활성화하세요.",
    },
    fallback: {
      fixed: "고정 응답",
      model: "모델 생성",
  ...
  datasource: {
    title: "데이터 소스 관리",
    description:
      "외부 데이터 소스를 구성하여 콘텐츠를 지식베이스에 자동 동기화",
    add: "데이터 소스 추가",
    empty: "구성된 데이터 소스가 없습니다",
    edit: "편집",
    delete: "삭제",
    deleteConfirm:
      "이 데이터 소스를 삭제하시겠습니까? 동기화된 지식은 삭제되지 않습니다.",
    ...
    gitlab: {
      ...
      projectsHint:
        "프로젝트 ID 또는 네임스페이스 경로(예: group/project)를 입력하고, 필요에 따라 브랜치와 디렉터리를 지정하세요.",
      project: "프로젝트",
      projectId: "프로젝트 ID",
      ...
      paths: "디렉터리",
      pathsPlaceholder:
        "한 줄에 하나씩 입력하세요. 비워 두면 전체 프로젝트를 동기화합니다",
      addProject: "프로젝트 추가",
    ...
    noResourcesDesc:
      "앱이 콘텐츠를 가져오려면 그룹 채팅을 통해 위키 접근 권한을 얻어야 합니다",
    noResourcesDesc_notion:
      "앱이 콘텐츠를 가져오려면 Notion 페이지 접근 권한이 필요합니다",
    retryLoadResources: "다시 시도",
    guideStep1:
      "Feishu에서 그룹 채팅을 만들고 그룹 설정의 '그룹 봇'에 앱을 추가하세요",
    guideStep2:
      "위키 '설정' > '멤버 설정' > '멤버 추가'를 열고 해당 그룹 채팅을 검색하여 추가하세요",
    guideStep3:
      "그룹 채팅 역할이 최소 '읽기 가능'인지 확인한 후, 돌아와서 다시 시도를 클릭하세요",
    guideStep1_notion: "Notion에서 동기화하려는 페이지나 데이터베이스를 엽니다",
    guideStep2_notion:
      "오른쪽 상단의 '···' 메뉴를 클릭하고 'Connect to' 또는 'Add connections'를 선택합니다",
    guideStep3_notion:
      "Integration 앱을 검색하여 선택한 후, 돌아와서 다시 시도를 클릭하세요",
    ...
    createAndSyncSuccess:
      "데이터 소스가 생성되었으며 동기화 작업이 제출되었습니다",
    createButSyncFailed:
      "데이터 소스가 생성되었으나 동기화 트리거에 실패했습니다",
    updateSuccessSyncHint:
      "데이터 소스가 업데이트되었습니다. 편집은 자동으로 동기화를 시작하지 않으므로 다시 가져오려면 동기화를 클릭하세요.",
    saveFailed: "저장 실패",
    step: {
      selectType: "유형 선택",
      credentials: "인증 정보",
    ...
    drive: {
      ...
      folderTokenRequired:
        "구체적인 폴더의 folder_token을 입력하세요. 클라우드 루트는 지원되지 않습니다",
      rootNotSupportedHint:
        "루트 폴더는 페이지네이션되지 않고 바로가기를 반환하지 않습니다. 구체적인 폴더를 선택하세요",
      load: "로드",
      shareHint:
        "앱이 접근할 수 있도록 먼저 드라이브 폴더를 앱이 속한 그룹에 공유하세요",
      placeholderTitle: "먼저 드라이브 폴더를 로드하세요",
      placeholderDesc:
        "위에 folder_token(또는 페이슈 드라이브 폴더 URL)을 입력하고 '로드'를 클릭하세요",
      loadForbiddenHint:
        "앱이 이 폴더에 접근할 수 없습니다. 페이슈 드라이브에서 폴더를 앱이 속한 그룹에 공유한 후 다시 시도하세요.",
      loadAuthHint:
        "앱 자격 증명이 유효하지 않거나 드라이브 권한이 없습니다. App ID / App Secret 및 drive:drive:readonly 권한을 확인하세요.",
      loadNotFoundHint:
        "folder_token이 존재하지 않거나 삭제되었습니다. 페이슈 드라이브 폴더 URL에서 복사한 토큰이 맞는지 확인하세요.",
    },
    field: {
      appId: "App ID",
      ...
      operatorIdHint:
        "대상 지식베이스에 접근할 수 있는 DingTalk 사용자의 Union ID를 입력하세요.",
      ...
      baseUrl: "Base URL",
      baseUrlHint:
        "비워두면 기본 퍼블릭 클라우드 주소가 사용됩니다. 프라이빗/엔터프라이즈 배포거나 리버스 프록시를 통해 액세스해야 하는 경우 사용자 정의 주소를 입력하세요 (예: https://api-proxy.example.com)",
      feedUrls: "피드 주소",
      feedUrlsHint:
        "한 줄에 하나씩 RSS / Atom 피드 주소를 입력하세요. 여러 개를 함께 입력할 수 있습니다.",
      authHeaders: "사용자 지정 헤더 (선택)",
      authHeadersHint:
        "비공개 피드 접근용. 한 줄에 하나씩 「이름: 값」 형식으로 입력하세요. 예: Authorization: Bearer xxxx",
    },
    comingSoon: "곧 지원 예정",
    docHint: "다음에서 인증 정보를 받으세요:",
    openDoc: "문서 열기",
    prereqBarText:
      "처음 사용하시나요? 클릭하여 Feishu 앱 설정 가이드를 확인하세요",
    prereqBarText_yuque:
      "처음 사용하시나요? 클릭하여 Yuque Token 설정 가이드를 확인하세요",
    prereqStep1Brief_yuque: "Yuque 개인 Token 생성",
    prereqStep1Desc_yuque:
      "Yuque 로그인 → 프로필 아이콘 → 설정 → Token → 새 Token 만들기",
    prereqStep2Brief_yuque: "Token에 필요한 권한 부여",
    prereqStep2Desc_yuque:
      "최소한 repo:read 와 doc:read 를 선택하세요 (지식베이스 및 문서 콘텐츠 읽기)",
    prereqStep3Brief_yuque: "(선택) Enterprise 사용 시 Base URL 입력",
    prereqStep3Desc_yuque:
      "퍼블릭 클라우드 사용자는 입력하지 않아도 됩니다. Yuque Enterprise 또는 사설 배포 시 기업 도메인을 입력하세요",
    prereqStep1Brief_feishu: "Feishu 커스텀 앱 생성",
    prereqStep1Desc_feishu:
      "Feishu Open Platform 로그인 → 엔터프라이즈 커스텀 앱 생성",
    ...
    prereqStep3Desc_feishu:
      "wiki:wiki:readonly, drive:drive:readonly, drive:export:readonly, docx:document:readonly 권한 활성화",
    prereqStep1Brief_lark: "Lark 커스텀 앱 생성",
    prereqStep1Desc_lark:
      "Lark Open Platform 로그인 → 엔터프라이즈 커스텀 앱 생성",
    ...
    prereqStep3Desc_feishu_drive:
      "drive:drive:readonly, drive:export:readonly, docx:document:readonly 권한 활성화",
    ...
    prereqBarText_dingtalk:
      "처음 사용하시나요? 클릭하여 DingTalk 앱 설정 가이드를 확인하세요",
    prereqStep1Brief_dingtalk: "기업 내부 앱 생성",
    prereqStep1Desc_dingtalk:
      "DingTalk Open Platform에서 기업 내부 앱을 생성하고 Client ID와 Client Secret을 복사하세요.",
    prereqStep2Brief_dingtalk: "지식베이스 읽기 권한 부여",
    prereqStep2Desc_dingtalk:
      "Wiki.Workspace.Read, Wiki.Node.Read, Storage.File.Read 권한을 부여하세요.",
    prereqStep3Brief_dingtalk: "운영자 Union ID 입력",
    prereqStep3Desc_dingtalk:
      "대상 지식베이스에 접근할 수 있는 DingTalk 사용자의 Union ID를 입력하세요.",
    prereqOpenConsole_dingtalk: "DingTalk 개발자 콘솔 열기",
    prereqBarText_ima:
      "처음 사용하시나요? 클릭하여 Tencent IMA OpenAPI 설정 가이드를 확인하세요",
    prereqStep1Brief_ima: "IMA 에이전트 OpenAPI 액세스 활성화",
    prereqStep1Desc_ima:
      "https://ima.qq.com/agent-interface 에 로그인하여 OpenAPI 액세스를 신청하세요",
    prereqStep2Brief_ima: "ClientID 및 APIKey 획득",
    prereqStep2Desc_ima:
      "에이전트 접속 페이지에서 ima-openapi-clientid 와 ima-openapi-apikey 자격 증명을 복사하세요",
    prereqStep3Brief_ima: "대상 지식베이스에 자격 증명 권한 부여",
    prereqStep3Desc_ima:
      "IMA 클라이언트에서 동기화하려는 지식베이스에 대해 자격 증명을 승인하세요. 승인되지 않은 지식베이스는 목록에 나타나지 않습니다",
    ...
    prereqMemberDesc:
      "그룹 채팅 생성 → 앱을 그룹 봇으로 추가 → 그룹 채팅을 지식베이스 멤버로 추가",
    back: "이전",
    next: "다음",
    save: "저장",
    schedule30min: "30분마다",
    ...
    syncError: {
      dingtalk_document_failed:
        "DingTalk 문서를 읽을 수 없습니다. 접근 권한을 확인하고 동기화를 다시 시도하세요.",
      dingtalk_resource_failed:
        "DingTalk 리소스를 사용할 수 없습니다. 접근 권한과 선택한 리소스를 확인한 후 다시 시도하세요.",
      deletion_lookup_failed:
        "삭제 전 항목 조회에 실패했습니다. 서버 로그를 확인하세요",
  ...
  integrations: {
    cli: {
      title: "WeKnora CLI",
      subtitle:
        "터미널에서 지식 베이스와 문서를 관리하고, 콘텐츠를 검색하고, 질문하세요. CLI 또는 MCP로 스크립트와 AI 도구를 연결할 수 있습니다.",
      docs: "CLI 문서 보기",
      docsHint: "설치 안내 및 전체 명령어 참조",
      quickstart: "빠른 시작",
      installTitle: "CLI 설치",
      installDesc:
        "Git과 Go 1.26+로 소스에서 빌드합니다. 아래 macOS / Linux 예제의 PATH 설정은 현재 터미널에만 적용됩니다. 계속 사용하려면 바이너리를 PATH에 포함된 디렉터리에 배치하세요.",
      connectTitle: "현재 서버에 연결",
      connectDesc:
        "weknora 프로필을 생성하고 활성화한 후 이메일과 비밀번호로 로그인하세요. 같은 이름의 프로필이 있다면 다른 이름을 사용하고 MCP 예제의 프로필 이름도 변경하세요.",
      verifyTitle: "연결 확인",
      verifyDesc:
        "서버 및 인증 상태를 확인하고 현재 계정으로 접근할 수 있는 지식 베이스를 조회합니다.",
      commandsTitle: "주요 명령어",
      commandsDesc:
        "KB_ID를 지식 베이스 ID로 바꾸고 파일 경로, 검색어, 질문을 수정하세요. 업로드한 문서는 처리가 완료되어야 검색할 수 있습니다.",
      mcpTitle: "MCP 클라이언트 연결",
      mcpDesc:
        "로그인 후 stdio를 지원하는 MCP 클라이언트에 아래 설정을 추가하세요. 클라이언트가 weknora를 찾지 못하면 command를 바이너리의 절대 경로로 변경하세요.",
      copy: "복사",
      copied: "복사됨",
    },
    title: "게시 및 통합",
    ...
    api: {
      title: "API 연동",
      subtitle:
        "REST API로 서비스를 연동하고, 요청이 최종 사용자를 식별하는 방식을 설정합니다.",
      ...
      directHostBaseUrlDesc:
        "VOS 패키지는 기본적으로 RAG API를 호스트 포트 29081에 연결하므로 LAN 또는 외부 시스템에서 직접 호출할 수 있습니다. 설치 포트를 변경했다면 설치된 값을 사용하세요.",
      externalGuideTitle: "외부 API 빠른 참조",
      externalGuideDesc:
        "외부 서비스는 VOS 앱 경로 또는 직접 호스트 포트를 통해 HybRAG를 호출할 수 있습니다. HybRAG는 개인 사용자 API Key와 VOS/OAuth bearer token을 모두 지원합니다.",
      externalGuideAuthTitle: "인증",
      externalGuideAuthDesc:
        "옵션 1: 일반 사용자가 여기에서 개인 API Key를 만들고 외부 앱이 X-API-Key를 보냅니다. 개인 Key는 해당 사용자의 지식베이스 범위만 상속하며 관리자가 발급한 Key가 필요하지 않습니다. 옵션 2: 외부 앱이 사용자의 VOS/OAuth token을 받아 Authorization: Bearer <VOS token>으로 보냅니다. HybRAG가 이를 확인하고 매핑된 사용자 권한으로 실행합니다.",
      externalGuideSessionTitle: "세션",
      externalGuideSessionDesc:
        "먼저 POST /sessions로 세션을 만들고, 반환된 id를 /knowledge-chat/:session_id 또는 /agent-chat/:session_id에 전달하세요.",
      externalGuideKbTitle: "지식 범위",
      externalGuideKbDesc:
        "요청 본문에 knowledge_base_ids를 전달하세요. API Key를 만들 때 선택한 지식베이스로 제한할 수도 있습니다.",
      externalGuideRagExample: "RAG Chat 예시",
      externalGuideRagStep:
        "# 2. RAG chat (SSE; 1단계에서 반환된 id로 <session_id>를 교체)",
      externalGuideQuestion: "이 지식베이스의 핵심 내용은 무엇인가요?",
      apiKeys: "API Keys",
      apiKeysDesc:
        "통합마다 별도 Key를 만들고 작업 권한 및 접근 가능한 지식베이스 범위를 제한합니다.",
      createApiKey: "API Key 생성",
      createApiKeyDialogDesc:
        "이 API Key가 사용할 기능과 지식베이스 범위를 선택하세요.",
      ...
      apiKeyCapabilitiesRequired:
        "Scoped API Key에 하나 이상의 기능을 선택하세요",
      apiKeyAccessMode: "접근 방식",
      apiKeyScopedAccess: "범위 지정 접근",
      apiKeyAccessType: "접근 유형",
      apiKeyAccessTypeHint:
        '"지식베이스"는 아래 권한 수준에 따라 지식베이스 범위 내에서 작동합니다. "워크스페이스 전체 접근"은 모델, 데이터 소스 등 모든 워크스페이스 수준 API를 추가로 사용할 수 있습니다.',
      personalApiKeyAccessTypeHint:
        "일반 사용자는 개인 API Key를 만들 수 있습니다. 현재 계정에만 적용되며 선택한 지식베이스를 검색/대화/수집할 수 있고 워크스페이스 전체 접근 권한을 부여할 수 없습니다. 관리자가 발급한 Key도 필요하지 않습니다.",
      ...
      capabilityTenantFullHint:
        "모델, 벡터 스토어, 데이터 소스, 채널 등 모든 워크스페이스 수준 API를 허용합니다. 지식베이스 범위는 적용되지 않습니다.",
      ...
      capabilityReadAgentsHint:
        "에이전트 목록, 상세 정보, 프리셋 및 추천 질문을 읽을 수 있습니다. 대화 시작이나 에이전트 수정은 허용하지 않습니다.",
      ...
      capabilityManageAgentsHint:
        "에이전트를 생성, 수정, 삭제, 복사할 수 있습니다. 에이전트 설정에는 모델/MCP 등 민감한 바인딩이 포함될 수 있으므로 기본적으로 꺼져 있으며 필요할 때만 켜세요.",
      ...
      capabilityManageModelsHint:
        "모델 설정, 자격 증명, 연결 테스트 및 WeKnoraCloud 자격 증명을 관리합니다.",
      capabilityManageMcpServices: "MCP 서비스 관리",
      capabilityManageMcpServicesHint:
        "MCP 서비스, 자격 증명, 도구 승인 정책 및 이 주체의 OAuth 상태를 관리합니다.",
      ...
      capabilityManageChannelsHint:
        "에이전트 임베드 채널, IM 채널 및 WeChat QR 바인딩 흐름을 관리합니다.",
      capabilityManageVectorStores: "검색 인프라 관리",
      capabilityManageVectorStoresHint:
        "벡터 스토어 설정과 파서, 문서 리더, 스토리지 엔진 연결 검사를 관리합니다.",
      ...
      capabilityManageWebSearchHint:
        "웹 검색 공급자 설정, 자격 증명 및 연결 테스트를 관리합니다.",
      capabilityRunEvaluations: "평가 실행",
      capabilityRunEvaluationsHint:
        "평가 작업을 실행하고 결과를 읽을 수 있습니다.",
      ...
      personalApiKeyKnowledgeScopePlaceholder:
        "이 개인 API Key가 접근할 지식베이스를 선택하세요",
      personalApiKeyKnowledgeScopeHint:
        "개인 API Key는 현재 사용자에게 표시되는 선택한 지식베이스에 연결해야 합니다.",
      personalApiKeyKnowledgeScopeRequired:
        "개인 API Key에 사용할 지식베이스를 하나 이상 선택하세요",
      allKnowledgeBases: "모든 지식베이스",
      editApiKeyScope: "API Key 편집",
      editApiKeyScopeDesc: 'API Key "{name}"의 이름과 권한 범위를 변경합니다.',
      editApiKeyScopeHint:
        "비워 두면 이 워크스페이스의 모든 지식베이스를 허용합니다. 모든 변경 사항은 즉시 적용됩니다.",
      ...
      deleteApiKey: "삭제",
      deleteApiKeyConfirm:
        "삭제하면 이 API Key는 즉시 무효화되며, 사용 중인 통합이 중단됩니다.",
      ...
      modeSigned: "서명 토큰",
      directWarning:
        "직접 사용자 ID 모드는 요청 헤더를 신뢰합니다. 신뢰된 서버 간 호출에만 사용하세요.",
      directWarningDetail:
      ...
      signedRecommended:
        "사용자 대상 앱에 권장: 비즈니스 백엔드가 외부 사용자용 단기 HS256 JWT를 서명합니다.",
      signedFlowDetail:
      ...
      tokenHeader: "토큰 헤더",
      tokenHeaderDesc:
        "클라이언트는 이 고정 헤더에 백엔드가 서명한 JWT를 전달합니다.",
      hmacSecret: "HMAC secret",
      hmacSecretDesc:
        "WeKnora에 저장된 것과 동일한 secret. 백엔드에서 JWT 서명에만 사용하며 요청 헤더로 보내지 않습니다.",
      secretConfigured:
      ...
      hmacSecretResetConfirmBody:
        "재설정하면 기존 HMAC secret은 즉시 무효화됩니다. 기존 secret으로 JWT를 서명하는 모든 백엔드 서비스는 새 secret으로 교체해야 서명 토큰 호출을 계속 사용할 수 있습니다. 이 작업은 되돌릴 수 없습니다.",
      ...
      playgroundTenantModeHint:
        "워크스페이스 전용 모드는 외부 사용자 ID를 보내지 않으며 모든 API 세션이 동일한 워크스페이스 주체에 속합니다.",
      playgroundDirectModeHint: "{headerName} 헤더로 이 사용자 ID를 보냅니다.",
      playgroundSignedModeHint:
        "서명 토큰 모드는 JWT sub를 외부 사용자로 사용합니다. Playground가 이 사용자 ID로 단기 테스트 JWT를 자동 서명합니다.",
      ...
      playgroundMissingSessionId:
        "세션 생성은 성공했지만 응답에 session id가 없습니다.",
      playgroundNoStream:
        "대화 API가 읽을 수 있는 SSE 스트림을 반환하지 않았습니다.",
      ...
      playgroundEmptyResult:
        "테스트를 실행하면 Session 응답, 원시 SSE 출력, 추출된 답변이 여기에 표시됩니다.",
      ...
      autoSaveNeedSecret:
        "서명 토큰 모드는 자동 저장 전에 HMAC secret이 필요합니다.",
    },
    ...
    claw: {
      ...
      ecosystemNote:
        "Skill은 ClawHub({'@'}lyingbug/weknora)에 호스팅됩니다. 전체 API 문서는 ClawHub 페이지를 참고하세요.",
  ...
  credential: {
    ...
    confirmRemovePrompt:
      "이 credential을 제거하시겠습니까? 이 작업은 되돌릴 수 없습니다.",
    confirmRemove: "제거 확인",
  },
  userProfile: {
    title: "사용자 정보",
    description:
      "계정 기본 정보(사용자 ID, 사용자 이름, 이메일, 가입 시각)를 확인하고 비밀번호를 변경할 수 있습니다.",
    changePassword: {
      label: "비밀번호 변경",
      description:
        "현재 비밀번호를 확인한 뒤 새 비밀번호를 설정합니다. 성공 시 모든 세션이 만료되어 다시 로그인해야 합니다.",
      ...
      oidcOnlyDescription:
        "OIDC로 개설된 계정입니다. 로컬 로그인 비밀번호가 아직 설정되지 않았습니다.",
      oidcOnlyNotice:
        "시스템 관리자에게 비밀번호 재설정을 요청하거나 OIDC로 계속 로그인하세요. 자가 변경에는 현재 비밀번호가 필요합니다.",
    },
  },
  tenantMember: {
    title: "멤버 관리",
    ...
    remove: {
      button: "제거",
      confirmBody:
        "{name} 님을 이 워크스페이스에서 제거하시겠어요? 즉시 접근 권한이 해제됩니다.",
      confirm: "제거",
      success: "멤버를 제거했습니다",
    },
    leave: {
    ...
    errors: {
      ...
      userNotFound:
        "해당 이메일로 가입된 사용자가 없습니다. 먼저 가입을 요청하세요.",
      lastOwner:
        "마지막 소유자를 강등, 제거, 또는 떠날 수 없습니다. 다른 멤버를 먼저 소유자로 승격하세요.",
      notFound: "멤버를 찾을 수 없습니다.",
      invalidRole:
        "역할은 owner / admin / contributor / viewer 중 하나여야 합니다.",
  ...
  tenantInvitation: {
    ...
    shareLink: {
      ...
      resultBody:
        "아래 링크를 복사해 비공개 채널로 전달하세요. 목록에도 저장되어 다시 복사하거나 취소할 수 있습니다.",
      revokeConfirm:
        "취소 후에는 미가입자가 이 링크를 사용할 수 없습니다. 다시 발급하려면 새 링크를 생성하세요.",
    },
    revoke: {
      button: "취소",
  ...
  platformApiKeys: {
    title: "플랫폼 API 키",
    description:
      "워크스페이스 간 자동화를 위한 플랫폼 자격 증명입니다. 워크스페이스 API에는 X-Tenant-ID를 사용하세요.",
    securityNotice:
      "플랫폼 API 키는 모든 워크스페이스를 선택할 수 있습니다. 필요한 권한만 부여하고, 한 번 표시되는 키를 안전하게 보관하세요.",
    create: "플랫폼 API 키 만들기",
    createDescription:
      "플랫폼 키는 워크스페이스에 고정되지 않지만 모든 작업은 권한으로 제한됩니다.",
    loading: "불러오는 중…",
    ...
    capabilityHint:
      "워크스페이스 권한은 X-Tenant-ID 대상에, 시스템 권한은 플랫폼 제어 API에 적용됩니다.",
    lastUsed: "마지막 사용",
    createdAt: "생성 시간",
    actions: "작업",
    never: "사용 안 함",
    ...
    createdDescription:
      "지금 복사하여 안전하게 보관하세요. 전체 키는 다시 표시되지 않습니다.",
    copy: "키 복사",
    copySuccess: "키가 복사되었습니다",
    deleteConfirm:
      "“{name}”을(를) 삭제할까요? 이 키를 사용하는 자동화가 즉시 중단됩니다.",
  ...
  mcpMetadata: {
    ...
    next: "다음",
    policyLoadFailed:
      "도구 정책을 불러오지 못했습니다. 수정하기 전에 다시 시도하세요.",
    policySaveFailed: "도구 설정을 저장하지 못했습니다",
    tools: "Tools 목록",
    cacheHint:
      "아직 동기화되지 않았다면 이 단계에서 자동으로 연결해 저장합니다. 이후에는 새로 고침할 때만 MCP 서버에 연결합니다.",
    refresh: "Tools 새로 고침",
    fetch: "다시 가져오기",
    fetching: "연결해서 Tools를 가져오는 중…",
    toolCount: "도구 {count}개",
    stale:
      "연결 또는 인증 설정이 변경되었습니다. 모델이 사용하기 전에 목록을 새로 고치세요.",
    notSynced:
      "아직 동기화되지 않았습니다. 가져오면 전체 설명과 매개변수 정의가 저장됩니다.",
    syncRequired:
      "먼저 연결해서 Tools를 가져온 뒤 저장하세요. 모델은 동기화된 목록만 사용할 수 있습니다.",
    needsRefresh: "새로 고침 필요",
    saved: "저장된 목록",
    syncedAt: "동기화 시간:",
    serverDocumentation: "서버 원본 설명",
    noServerDocumentation:
      "이 MCP 서버의 initialize 응답에 instructions / serverInfo.description이 없습니다(둘 다 선택 필드). 도구 설명은 아래 각 도구의 description에 있습니다.",
    policyHint:
      "도구 활성화 및 승인 설정은 즉시 저장되며 목록을 새로 고쳐도 유지됩니다.",
    ...
    usage: "서비스 용도",
    usageHint:
      "모델은 이 개요를 읽은 후 필요한 도구를 불러옵니다. 새로 고침해도 입력한 내용은 유지됩니다.",
    summary: "용도 요약",
    summaryPlaceholder: "예: 주문 상태, 배송 진행 상황 및 환불 내역 조회.",
    usageInstructions: "사용 안내",
    instructionsPlaceholder:
      "서비스의 용도, 사용 상황, 주요 제약을 간결하게 설명하세요.",
    generateUsage: "AI로 생성",
    generateHint:
      "동기화된 활성 도구를 바탕으로 간결한 안내를 생성합니다. 수정 후 저장하면 적용됩니다.",
    instructionsRequired: "사용 안내를 입력해 주세요",
    generated: "생성되었습니다. 검토 후 저장해 주세요.",
    generateFailed:
      "생성에 실패했습니다. 도구 동기화와 사용 가능한 대화 모델 설정을 확인한 후 다시 시도하세요.",
    saveNext: "저장하고 다음",
  },
};
