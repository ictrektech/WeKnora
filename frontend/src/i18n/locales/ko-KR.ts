export default {
  ...
  contractReview: {
    ...
    uploadFirstDescription: '검토를 시작하기 전에 PDF 또는 DOCX를 업로드하세요.',
    model: '검토 모델',
    useDefaultModel: '모델 자동 선택',
    noAvailableModels: '사용 가능한 KnowledgeQA 모델이 없습니다',
    modelUnavailable: '사용할 수 없음',
    modelsLoadFailed: '모델 목록을 불러오지 못했습니다. 기본 모델을 사용합니다.',
    playbook: '검토 규칙',
    ...
    reconfigureDescription: '대리 당사자, 규칙 또는 모델을 바꾼 후 다시 실행하세요.',
    cancel: '취소',
