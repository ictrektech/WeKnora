export default {
  smartArchive: {
    ...
    notificationDeleteFailed: "通知の削除に失敗しました。",
    bulkDeleteReminders: "リマインダーを一括削除",
    bulkDeleteRemindersConfirm:
      "選択した {count} 件のリマインダーを削除しますか？",
    bulkDeleteRemindersActiveConfirm:
      "選択した {count} 件のうち {active} 件が予約中です。削除すると今後の通知が停止します。続行しますか？",
    bulkDeleteRemindersSuccess: "{count} 件のリマインダーを削除しました。",
    bulkIgnoreCandidates: "選択項目を無視",
    bulkIgnoreCandidatesConfirm:
      "選択した {count} 件を無視しますか？リマインダーは作成されませんが、記録は保持されます。",
    bulkIgnoreCandidatesSuccess: "{count} 件を無視しました。",
    eyebrow: "アーカイブワークスペース",
    title: "スマートアーカイブ",
    subtitle: "過去の文書、顧客情報、重要な期日を一か所で管理します。",
    importFiles: "ファイルをインポート",
    importing: "インポート中",
    importStarted: "インポートを開始しました。",
    importFailed: "インポートに失敗しました。",
    invalidFiles:
      "対応していないファイルをスキップしました。PDF、Word、Excel、JPG、PNG、WEBPに対応しています。",
    loading: "読み込み中…",
    loadFailed: "アーカイブを読み込めませんでした。",
    searchFailed: "検索に失敗しました。",
    documents: "文書",
    documentCount: "{count} 件の文書",
    documentsDescription:
      "契約書、借用契約、出庫記録と原文の根拠。画像OCRにも対応します。",
    customers: "顧客",
    customersDescription: "過去の文書から正規化された顧客情報。",
    reminders: "リマインダー",
    remindersDescription:
      "内容を確認してからリマインダーを作成・有効化します。",
    candidatesTitle: "確認が必要な項目",
    candidatesDescription:
      "検出された期日は候補であり、自動的にはリマインダーを作成しません。",
    noCandidates: "確認が必要な項目はありません",
    candidateNeedsReview: "先にフィールドを確認してください",
    candidateReview: "リマインダーを確認",
    createReminder: "リマインダーを作成",
    reminderCreated:
      "リマインダーを作成しました。準備ができたら有効化してください。",
    offsetDays: "何日前",
    reminderTime: "通知時刻",
    assignee: "担当者",
    assigneeDefault: "デフォルト担当者",
    eventDate: "イベント日",
    suggestedReminderDate: "推奨通知日",
    returnDue: "返却期限",
    cancel: "キャンセル",
    reviewQueue: "確認キュー",
    reviewQueueDescription: "人による確認が必要なフィールドと文書の関連。",
    searchPlaceholder: "検索語または契約番号を入力",
    searchAction: "検索",
    dateFrom: "インポート開始日",
    dateTo: "インポート終了日",
    typeFilter: "文書タイプで絞り込む",
    allTypes: "すべてのタイプ",
    allStatuses: "すべてのステータス",
    selectedStatuses: "ステータス {count}/7",
    archiveView: "アーカイブ範囲",
    currentDocuments: "現在の文書",
    archivedDocuments: "アーカイブ済み文書",
    showArchived: "アーカイブ済みを表示",
    clearFilters: "フィルターをクリア",
    noMatchingDocuments: "条件に一致する文書はありません。",
    loadMore: "さらに読み込む",
    loadedCount: "{loaded}/{total} 件を読み込み済み",
    selectAll: "表示中の項目をすべて選択",
    selectedCount: "{count} 件を選択中",
    bulkArchive: "選択項目をアーカイブ",
    bulkRestore: "選択項目を復元",
    bulkDelete: "完全に削除",
    bulkArchiveConfirm: "選択した {count} 件の文書をアーカイブしますか？",
    bulkRestoreConfirm: "選択した {count} 件の文書を復元しますか？",
    bulkDeleteConfirm:
      "選択した {count} 件の文書を完全に削除しますか？関連するリマインダーも取り消されます。",
    bulkActionSuccess: "{count} 件を処理しました。",
    bulkActionPartial:
      "{succeeded} 件を処理しました。{failed} 件は失敗したため、一覧を更新して確認してください。",
    bulkActionFailed: "一括操作に失敗しました。",
    emptyDocuments: "アーカイブ文書はありません",
    emptyDocumentsDescription:
      "PDF、Word、Excel、JPG、PNG、WEBPをインポートしてフィールドを抽出します。",
    noEntities: "記録はありません",
    noReminders: "作成済みのリマインダーはありません",
    notifications: "通知",
    markRead: "既読にする",
    refresh: "更新",
    reidentify: "再認識",
    ...
    updated: "更新日時",
    archive: "アーカイブ",
    archiveConfirm: "「{name}」をアーカイブしますか？",
    archiveFailed: "アーカイブに失敗しました。",
    restore: "復元",
    restoreConfirm: "「{name}」を復元しますか？",
    restoreFailed: "アーカイブ記録を復元できませんでした。",
    delete: "削除",
    ...
    activate: "有効化",
    handle: "処理済みにする",
    reminderFailed: "リマインダーの更新に失敗しました。",
    queueEmpty: "確認キューは空です",
    queueEmptyDescription: "信頼度の低いフィールドがここに表示されます。",
    noVerifiedFields:
      "確認可能なフィールドがありません。再認識するか手動で確認してください。",
    documentTypes: {
      contract: "契約書",
      loan_agreement: "借用契約",
      outbound_order: "出庫記録",
  ...
  legalAssistant: {
    ...
    title: "法務アシスタント",
    homeGreeting:
      "こんにちは、LexAIです。今日はどのような法務のお手伝いをしましょうか？",
    description:
      "契約書、法令、社内資料から根拠をすばやく探し、追跡可能な法務の回答を作成します。",
    sessions: "法務セッション",
    workspaceUnavailable:
      "法律ワークスペースを利用できません。ナレッジベースに戻ります。",
    createFailed: "法務アシスタントのセッションを作成できませんでした。",
  },
  legalWorkspaceSettings: {
    description:
      "Control whether the legal workspace is visible and available in this workspace. Turning it off does not delete existing data.",
    introTitle: "Legal workspace switch",
    introDescription:
      "When enabled, workspace members can open the legal workspace from the left navigation and use Contract Review.",
    enableLabel: "Enable legal workspace",
    enableDescription:
      "Turning this off only hides the entry. Contract reviews and uploaded source documents are retained.",
    ...
    deleteDescription:
      "Permanently delete all contract reviews, source documents, clauses, and findings in this workspace. This cannot be undone.",
    deleteButton: "Delete all data",
    deleteConfirmTitle: "Delete legal workspace data?",
    deleteConfirmBody:
      "This permanently deletes every contract review, uploaded source document, clause, and finding in the current workspace. It cannot be undone. Turning off the switch above does not delete this data. Confirm that you want to continue.",
    deleteSuccess: "Legal workspace data deleted",
    deleteFailed: "Failed to delete legal workspace data: {message}",
    cancel: "Cancel",
    adminOnly:
      "Workspace admins can change this setting. Only the workspace owner can delete legal workspace data.",
  ...
  contractReview: {
    ...
    subtitle:
      "Upload a contract to review risks, recommendations, and evidence by clause.",
    ...
    noReviewsDescription: "Upload a contract to start your first review.",
    noArchivedReviews: "No archived reviews",
    noArchivedDescription: "Archived reviews will appear here.",
    draftNoDocument: "No document uploaded",
    rename: "Rename",
    renamePrompt: "Enter a new review title",
    archive: "Archive",
    unarchive: "Restore",
    delete: "Delete",
    ...
    bulkArchiveConfirm: "Archive the selected reviews?",
    bulkArchiveRunningConfirm: "Some reviews are running. Archive them anyway?",
    bulkRestoreConfirm: "Restore the selected reviews?",
    bulkDeleteConfirm: "Delete the selected reviews?",
    bulkDeleteRunningConfirm: "Some reviews are running. Delete them anyway?",
    bulkActionSuccess: "Bulk action completed",
    bulkActionPartial: "Some items were updated",
    bulkActionFailed: "Bulk action failed",
    dropContract: "Drop a contract here",
    uploadFormats: "PDF or DOCX, subject to the system size limit",
    chooseFile: "Choose file",
    singleDocument: "Single document",
    uploadingFile: "Uploading file…",
    invalidFile: "Choose a PDF or DOCX file.",
    uploadFailed: "File upload failed",
    aiReview: "AI review",
    reviewPanelTitle: "Review results",
    readyToReview: "Document ready",
    readyDescription: "Choose a review configuration to analyze the contract.",
    uploadFirst: "Upload a contract first",
    uploadFirstDescription:
      "Upload a PDF or DOCX file before starting a review.",
    model: "Review model",
    useDefaultModel: "Automatic model selection",
    noAvailableModels: "No available KnowledgeQA models",
    modelUnavailable: "Unavailable",
    modelsLoadFailed: "Could not load models; the default model will be used",
    playbook: "Playbook",
    representedParty: "Representing",
    preparingDocument: "Preparing document…",
    startReview: "Start review",
    progressiveResults: "Results appear progressively as the analysis runs.",
    reviewFailed: "Review failed",
    retry: "Retry",
    reviewAgain: "Review again",
    reconfigureReview: "Reconfigure review",
    reconfigureDescription:
      "Change the represented party, playbook, or model and run again.",
    cancel: "Cancel",
    cancelReview: "Cancel review",
    cancelReviewConfirm:
      "Cancel this contract review? Partial results will be kept and you can retry it later.",
    cancelReviewSuccess: "Review cancelled",
    cancelReviewFailed: "Could not cancel the review",
    reviewCancelled: "Review cancelled",
    configureModel: "Configure model",
    overallRisk: "Overall risk",
    overviewPending: "The overview will appear when the review finishes.",
    ...
    documentContent: "Contract document",
    retryDocument: "Reload document",
    documentLoadFailed: "Document failed to load",
    unsupportedDocumentType: "This document format is not supported",
    loadingEvidenceLocator: "Loading stable evidence locations…",
    retryEvidenceLocator: "Retry evidence locations",
    evidenceLocatorUnsupported:
      "Stable evidence locations are unavailable; reliable highlighting is disabled.",
    evidenceLocatorFailed:
      "Evidence locations failed to load; stable highlights are temporarily unavailable.",
    locateFailed: "Could not locate clause",
    resultTabs: "Review result tabs",
    errorDetailsUnavailable: "No error details were provided.",
    unknownRisk: "Risk unknown",
    summaryUnavailable:
      "The overview is unavailable; verify the finding details.",
    qualityWarnings: "Result verification notes",
    summaryDetailsMismatch:
      "The overview risk counts do not match the finding details.",
    issuesNotLoaded:
      "Finding details have not loaded, so no issues cannot be confirmed.",
    summaryMissing:
      "The review is complete, but no overview summary was provided.",
    ...
    evidenceRefs: "{count} evidence units",
    evidenceStatus: "Evidence location",
    evidenceQuote: "Original evidence",
    noEvidenceQuote: "No original evidence was provided.",
    noSuggestionDetails: "No suggested revision was provided.",
    quality: {
      complete: "Complete",
    ...
    categories: {
      ...
      parties: "Parties",
      payment: "Payment",
      delivery_acceptance: "Delivery and acceptance",
      acceptance: "Delivery and acceptance",
      liability_remedies: "Liability and remedies",
      liability: "Liability and remedies",
      term_termination: "Term and termination",
      term: "Term and termination",
      ip_confidentiality: "IP and confidentiality",
    ...
    findingTypes: {
      ...
      one_sided_term: "One-sided term",
      excessive_exposure: "Excessive exposure",
      conflicting_term: "Conflicting term",
    ...
    createFailed: "Could not create review",
    saveFailed: "Save failed",
    startFailed: "Could not start review",
  ...
  localBrowser: {
    ...
    pauseHint:
      "ブラウザー操作を中断し、再開できるようページを保持します。会話は停止しません。",
    stopHint:
      "このタスクが作成したタブを閉じ、借用したタブを返却します。ブラウザーと接続設定は保持します。",
    openPage: "ページを開く",
    switchPage: "ページを切り替え",
    readPage: "ページを確認",
    listTabs: "タブを一覧表示",
    ...
    invalidArguments:
      "ブラウザーツールの引数が無効または不完全です。エージェントによる修正が必要です。",
    commandInterrupted:
      "操作が中断されました。ページを確認してプレビューから再開してください。",
    actionFailedHint:
      "ブラウザー操作が完了しませんでした。ページを確認して再試行してください。",
    previewStale: "画面は未更新です",
    previewIdle: "最後の画面を保持しています",
    previewLive: "画面を同期中",
    previewLoading: "画面を取得中",
    helpHint:
      "確認または許可が必要です。プレビューをクリックして移動してください。",
    settingsTitle: "ブラウザー接続",
    settingsDescription:
      "BrowserSkill で手元の Chrome を接続すると、会話から実際のウェブページを操作できます。",
    openSettings: "接続設定を開く",
    settingsHint:
      "個人設定で BrowserSkill を接続すると、ここでローカルブラウザーを利用できます。",
    unavailable:
      "サーバーでローカルブラウザーが有効になっていません。管理者に連絡してください。",
    source: "ブラウザーの接続先",
    sandbox: "サンドボックス",
    local: "ローカルブラウザー",
    paused: "一時停止中",
    ...
    stop: "ブラウザータスクを終了",
    pairHint:
      "拡張機能の「リモート接続」にリンクを貼り付け、サーバーを確認します。",
    copyPairing: "ペアリングリンクをコピー",
    copied: "コピーしました",
    windowHint:
      "タスクはラベル付きのタブグループで実行されます。既存タブには許可が必要です。",
    preview: "ローカルブラウザーのプレビュー",
    waiting: "タスクのページを待っています",
    startHint:
      "ブラウザーのタスクを送ると、バックグラウンドにタスクタブを作成します。",
    revoke: "デバイスの認証を取り消す",
    revokeConfirm:
      "取り消すと、ローカルブラウザーを使うには再度ペアリングが必要です。",
    ...
    reconnectHint:
      "認証は保存されています。Chrome と拡張機能を開くと自動的に再接続します。",
    ...
    packageUnavailable:
      "対応する拡張機能パッケージを管理者から入手してください。",
    manualCopy:
      "下のリンクをコピーしてください。有効期限は 5 分、使用は 1 回限りです。",
    pairingReady:
      "コピーしました。5 分以内に拡張機能に貼り付けてください。1 回限り有効です。",
    copyAgain: "再コピー",
    usageTitle: "使い方",
    usageStep1Title: "拡張機能をインストール",
    usageStep1Text:
      "拡張を解凍し、Chrome の拡張機能ページでデベロッパーモードを有効にして読み込みます。",
    usageStep2Title: "ブラウザーをペアリング",
    usageStep2Text:
      "ペアリングリンクをコピーし、拡張機能の「リモート接続」に貼り付けてサーバーを確認します。同じスペースの会話で共有されます。",
    usageStep3Title: "会話でタスクを伝える",
    usageStep3Text:
      "入力欄でローカルブラウザーをオンにし、行うウェブタスクを伝えてください。ラベル付きのタブグループで実行されます。",
    usageStep4Title: "プレビューで確認・再開",
    usageStep4Text:
      "会話に小さなプレビューが表示されます。クリックするとタスクタブに移動できます。中断したタスクは再接続後も一時停止するので、プレビューから再開してください。既存タブには許可が必要です。",
    running: "実行中",
  ...
  menu: {
    ...
    clearMessagesFailed:
      "メッセージのクリアに失敗しました。しばらくしてから再試行してください",
    renameSession: "タイトルを変更",
    renameSessionSuccess: "タイトルを更新しました",
    renameSessionFailed:
      "タイトルの更新に失敗しました。しばらくしてから再試行してください",
    batchManage: "一括管理",
    newSession: "新しいチャット",
    pin: "ピン留め",
    unpin: "ピン留めを解除",
    ...
    unpinFailed:
      "ピン留めの解除に失敗しました。しばらくしてから再試行してください",
    search: "検索",
  ...
  chatHeader: {
    ...
    clearConfirmBody:
      "この会話のメッセージをすべてクリアしますか？会話自体は残りますが、この操作は取り消せません。",
  ...
  contextualGuide: {
    ...
    tenantModels: {
      needChatModelFirst:
        "エージェントを作成する前に、チャットモデル（KnowledgeQA）を追加してください。",
      steps: {
        intro: {
          title: "まずモデルを設定",
  ...
  batchManage: {
    ...
    deleteConfirmTitle: "会話を削除",
    deleteConfirmBody:
      "選択した{count}件の会話を削除してもよろしいですか？この操作は取り消せません。",
    deleteAllConfirmBody:
      "すべての会話を削除してもよろしいですか？この操作は取り消せません。",
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      rootRow: "ルート",
      rootRowTip:
        "ナレッジベースのルート。サブフォルダに属さないドキュメントはここに置かれます",
    ...
    tagDeleteDescDoc:
      "タグ「{name}」を削除しますか？このタグが付いたドキュメントもすべて削除されます。",
    ...
    videosFilteredNoVLM:
      "{count}件の動画ファイルをスキップしました（動画のアップロードには対応していません）",
    unsupportedTypesHint:
      "一部のドキュメント形式（{types}）は利用できる解析エンジンがないため、アップロードしても解析できません",
    ...
    urlTip:
      "さまざまなWebページの内容をインポートできます。システムがWebページからテキストを自動で抽出して解析します",
    typeURL: "URL",
    typeManual: "手動作成",
    typeFile: "ファイル",
    ...
    confirmDeleteQuestion:
      "この質問を削除してもよろしいですか？対応するベクトルインデックスも削除されます。",
    legacyQuestionCannotDelete:
      "旧形式の質問は削除できません。質問を再生成してください。",
    customMetadata: "カスタムメタデータ",
    metadataCapabilityHint:
      "ドキュメントの要約に使用され、検索後はドキュメントレベルのコンテキストとして利用されます。インデックスには含まれず、検索順位にも影響しません",
    ...
    metadataNumberRequired:
      "メタデータ項目{key}には有効な数値を入力してください",
    ...
    summaryRefreshQueued:
      "要約の更新を登録しました。完了すると自動的に反映されます",
    indexFailed: "インデックスの同期に失敗しました",
    chunkSavedIndexFailed:
      "内容は保存されましたが、インデックスの同期に失敗しました。「インデックスを再試行」を実行してください。",
    chunkEditConflict:
      "このチャンクは他のユーザによって変更されました。一覧を更新しましたので、再試行してください。",
    ...
    noContentChanges:
      "内容の変更はありません。このバージョンではステータスのみ変更されました",
    revertRevision: "このバージョンに戻す",
    revertRevisionConfirm:
      "v{revision}に戻しますか？新しいバージョンが作成されます。",
    ...
    staleGeneratedQuestions:
      "編集前の内容から生成された質問です。必要に応じて再生成してください",
    noGeneratedQuestions: "検索用質問はありません",
    notInitialized:
      "ナレッジベースが初期化されていません。ファイルをアップロードする前に、設定でモデルを設定してください",
    missingStorageEngine:
      "このナレッジベースにはストレージエンジンが選択されていません。コンテンツをアップロードする前に、設定でストレージエンジンを設定してください。",
    missingStorageEngineUpload:
      "コンテンツをアップロードする前にストレージエンジンを設定してください",
    goToStorageSettings: "設定を開く",
    getInfoFailed:
      "ナレッジベース情報の取得に失敗したため、ファイルをアップロードできません",
    ...
    rebuildConfirm:
      "ドキュメント「{fileName}」を再構築しますか？既存のチャンクを削除して、再度解析します。",
    rebuildSubmitted: "再構築タスクを登録しました",
    rebuildFailed: "再構築に失敗しました。しばらくしてから再試行してください",
    rebuildInProgress:
      "このドキュメントは現在解析中です。しばらくしてから再試行してください",
    cancelParse: "解析を停止",
    cancelParseConfirmBody:
      "「{title}」の解析を停止しますか？書き込み済みのチャンクは保持され、後から「再構築」で再解析できます。最適化段階（要約／Q&A／ナレッジグラフ）の未実行タスクはすぐに破棄されます。",
    ...
    moveNoTargets:
      "移動可能なナレッジベースがありません（同じタイプかつ同じ埋め込みモデルである必要があります）",
    moveModeReuseVectors: "ベクトルを再利用（高速）",
    moveModeReuseVectorsDesc:
      "チャンクとベクトルインデックスをそのまま移動します。チャンク分割設定が同じ場合に使用してください。",
    moveModeReparse: "再解析",
    moveModeReparseDesc:
      "移動先ナレッジベースのチャンク分割設定でドキュメントを再解析します。",
    moveConfirm: "移動を確定",
    ...
    confirmDeleteDocument:
      "ドキュメント「{fileName}」を削除しますか？削除後は復元できません",
    confirmDelete: "削除を確定",
    viewModeGrid: "グリッド表示",
    viewModeList: "リスト表示",
    ...
    batchDownloadHint:
      "1回につき最大200件、元ファイル合計512 MiBまでZIPでダウンロードできます。全選択は読み込み済み文書のみ対象で、元ファイルのないウェブページはスキップされます。ZIPはフォルダ構造を保持します。",
    batchDownloadStarted:
      "ZIPの保存を開始しました。展開してからファイルとフォルダをアップロードしてください。",
    batchDownloadFailed: "Batch download failed",
    batchDownloadSkipped: "元ファイルのない文書を{count}件スキップしました。",
    batchDownloadNoFiles:
      "選択した文書にダウンロードできる元ファイルがありません。",
    batchDownloadTooLarge:
      "選択したファイルの合計が512 MiBを超えています。件数を減らして分批ダウンロードしてください。",
    selectLoaded: "読み込み済みを選択",
    confirmBatchDeleteDocument:
      "選択した{count}件のドキュメントを削除しますか？この操作は取り消せません。",
    deleteSubmitted: "削除リクエストを送信しました。完了までお待ちください。",
    deletePending: "削除はまだ処理中です。後で更新して結果を確認してください。",
    deleteTaskFailed:
      "削除に失敗しました。ドキュメントのエラー詳細を確認して再試行してください。",
    deleteStatusUnavailable:
      "削除結果を確認できませんでした。後で更新してドキュメントのステータスを確認してください。",
    ...
    reparseFailedDocumentsSuccess:
      "Submitted {count} failed document(s) for reparsing",
    ...
    batchTagSubtitle:
      "選択した{count}件のドキュメントにタグを設定します（既存のタグは置き換えられます）",
    ...
    confirmBatchReparseDocument:
      "選択した{count}件のドキュメントを再構築しますか？既存の内容は削除され、各ドキュメントが再解析されます。",
    ...
    emptyKnowledgeDragDrop:
      "ナレッジがありません。ドラッグ＆ドロップでアップロードできます",
    ...
    operationNotSupportedForType:
      "この操作は現在のナレッジベースのタイプでは利用できません",
    allFilesSkippedNoEngine:
      "利用可能な解析エンジンがないため、選択したすべてのファイルをスキップしました",
    filesSkippedNoEngine:
      "利用可能な解析エンジンがないため、{count}件のファイルをスキップしました",
    allUploadSuccess: "すべてのファイルをアップロードしました（{count}件）",
    partialUploadSuccess:
      "一部のファイルをアップロードしました（成功: {success}件、失敗: {fail}件）",
    allUploadFailed:
      "すべてのファイルのアップロードに失敗しました（{count}件）",
  ...
  uploadConfirm: {
    ...
    tabTags: "ドキュメントのタグ",
    tagsDescription:
      "今回のインポート対象すべてのドキュメントに付けるタグを選択してください",
    tagsPlaceholder: "タグを選択（複数選択可）",
    tagsEmpty:
      "このナレッジベースにはタグがありません。アップロード後にタグ管理から作成できます。",
    tagsLoadFailed:
      "タグの読み込みに失敗しました。後からドキュメント一覧で設定できます。",
    ...
    multimodalSetupHint:
      "画像が含まれています。マルチモーダルを有効にしてモデルを選択してください。",
    asrSetupHint:
      "音声が含まれています。音声認識を有効にしてモデルを選択してください。",
    vlmModelRequired: "マルチモーダルモデルを設定してください",
    asrModelRequired: "音声認識モデルを設定してください",
    vlmModelSelectRequired:
      "マルチモーダルが有効です。VLMモデルを選択してください。",
    asrModelSelectRequired: "音声認識が有効です。ASRモデルを選択してください。",
    pdfForceScanned: {
      label: "スキャンPDFとして強制解析",
      description:
        "Web印刷、スキャン、画像が多いPDFに有効です。全ページを画像としてレンダリングし、OCR／VLMで処理します。処理時間とモデル費用が増える場合があります。",
    },
    continueAdd: "続けて追加",
    ...
    folderUploadHint:
      "全{count}件のファイル。ローカルのフォルダ構成が保持されます",
  },
  knowledgeStages: {
    title: "処理パイプライン",
    root: "ナレッジ処理",
    ...
    rowSelectHint:
      "クリックすると詳細を表示します。矢印で子項目を展開または折りたたみます",
    ...
    head: {
      ...
      postprocessTasks:
        "後処理: 実行中{running}件／失敗{failed}件／完了{completed}件",
      completedWithActiveTrace:
        "処理は完了しましたが、{n}件のトレースタスクがまだ実行中です",
      attempt: "試行",
      updated: "更新",
    },
    tab: {
    ...
    detail: {
      ...
      metadataHint:
        "可観測性のための補助項目です（LangfuseのトレースIDなど）。各ステージやサブspanの内容は「入力」「出力」で確認できます。",
      metadataEmpty:
        "このspanにはメタデータがありません。ステージの内容は「入力」「出力」を参照してください。Langfuseを連携している場合、トレースレベルの項目は「概要」に表示されます。",
      error: "エラー",
      empty: "データなし",
      inProgress: "実行中",
      elapsed: "経過時間",
      placeholderHint:
        "このステージには詳細なspanの記録がなく、推定された状態のみを表示しています。",
      showJson: "JSONを展開",
      hideJson: "JSONを折りたたむ",
  ...
  agent: {
    ...
    artifactDrawer: {
      ...
      title: "生成されたファイル",
      empty:
        "今回のやり取りでダウンロード可能なファイルは生成されませんでした。",
      preview: "プレビュー",
      previewBack: "一覧に戻る",
    ...
    title: "エージェント",
    subtitle:
      "エージェントを設定・管理して、会話の動作と機能をカスタマイズします",
    ...
    empty: {
      ...
      description:
        "右上のボタンをクリックして最初のエージェントを作成してください",
      sharedTitle: "共有されたエージェントはありません",
      sharedDescription:
        "スペースに参加するか、他のユーザにエージェントの共有を依頼してください",
      favoritesTitle: "お気に入りはありません",
      favoritesDescription:
        "エージェントのカード右上にある星マークをクリックすると、お気に入りに追加できます",
    ...
    delete: {
      ...
      confirmMessage:
        "エージェント「{name}」を削除してもよろしいですか？この操作は取り消せません。",
      confirmButton: "削除を確定",
    },
    messages: {
    ...
    editor: {
      ...
      postCreateHint: {
        title: "作成しました",
        footer:
          "引き続き設定を調整し、共有と公開チャネルを設定してから「保存して閉じる」をクリックしてください。",
        integrationDesc:
          "連携センターでIM、Web埋め込みなどの公開チャネルを設定できます",
      },
      basicInfo: "基本情報",
      basicInfoDesc: "エージェントの名前、説明、実行モードを設定します",
      promptsConfig: "プロンプト",
      promptsConfigDesc:
        "システム、コンテキスト、意図判定、リライト、フォールバックの各プロンプトを設定します",
      modelConfig: "モデル設定",
      modelConfigDesc:
        "チャットモデル、補助モデル（リランク）、生成パラメータを設定します",
      toolsConfig: "ツール",
      toolsConfigDesc: "エージェントが利用できるツールを設定します",
      knowledgeConfig: "ナレッジベース",
      knowledgeConfigDesc:
        "エージェントのナレッジベース範囲とFAQ戦略を設定します",
      ...
      queryMissingInRewrite:
        "リライト用ユーザプロンプトには{'{{'}query{'}}'}プレースホルダが必要です",
      queryMissingInFallback:
        "フォールバックプロンプトには{'{{'}query{'}}'}プレースホルダが必要です",
      description: "説明",
      ...
      systemPromptPlaceholder:
        "エージェントの動作と役割を定義するカスタムシステムプロンプト（{'{{'}web_search_status{'}}'}プレースホルダでWeb検索の挙動を動的に切り替えられます）",
      contextTemplateRequired: "コンテキストテンプレートは必須です",
      temperature: "Temperature",
      thinking: "思考モード",
      citationEnabled: "出典を表示",
      citationEnabledDesc:
        "最終回答にナレッジベースとWebの出典を表示します。無効にしても検索と根拠付けは機能します",
      mode: "実行モード",
      webSearch: "Web検索",
      ...
      selectKnowledgeBasesDesc:
        "紐付けるナレッジベースを選択してください（共同利用のものを含む）",
      ...
      retrieveKBOnlyWhenMentionedDesc:
        "オフ: 設定済みのナレッジベースを自動で検索します。オン: ユーザが{'@'}で指定した場合のみ検索します",
      rerankModel: "リランクモデル",
      rerankModelDesc: "ナレッジベースの検索結果を並べ替えて精度を高めます",
      rerankModelPlaceholder: "リランクモデルを選択",
      rerankModelOptionalHint:
        "現在の範囲にRAG型のナレッジベースがないため任意です。後からRAG型ナレッジベースを追加した場合は、ワークスペースのデフォルトリランクモデルが自動的に使用されます。明示的に設定することを推奨します。",
      ...
      queryUnderstandModelPlaceholder:
        "空欄の場合はメインのチャットモデルを使用します",
      rewritePromptSystem: "リライト用システムプロンプト",
      rewritePromptSystemPlaceholder:
        "空欄の場合はデフォルトのプロンプトを使用します",
      rewritePromptUser: "リライト用ユーザプロンプト",
      rewritePromptUserPlaceholder:
        "空欄の場合はデフォルトのプロンプトを使用します",
      ...
      fallbackResponsePlaceholder:
        "申し訳ありませんが、この質問にはお答えできません。",
      fallbackPrompt: "フォールバックプロンプト",
      fallbackPromptPlaceholder:
        "空欄の場合はデフォルトのプロンプトを使用します",
      skillsConfig: "スキル",
      skillsConfigDesc:
        "実行中のサンドボックスを選択してから、下でスキルを選択してください。そのサンドボックスにないスキルには「インストール」が表示され、インストール後にのみ選択できます。",
      skillsSelection: "スキル一覧",
      skillsSelectionDesc:
        "ワークスペースのスキルがすべて表示されます。インストール済みのものはすぐに使用でき、それ以外は先にインストールが必要です。",
      skillsAll: "すべて",
      skillsSelected: "選択中",
      skillsNone: "無効",
      selectSkillsDesc:
        "このエージェントに使わせるスキルにチェックを入れてください。未インストールのスキルは選択できません。まず右側の「インストール」をクリックしてください。",
      skillsAllListHint:
        "「すべて」に含まれるのは、このサンドボックスにインストール済みのスキルのみです。未インストールのスキルは、インストールするまで追加されません。",
      ...
      sandboxBackendHint:
        "サンドボックスを選択するまでスキルのスクリプトは実行されません。",
      sandboxBackendMissing: "設定が削除されました",
      sandboxNoConfigs:
        "このワークスペースにはサンドボックスがないため、スキルのスクリプトは実行されません。",
      selectSkills: "スキルを選択",
  ...
  settings: {
    ...
    autoCheckUpdateDesc:
      "有効にすると、バックグラウンドで最新バージョンを自動的に確認・ダウンロードします。",
    ...
    sandbox: {
      title: "サンドボックス設定",
      description:
        "エージェントのスキルスクリプトを実行する隔離環境を設定します。各エージェントはワークスペースの設定を1つ選択します。",
      pageHintTitle: "サンドボックスとは？",
      pageHint:
        "サンドボックスは、エージェントのスキルスクリプトが実行される隔離環境です。ワークスペースには複数の設定（Docker、E2B、CubeSandbox）を持たせることができ、各エージェントが1つを選択します。スキルは「スキル管理」ページから、選択した設定のイメージにインストールされます。設定を選択するまでスクリプトは無効のままです。",
      editorDescription:
        "ワークスペースのランタイムを設定します。Docker、CubeSandbox、E2Bは同じ管理フローを使用します。",
      stepConnection: "接続",
      stepTemplate: "テンプレート",
      stepRuntime: "ランタイム",
      stepSkills: "スキル",
      stepSkillsLocked:
        "スキルはこの設定のイメージにインストールされます。先に設定を保存してから、このステップに戻ってください。",
      setupProgress: "サンドボックス設定の進捗",
      stepDescriptions: {
        connection:
          "バックエンドを設定し、テンプレートを読み込む前に接続を確認します。",
        template:
          "接続したクラスタから返された既製のテンプレートを選択します。",
        runtime:
          "実行設定、環境変数、スキルイメージの更新を適用するタイミングを設定して保存します。",
        skills:
          "この設定のサンドボックスイメージにスキルをインストールします。設定を保存すれば、いつでも戻って作業できます。",
      },
      back: "戻る",
      ...
      scriptPolicyDesc:
        "オフにすると、このワークスペースのエージェントはスキルの内容を読むことしかできません。すでに実行中のリモートサンドボックスは、セッション終了時に解放されます。",
      backendDescriptions: {
        cube: "プライベート環境やオンプレミス向けのセルフホストMicroVMクラスタ",
        e2b: "マネージドMicroVMサービス、またはE2B互換のデプロイ",
        docker:
          "このWeKnoraホスト上でセッションごとに長時間稼働するコンテナを保持します。スクリプトとファイルはそのコンテナ内に残ります",
      },
      dockerDisabledAlert:
        "このデプロイではDockerサンドボックスが有効になっていません",
      dockerDisabledHint:
        "ローカルのdocker.sockはホスト上のroot権限に相当します。単一マシンのプライベート環境では、システム管理者が「設定 → システム設定 → ネットワークセキュリティ」から有効化できます。",
      dockerDisabledCard:
        "このデプロイではDockerサンドボックスが無効です。この設定ではコンテナは作成されません",
      dockerHostRisk:
        "空欄またはunix://を指定するとWeKnoraホストのDockerデーモンを使用します。これはそのマシンのroot権限に相当します。単一ノードのプライベート環境でのみ使用してください。複数のワークスペースがホストを共有する場合はCubeまたはE2Bを推奨します。リモートのtcp://エンドポイントにはTLS証明書ディレクトリが必要です。",
      ...
      networkHint:
        "この設定を使用するすべてのサンドボックスの外向き通信を制御します。変更は新しく作成されるサンドボックスにのみ適用され、既存のサンドボックスは回収されるまで従来のポリシーを維持します。",
      egressDefault: "デフォルトの外向き通信",
      egressAllowAll: "パブリックネットワークを許可（デフォルト）",
      egressDenyAll: "デフォルトで拒否",
      egressPrecedence:
        "評価順序: 許可、拒否、デフォルトの順です。許可ルールは拒否ルールより優先されます。",
      allowOut: "許可する宛先",
      allowOutPlaceholder: "ドメイン / IP / CIDR（例: *.example.com）",
      allowOutHelp:
        "IPv4、CIDR、ドメイン、および*.example.comのような単一ラベルのワイルドカード（ルートドメインには一致しません）に対応します。",
      denyOut: "拒否する宛先",
      denyOutPlaceholder: "IP / CIDRのみ（例: 169.254.169.254/32）",
      denyOutHelp:
        "拒否ルールは宛先IPのみに一致するため、ドメインは指定できません。",
      domainAllowNeedsDenyAll:
        "許可する宛先にドメインを含める場合は、「デフォルトで拒否」を選択するか、拒否する宛先に0.0.0.0/0を追加してください。そうしないと許可リストが機能しません。",
      cubeL7Rules: "HTTPアクセスルール（L7）",
      cubeL7RulesHelp:
        "すべてのルールにhostまたはsniが必要です。ネットワーク層はこれらのフィールドからのみ許可対象を判断します。フィールドはAND、メソッドはORで評価されます。HTTP 80 / HTTPS 443にのみ適用されます。ルールは上から順に、最初に一致したものが適用されます。",
      e2bHostRules: "ホストごとのリクエスト変換",
      e2bHostRulesHelp:
        "ホストごとにヘッダーを挿入します。ルール自体は外向き通信を許可しません。対象のホストは許可する宛先にも登録する必要があります。",
      ruleUntitled: "無題のルール",
      expandRule: "ルールを展開",
      ...
      removeRule: "ルールを削除",
      noConfigs:
        "サンドボックスがまだありません。ワークスペース設定のないエージェントはスキルスクリプトを実行できません。",
      identityFieldHint:
        "この設定がサンドボックスを保持している間は、バックエンドの種類、APIエンドポイント、APIキー、サンドボックスドメイン、プロキシエンドポイントを変更できません。",
      connectionLockedBySkills:
        "このサンドボックスにはすでにスキルがあります。接続情報・認証情報・DNSを変更するとスキルのスナップショットの参照先が変わり、DNSはテンプレートの再構築後にのみ反映されます。代わりに新しいサンドボックスを作成してください。",
      connectionLockedByInFlight:
        "スキルのインストールまたは削除が進行中です。完了するまで接続情報・認証情報・DNSは変更できません。",
      viewSandboxes: "実行中のインスタンス",
      inventoryTitle: "実行中のインスタンス",
      inventoryDrawerDesc:
        "この設定がまだ保持しているサンドボックスと、影響を受けるセッション・エージェントです。",
      ...
      inventoryUnverifiableHint:
        "バックエンドに接続できないため、サンドボックス数は不明です。これは「0件」であることを意味しません。",
      ...
      sandboxesStillLive:
        "この設定は実行中または一時停止中のサンドボックスを{count}件保持しているため、識別情報の項目はまだ変更できません。",
      blockedHint:
        "該当するセッションを終了または削除するか（セッションを削除するとサンドボックスも破棄されます）、2つ目の設定を作成してエージェントの参照先を変更してください。",
      unverifiableBlocked:
        "バックエンドに接続できずサンドボックスの残存を確認できないため、保存済みの認証情報は上書きされません。",
      unverifiableSaveHint:
        "まず接続を復旧してください。バックエンドが完全に失われた場合は、2つ目の設定を作成してエージェントの参照先を変更してください。",
      ...
      confirmDeleteWithAgents:
        "サンドボックス「{name}」を削除しますか？{agents}これらのエージェントは次回のスキル実行時に失敗します。",
      deleteFailed: "削除に失敗しました",
      deleted: "削除しました",
      forceDeleteTitle: "サンドボックスの使用状況を確認できません",
      forceDeleteConfirm:
        "バックエンドに接続できず、サンドボックスが残っているか確認できません。バックエンドが完全に失われた場合はこの設定を強制削除できますが、一時的に接続できないだけの場合、強制削除すると残ったサンドボックスを回収する手段がなくなります。それでも強制削除しますか？",
      forceDelete: "強制削除",
      ...
      legacyConfig: "非推奨",
      namedBackendHint:
        "ワークスペース設定が唯一のランタイムの供給元です。設定のないエージェントはスキルスクリプトを実行できません。",
      weknoraTemplateTitle: "WeKnora標準テンプレート",
      weknoraDockerImage: "WeKnora標準イメージ",
      weknoraDockerImageHint:
        "セッションごとに専用の長時間稼働コンテナが割り当てられます。スクリプト、シェルコマンド、ファイルはすべてこのコンテナを共有し、セッション終了またはアイドルタイムアウトによる回収まで保持されます。",
      weknoraTemplateOverview:
        "WeKnoraが標準ランタイムを提供します。テンプレートは接続後に検出され、存在しない場合は標準テンプレートが作成されます。",
      weknoraTemplateDescription:
        "WeKnoraのスキルが必要とするPython、Node.js、CLIツール、ワークスペースパス、非root実行ユーザが含まれます。",
      recommendedTag: "推奨",
      ...
      templateSelectHelp:
        "テンプレートはこのクラスタから読み込まれます。保存した設定にはIDが自動的に記録されます。",
      templateSelectPlaceholder:
        "クラスタに接続してテンプレートを読み込んでください",
      templateLoadHint:
        "クラスタの接続情報を入力して更新してください。公式のCLIテンプレートがない場合はHubイメージから自動構築します。デスクトップテンプレートはサイズが大きいため、下の行から個別に作成してください。DNSやイメージを変更した場合は、該当カードから再構築してください。",
      templateLoadFailed: "テンプレートの読み込みに失敗しました",
      standardTemplateProvisioning:
        "WeKnora標準テンプレートを作成しています。しばらくしてから更新してステータスを確認してください。",
      standardTemplateReplaced:
        "以前の標準テンプレートを削除し、再構築を開始しました。完了までお待ちください。",
      templateNotReady:
        "選択したテンプレートは準備ができていません。更新してビルドの完了をお待ちください。",
      connectionPassed:
        "接続を確認しました。以下のテンプレートはこのクラスタから読み込まれています。",
      connectionPassedTitle: "クラスタに接続しました",
      templateStepHint:
        "このステップではクラスタのテンプレートを表示し、公式のCLIイメージがなければHubから構築します。デスクトップ（XFCE）テンプレートはサイズが大きいため、「作成」を押したときだけ構築します。DNSやイメージを変更した場合は該当カードから「再構築」してください。テンプレートの準備ができたら次へ進めます。",
      loadingTemplates: "クラスタからテンプレートを読み込み中...",
      templateBuildingHint:
        "テンプレートをビルド中です。このリストは自動的に更新されます。",
      templateUntaggedHint:
        "ビルドは完了しましたが、デフォルトタグが付いたものがないため、サンドボックス作成時にこのテンプレートを解決できません。E2Bで削除して更新すると、WeKnoraが再構築します。",
      ...
      createStandardTemplateHint:
        "DNSを含む現在の接続設定でビルドされます。設定を変更した場合は、カードから再構築してください。",
      weknoraDesktopTemplate: "WeKnoraデスクトップテンプレート",
      createDesktopTemplate: "作成",
      createDesktopTemplateHint:
        "公式デスクトップイメージからXFCEグラフィカルデスクトップを構築します。CLIテンプレートよりはるかに大きいため、GUIが必要なときだけ作成してください。",
      replaceStandardTemplate: "再構築",
      replaceStandardTemplateConfirm:
        "DNSを含む現在の設定でWeKnora標準テンプレートを再構築します。既存の起動可能なテンプレートは、新しいテンプレートの準備が整うまで削除されません。",
      desktopTemplateProvisioning:
        "WeKnoraデスクトップテンプレートを作成しています。しばらくしてから更新してステータスを確認してください。",
      desktopTemplateReplaced:
        "以前のデスクトップテンプレートを削除し、再構築を開始しました。完了までお待ちください。CLIテンプレートは変更しません。",
      desktopTemplateTag: "デスクトップ",
      replaceDesktopTemplateConfirm:
        "DNSを含む現在の設定でWeKnoraデスクトップテンプレートを再構築します。既存の起動可能なデスクトップテンプレートは、新しいテンプレートの準備が整うまで削除されません。CLIテンプレートは変更しません。",
      templateLockedBySkills:
        "このサンドボックスにはすでにスキルがあります。スキル環境は現在のスナップショットに紐づいているため、ランタイムテンプレートの変更や再構築はできません。新しいサンドボックスを作成し、新しいテンプレートからスキルをインストールしてください。",
      templateLockedByInFlight:
        "スキルのインストールまたは削除が進行中です。完了するまでランタイムテンプレートの変更や再構築はできません。",
      ...
      templateProvisioningHint:
        "テンプレートをビルド中です。ステータスは自動的に更新されます。",
      templateStatuses: {
        ready: "準備完了",
        building: "ビルド中",
        untagged: "デフォルトタグなし",
      ...
      allowPrivateEndpointsHint:
        "セルフホストのプライベートコントロールプレーン向けです。リンクローカルアドレスとクラウドメタデータアドレスは引き続きブロックされます。",
      howToBuildTemplate: "サンドボックスクラスタの構築とテンプレートのガイド",
      noEnvVars: "追加の環境変数はありません。",
      fieldRequired: "必須",
      cubeApiKeyOptional:
        "任意。認証なしのセルフホストCubeSandboxでは空欄のままにしてください",
      cubeApiKeyWhere: "セルフホストクラスタで認証を有効にする方法",
      cubeDnsServers: "DNSサーバ",
      cubeDnsServersHelp:
        "任意。WeKnora標準テンプレートに書き込まれるネームサーバのIPです。空欄の場合はクラスタのデフォルト（通常は119.29.29.29）を使用します。パブリックリゾルバへのUDP/53がブロックされている場合は、Cubeホストの/etc/resolv.confから到達可能なアドレス（10/8、172.16/12、192.168/16を除く）を指定してください。既存の標準テンプレートには、テンプレートカードで「再構築」を実行した後にのみ反映されます。",
      cubeDnsServersPlaceholder: "例: 8.8.8.8（Enterで追加）",
      e2bApiKeyHelp:
        "E2BダッシュボードのAPI Keysページで作成します。通常はe2b_で始まります。",
      e2bApiKeyWhere: "E2BダッシュボードでAPIキーを取得",
      apiKeyPlaceholder: "APIキーを貼り付け",
      secretConfigured:
        "キーは設定済みです（再表示されません）。更新するには新しい値を入力してください",
      ...
      e2bProxyUrlOptional:
        "セルフホストのE2B互換クラスタのデータプレーンゲートウェイです。空欄の場合は、E2B Cloudと同様にサンドボックスドメイン経由でサンドボックスに接続します。",
      backends: {
        disabled: "無効",
        local: "ローカルプロセス",
        docker: "Docker",
      ...
      httpTimeoutHelp:
        "バックエンドへの管理呼び出しの待ち時間の上限です。これを超えるとエンドポイントは到達不能とみなされます。空欄の場合は30秒です。",
      sandboxTtl: "サンドボックスTTL（秒）",
      sandboxTtlHelp: "サンドボックスが一時停止されるまでの時間",
      dockerImage: "Dockerイメージ",
      dockerHost: "Dockerデーモンのエンドポイント",
      dockerHostHelp:
        "空欄の場合はローカルのdocker CLI（DOCKER_HOSTまたは現在のdockerコンテキスト）に従うため、/var/run/docker.sockを入力する必要はありません。リモートデーモンを使う場合はtcp://host:2376を指定してTLS証明書ディレクトリを入力し、RFC1918アドレスでは「プライベートエンドポイントを許可」を有効にしてください。",
      dockerTlsCertPath: "TLS証明書ディレクトリ",
      dockerTlsCertPathHelp:
        "WeKnoraホスト上でca.pem、cert.pem、key.pemを格納しているディレクトリです。リモートデーモンでは必須です。証明書はデプロイ側でマウントされ、ここには保存されません。",
      dockerIdleTtl: "アイドル回収（秒）",
      dockerIdleTtlHelp:
        "Dockerデーモン自体にはアイドルタイムアウトがありません。この時間コマンドが実行されなかったコンテナはWeKnoraが回収し、セッションが続く場合は再作成します。空欄の場合は1800秒です。",
      dockerCpuLimit: "CPUコア数の上限",
      dockerCpuLimitHelp:
        "サンドボックス1つが使用できるCPUコア数です。0の場合は組み込みのデフォルトを使用します。",
      dockerMemoryLimit: "メモリ上限（MB）",
      dockerMemoryLimitHelp:
        "サンドボックス1つのメモリ上限（MB）です。0の場合は組み込みのデフォルトを使用します。",
      dockerPidsLimit: "プロセス数の上限",
      dockerPidsLimitHelp:
        "サンドボックス1つが作成できるプロセスの最大数です。0の場合は組み込みのデフォルトを使用します。",
      dockerNetworkMode: "ネットワークモード",
      dockerNetworkModeHelp:
        "デフォルトはbridgeで、スキルがパッケージをインストールするために必要です。外向き通信を完全に遮断するにはnoneを選択してください。Dockerはネットワーク単位でのみ制御でき、ドメインごとのルールは指定できません。",
      dockerNetworkBridge: "bridge（外向き通信を許可）",
      dockerNetworkNone: "none（外向き通信なし）",
      defaultTimeout: "実行タイムアウト（秒）",
      defaultTimeoutHelp:
        "スキルスクリプト1回あたりの最長実行時間です。これを超えると強制終了されます。空欄の場合は60秒です。",
      terminalIdleDisconnect: "ターミナル / デスクトップのアイドル切断（秒）",
      terminalIdleDisconnectHelp:
        "ターミナルまたはデスクトップを開いた後、この時間だけ操作がなければ接続を切断し、サンドボックスはTTLに従って一時停止します。ターミナルはキーボードとPTY出力、デスクトップはマウスとキーボードを見ます。空欄の場合は900秒、最短60秒、最長24時間です。",
      envVars: "環境変数",
      envKey: "名前",
      envValue: "値",
      envVarsHint:
        "この設定から作成されるサンドボックスに注入されます。値は保存時に暗号化されますが、サンドボックス内のスクリプトからは参照できます。\n注入はサンドボックス作成時のみです。実行のたびに注入する場合は「サンドボックスのシークレット」ページで追加してください。",
      addRow: "変数を追加",
      removeRow: "削除",
      save: "保存",
      ...
      recheck: "再検証",
      deepCheckIntro:
        "完全検証では、使い捨てのサンドボックスを作成してスクリプトを1回実行し、外向き通信を確認したうえで破棄します。",
      deepCheckConfirm:
        "完全検証では使い捨てのスクリプトを実行します。リモートバックエンドの場合は実際のサンドボックスの作成と破棄も行われ、わずかにサンドボックス時間を消費します。続行しますか？",
      checkPassed: "すべてのチェックに合格しました",
      checkFailed: "一部のチェックに失敗しました",
      checkScopeConnection:
        "今回はコントロールプレーンのみを検証しました。エンドポイントは応答し、認証情報も有効です。実際にスクリプトが実行できるかどうかはまだ検証されていません。",
      checkScopeFull:
        "エンドポイント、認証情報、テンプレート、サンドボックス内での実行、外向き通信のすべてを実際に検証しました。",
      checkScopePolicyRestricted:
        "ポリシーにより外向き通信が制限されているため、外向き通信は検査していません。エンドポイント、認証情報、テンプレート、サンドボックス内での実行は検証済みです。",
      checkPendingHint:
        "{names}は完全検証でのみ確認できます。完全検証では使い捨てのサンドボックスを作成してスクリプトを1回実行し、破棄します。",
      skipReasons: {
        needs_deep_check: "完全検証が必要",
        control_plane_unreachable:
          "スキップ: コントロールプレーンに接続できません",
        sandbox_not_created: "スキップ: サンドボックスが作成されませんでした",
        sandbox_exec_failed: "スキップ: サンドボックス内での実行に失敗しました",
        egress_restricted_by_policy:
          "ネットワークポリシーにより制限（この設定はデフォルトで外向き通信を拒否します）",
      },
      checks: {
      ...
      skillInstallerModelHint:
        "組み込みのインストーラエージェントが使用します。ツール呼び出しに対応したチャットモデルを選択してください。",
      ...
      skillRolloutHint:
        "スキルのインストールまたは削除を行うと、新しいイメージがビルドされます。ここでは、開いているセッションを新しいイメージに切り替えるかどうかを指定します。",
      skillRolloutNextTurn:
        "開いているセッションは次のやり取りでサンドボックスを再構築する",
      skillRolloutNewSession:
        "開いているセッションは現在のサンドボックスのままにし、新しいセッションのみ新しいイメージを使用する",
      ...
      skillUploadHint:
        "インストールすると、現在のイメージにスキルが書き込まれ、新しいスナップショットが作成されます。数分かかる場合があります。現在のやり取りは中断されません。開いているセッションは次のやり取りでサンドボックスを再構築するため、セッションのワークスペースの一時ファイルは消去されます。",
      skillUploadHintNewSession:
        "インストールすると、現在のイメージにスキルが書き込まれ、新しいスナップショットが作成されます。数分かかる場合があります。すでに開いているセッションは終了するまで現在のサンドボックスを使い続け、新しく開始したセッションのみがこのインストールを反映します。",
      skillSourceSection: "ソースからインストール",
      skillSourceSectionHint:
        "ClawHub、GitHub、SkillHubのリンク、または{'@'}owner/slugを貼り付けてください。バンドルのサイズは{size} MB以下にしてください。",
      skillUploadSection: "ローカルのバンドルをアップロード",
      skillUploadSectionHint:
        "SKILL.mdを含むzipを下にドロップするか、クリックしてファイルを選択してください。バンドルのサイズは{size} MB以下にしてください。",
      skillSourcePlaceholder:
        "ClawHub: {'@'}owner/slug。GitHub / SkillHub: 完全なURLを貼り付け",
      skillSourceInstall: "インストール",
      skillInstallOr: "または",
      skillSourceFailed: "レジストリからのスキルのインストールに失敗しました",
      skillUploadFailed: "スキルのアップロードに失敗しました",
      skillBundleTooLarge:
        "スキルバンドルのサイズは{size} MBを超えることはできません。",
      skillBundleTooManyFiles:
        "スキルディレクトリに含められるファイルは{count}個までです。",
      skillBundleTooManyZipEntries:
        "アーカイブに含められるzipエントリは{count}個までです。",
      ...
      skillDisableHint:
        "無効化すると、スキルはエージェントから見えなくなりますが、ファイルはイメージ内に残ります。変更はセッションの次回実行時に反映されます。",
      skillDeleteHint:
        "削除すると、イメージからスキルのディレクトリが取り除かれ、新しいスナップショットが作成されます。現在のやり取りは中断されません。開いているセッションは次のやり取りでサンドボックスを再構築するため、セッションのワークスペースの一時ファイルは消去されます。",
      skillDeleteHintNewSession:
        "削除すると、イメージからスキルのディレクトリが取り除かれ、新しいスナップショットが作成されます。すでに開いているセッションは終了するまで現在のサンドボックスを使い続け、新しく開始したセッションのみでこのスキルが使えなくなります。",
      skillRemoveInProgress: "アンインストール中",
      skillRemoveWaiting:
        "イメージからのアンインストールを開始しました。進捗を待っています…",
      skillRemoveDone:
        "このサンドボックスから「{name}」をアンインストールしました。カタログには残っているため、後で再インストールできます。",
      skillRemoveStage: {
      ...
      imageInfoUsingBase:
        "スキルはまだインストールされていません。セッションは選択したランタイムテンプレートから起動します。",
      ...
      skillRetry: "再インストール",
      skillRetryHint:
        "保存済みのバンドルで再試行します。アップロードし直す必要はありません",
      skillRetryAccepted: "再インストールを開始しました",
      skillRetryFailed: "再インストールの開始に失敗しました",
      skillStop: "インストールを停止",
      skillStopHint:
        "このインストールを中止します。中止後は再試行またはアンインストールができます",
      skillStopAccepted: "停止しました",
      skillStopFailed: "停止に失敗しました",
      skillEmpty:
        "スキルはまだインストールされていません。レジストリのURLを貼り付けるか、zipをアップロードしてください。",
      skillVersion: "バージョン",
      ...
      skillEnv: {
        ...
        workspaceHint:
          "独自の値を設定していないメンバーは、ここでの値を使用します。メンバーは「設定 → サンドボックスのシークレット」から独自の値を設定できます。",
        required: "必須",
        isSet: "設定済み",
        notSet: "未設定",
        ...
        clear: "クリア",
        clearConfirm:
          "{name}のワークスペースの値をクリアしますか？宣言自体は残ります。独自の値を持たないメンバーは、この値を参照できなくなります。",
      ...
      skillGuidance: {
        ...
        unavailable:
          "この段階では入力できません。完了後に補足付きで再試行できます。",
        failed:
          "送信できませんでした。入力は保持されています。再試行してください。",
      },
    },
    skills: {
      title: "スキル管理",
      description:
        "スキルはワークスペースのカタログに登録されます。まず登録し、その後1つ以上のサンドボックスにインストールしてください。エージェントは、自身のサンドボックスで準備完了しているスキルのみ有効化できます。",
      helpTooltip:
        "カタログのスキルは、どこかにインストールされている必要はありません。スクリプトは、エージェントが使用するサンドボックスイメージにスキルがインストールされて初めて実行されます。Docker、Cube、E2Bのイメージには互換性がないため、サンドボックスごとにインストールしてください。",
      ...
      addStepRegisterDesc:
        "ソースを貼り付けるかzipをアップロードして、ワークスペースのカタログにスキルを追加します。",
      addStepInstallDesc:
        "解析されたスキルを確認し、インストール先のサンドボックスを選択します。ここをスキップして、後から一覧でインストールすることもできます。",
      addFinish: "完了",
      addFileSelected: "{name}を選択しました",
      addClearFile: "クリア",
      emptyDesc:
        "スキルがまだありません。追加してから、1つ以上のサンドボックスにインストールしてください。",
      emptyNoSandboxHint:
        "サンドボックスがまだありません。スクリプトを含むスキルは、イメージにインストールされるまで実行できません。",
      installSkill: "スキルを追加",
      installDrawerDesc: "{name}のイメージにインストールします。",
      installToSandbox: "サンドボックスにインストール",
      installToSandboxDesc:
        "サンドボックスのバックエンドごとにインストールが必要です。Docker、Cube、E2Bのイメージには互換性がありません。",
      pickSandboxes: "インストール先のサンドボックス",
      pickSandboxesHint:
        "選択した各サンドボックスが使用するイメージにスキルが書き込まれます。Docker、Cube、E2Bのイメージには互換性がないため、サンドボックスごとにインストールしてください。ここをスキップして、後からカタログでインストールすることもできます。",
      ...
      viewInstallProgress: "進捗を表示",
      manageDrawerDesc:
        "サンドボックス「{name}」での有効化、変数、アンインストールを管理します。",
      manageEnable: "有効化",
      manageUninstall: "サンドボックスからアンインストール",
      manageUninstallConfirm:
        "このサンドボックスから「{name}」をアンインストールしますか？",
      deleteCatalog: "カタログから削除",
      deleteCatalogConfirm:
        "カタログから「{name}」を削除しますか？先にすべてのサンドボックスからアンインストールしてください。",
      deleteCatalogBlocked:
        "先にこのスキルをすべてのサンドボックスからアンインストールしてください。",
      deleteSuccess: "カタログから削除しました",
      registerAccepted: "カタログに追加しました",
      installAccepted: "インストールを開始しました",
      installPartial:
        "一部のサンドボックスで開始しました。{failed}件では開始できませんでした。",
      installOutdated: "カタログと差異あり",
      loadFailed: "読み込みに失敗しました",
      noConfigsDesc:
        "サンドボックスがまだありません。スキルをインストールするにはイメージが必要です。",
      addDrawerDesc:
        "ソースを貼り付けるかzipをアップロードしてカタログに追加します。サンドボックスへのインストールは今すぐでも後からでも行えます。",
    ...
    capabilityUnavailable:
      "この機能は現在のデプロイでは利用できません。利用可能なページに戻りました。",
    weknoraCloud: {
      title: "WeKnora Cloud",
      description:
        "WeKnora CloudのAPPIDとAPPSECRETを設定します。この認証情報はモデルサービスとドキュメント解析エンジンで使用されます。",
      viewDocs: "ドキュメントを表示",
      unconfigured:
        "認証情報が未設定です。APPIDとAPPSECRETを入力してください。",
      configured: "認証情報は設定済みで、正常に動作しています。",
      expired: "WeKnora Cloudの認証情報が無効になりました",
      expiredDefault:
        "サービス再起動後に暗号化キーが変更されました。保存済みの認証情報を復号できません。認証情報を再入力してください。",
      reconfigure: "再設定",
      appIdLabel: "APPID",
      ...
      credentialUnconfigured:
        "WeKnoraCloudの認証情報が未設定です。先にAPPIDとAPPSECRETを設定してください。",
      checkingStatus: "認証情報のステータスを確認中...",
      goToSettings: "設定へ移動",
      modelHintConfigured:
        "WeKnoraCloudの認証情報は設定済みです。対応モデルは以下を参照してください:",
      modelHintDocsLink: "APIドキュメント",
      modelsSection: {
        title: "クラウドモデル",
        descReady:
          "チャット、検索、リランク、画像理解（VLM）の4種類のWeKnora Cloud標準モデルを登録します。",
        descPending:
          "クラウドモデルを追加する前に、上の認証情報を保存してください。",
        statusAdded: "追加済み",
        ...
        confirmAddAll:
          "未追加のクラウドモデル{count}個をまとめて追加しますか？",
      ...
      addModelsEmbeddingFailed:
        "埋め込みモデルの接続テストに失敗し、ベクトルの次元数を検出できませんでした",
    ...
    parser: {
      title: "解析エンジン",
      description:
        "ドキュメント解析エンジンのステータスと設定です。ここでの設定はサーバの環境変数より優先されます。空欄の場合は環境変数の値が使用されます。",
      supportedFileTypes: "対応形式",
      statusSection: "ステータス",
      configSection: "設定",
      ...
      retry: "再試行",
      noEngineDetected:
        "解析エンジンが検出されませんでした。DocReaderサービスが正常に稼働しているか確認してください。",
      disconnected: "未接続",
      connected: "接続済み",
      available: "利用可能",
      unavailable: "利用不可",
      builtinDesc:
        "DocReaderの組み込み解析エンジン（docx/pdf/xlsxなどの複雑な形式に対応）",
      currentAddr: "現在",
      envVarHint:
        "変更するには、環境変数DOCREADER_ADDRとDOCREADER_TRANSPORT（grpc/http）を設定してサービスを再起動してください。",
      ...
      parseMethodHint:
        "自動モードでは、スキャンされたPDFにはOCRを使用し、デジタルPDFからはネイティブのテキストレイヤを抽出します。",
      ...
      ensureDocreaderConnected:
        "DocReaderサービスが環境変数で設定され、接続されていることを確認してください",
      checkDoneStatusUpdated:
        "現在のパラメータで確認しました。上のステータスを更新しました。",
      ...
      vlmServerUrlHint:
        "バックエンドがvlm-http-clientまたはhybrid-http-clientの場合は必須です",
      paddleocrVlEndpointPlaceholder: "例: http://your-paddleocr-vl:8080",
      paddleocrVlEndpointHint:
        "PaddleOCR-VLパイプラインサービスのベースURLです。末尾に/layout-parsingを付ける必要はありません",
      paddleocrVlCloudTokenPlaceholder: "PaddleOCR-VL AI Studio Token",
    },
    storageBackend: {
      description:
        "ファイルと画像に使用するストレージインスタンスを管理します。同じ種類のインスタンスを複数設定できます。",
    ...
    storage: {
      title: "ストレージエンジン",
      description:
        "ドキュメントと画像のストレージを設定します。ここでエンジンのパラメータを設定し、ナレッジベースでは使用するエンジンを選択するだけです。",
      basicSection: "基本",
      modeSection: "デプロイモード",
      ...
      defaultEngineDesc:
        "ナレッジベースを新規作成するときのデフォルトのストレージエンジン",
      engineLocal: "ローカル",
      ...
      localDesc:
        "サーバのローカルファイルシステムにファイルを保存します。単一ノードのデプロイにのみ適しています。",
      available: "利用可能",
      needsConfig: "設定が必要",
      configurable: "設定可能",
      ...
      minioDesc:
        "S3互換のセルフホスト型オブジェクトストレージです。プライベートネットワークやプライベートクラウドでのデプロイに適しています。",
      minioDocker: "Dockerデプロイ",
      minioRemote: "リモートMinIO",
      minioDockerDetected:
        "DockerでデプロイされたMinIOの環境変数を検出しました。接続情報は環境変数から提供されるため、手動入力は不要です。",
      minioDockerNotDetected:
        "MinIOの環境変数（MINIO_ENDPOINTなど）が検出されませんでした。Docker Composeの設定を確認してください。",
      minioRemoteHint:
        "リモートのMinIOサービスに接続します。接続情報の手動入力が必要です。",
      cosTitle: "Tencent Cloud COS",
      cosDesc:
        "Tencent Cloudのオブジェクトストレージです。CDNによる高速化を伴うパブリッククラウドのデプロイに適しています。",
      ...
      tosDesc:
        "Volcengineのオブジェクトストレージサービス（TOS）です。パブリッククラウドのデプロイに適しています。",
      tosAccessKeyPlaceholder: "VolcengineのAccess Key",
      tosSecretKeyPlaceholder: "VolcengineのSecret Key",
      s3Title: "AWS S3",
      s3Desc:
        "AWS S3およびS3互換のオブジェクトストレージサービスです。パブリッククラウドのデプロイに適しています。",
      s3AccessKeyPlaceholder: "AWSのAccess Key",
      s3SecretKeyPlaceholder: "AWSのSecret Key",
      s3DefaultCredentialsHint:
        "両方のキーを空欄にすると、AWSのデフォルト認証情報チェーン（IAMロール、IRSA / Web Identity、環境変数、共有設定ファイル）が使用されます。",
      s3EndpointPlaceholder:
        "任意。空欄の場合はAWSのリージョナルエンドポイントを使用します",
      ks3Title: "Kingsoft Cloud KS3",
      ks3Desc:
        "Kingsoft Cloudのオブジェクトストレージサービス（KS3）です。パブリッククラウドのデプロイに適しています。",
      ...
      obsDesc:
        "Huawei Cloudのオブジェクトストレージサービス（OBS）です。パブリッククラウドのデプロイに適しています。",
      ...
      ossDesc:
        "Alibaba Cloudのオブジェクトストレージサービス（OSS）です。パブリッククラウドのデプロイに適しています。",
  ...
  webSearchSettings: {
    title: "Web検索の設定",
    description:
      "Web検索を設定すると、回答にインターネット上の最新情報を含められます。",
    basicSection: "基本",
    ...
    noProvidersDesc:
      "Web検索プロバイダを追加すると、エージェントがインターネットからリアルタイムの情報を取得できるようになります。",
    setAsDefaultDesc:
      "エージェントがプロバイダを指定していない場合に、このプロバイダがデフォルトで使用されます",
    proxyUrlLabel: "HTTPプロキシ",
    proxyUrlPlaceholder:
      "例: http://proxy.example.com:3128（任意。http/httpsのみ）",
    proxyUrlHelp:
      "検索APIへの外向き通信にプロキシが必要な場合に指定します。空欄の場合はHTTP_PROXY / HTTPS_PROXY環境変数に従います。",
    apiKeyLabel: "APIキー",
  ...
  vectorStoreSettings: {
    ...
    description:
      "ナレッジベースの検索に使用するベクトルデータベースのインスタンスを登録・管理します。",
    basicSection: "基本",
    ...
    emptyDesc:
      "ベクトルデータベースが設定されていません。「データベースを追加」から始めてください。",
    ...
    testing: "テスト中...",
    immutableNotice:
      "エンジンの種類、接続情報、インデックス設定は作成後に変更できません。\n変更するには、削除して作成し直してください。",
    insecureSkipVerifyWarning:
      "TLS証明書の検証を無効にすると、中間者攻撃を受けるおそれがあります。自己署名証明書の開発用クラスタでのみ使用し、本番環境では使用しないでください。",
    validation: {
      nameRequired: "名前は必須です",
      engineTypeRequired: "エンジンの種類は必須です",
      fieldRequired: "{field}は必須です",
      indexNamePattern:
        "英字で始める必要があります。使用できるのは英数字、アンダースコア、ハイフンのみです（最大128文字）",
    },
    toasts: {
  ...
  memorySettings: {
    title: "マイメモリ",
    description:
      "会話をまたいでアシスタントが記憶しているあなたの情報です。ここで内容の確認・編集・削除ができます。削除したメモリが再び使われることはありません。",
    workspaceDisabled:
      "このワークスペースでは長期メモリが無効です。この切り替えは、管理者が有効にした後に反映されます。",
    enableLabel: "自分の長期メモリを使用する",
    enableDescription:
      "オフにすると、アシスタントはあなたのメモリを読み取ることも追加することもありません。既存のメモリは保持され、再度オンにすると使用が再開されます。",
    agentDisabledHint:
      "個々のエージェントが自分だけ長期メモリを無効にすることもできます。そのエージェントとの会話ではあなたのメモリは読み取られず追加もされませんが、他のエージェントには影響しません。",
    usage: {
      title: "メモリが使われるタイミング",
    ...
    rejectGuess: "いいえ",
    pendingHint:
      "これらはあなたの質問から推測された項目です。確認するまでは使用されません。",
    trackingHint:
      "これらは繰り返し質問している話題ですが、長期的な関心になるしきい値にはまだ達していません。それまでは会話で使用されません。",
    documentsHint:
      "これらのドキュメントは回答に繰り返し登場するため、検索でわずかに優先されます。観察を終了すると優先されなくなりますが、さらに2回引用されると再び表示されます。",
    supersededHint:
      "これらは新しいメモリに置き換えられました。変更の履歴として保持されており、会話では使用されません。",
    archivedHint:
      "アーカイブされたメモリは会話で使用されません。1人あたりの上限に達すると、使用頻度の低い項目から自動的にアーカイブされます。",
    pendingEmptyTitle: "確認する項目はありません",
    pendingEmptyDescription:
      "あなたの質問から何かが推測されると、ここで確認を待ちます。",
    trackingEmptyTitle: "観察中の話題はありません",
    trackingEmptyDescription:
      "自動抽出を有効にすると、よく質問する内容の回数が数えられ、十分に繰り返された時点で長期的な関心になります。",
    documentsEmptyTitle: "よく使う情報源はまだありません",
    documentsEmptyDescription:
      "回答で2回以上引用されたドキュメントがここに表示されます。",
    supersededEmptyTitle: "まだ置き換えられた項目はありません",
    supersededEmptyDescription:
      "同じ話題を新しい表現で記録すると、古い表現がここに残ります。このページで項目を編集した場合はその場で更新され、履歴の行は作成されません。",
    archivedEmptyTitle: "まだアーカイブされた項目はありません",
    archivedEmptyDescription:
      "有効なメモリが上限（デフォルトは200件）を超えると、使用頻度の低いものからアーカイブされます。期限付きのタスクも、期限が切れるとここに入ります。",
    ...
    consolidate: "整理",
    consolidateConfirm:
      "内容がほぼ重複する項目が統合されます。古い表現は「置き換え済み」に残ります。続行しますか？",
    consolidateSuccess:
      "整理しました: {merged}グループを統合し、期限切れの{expired}件をアーカイブし、古いタスク{demoted}件を降格しました",
    consolidateTooFewItems: "メモリが少ないため、まだ整理する必要はありません",
    consolidateNoCandidates:
      "統合できるほど内容が近いメモリは見つかりませんでした",
    consolidateModelDeclined:
      "モデルが確認した結果、これらは別の内容と判断されたため、統合は行われませんでした",
    consolidateTooSoon:
      "整理を実行したばかりです。しばらくしてから再試行してください。",
    consolidateModelUnavailable:
      "モデルを利用できなかったため、誤った統合を避けて何も変更しませんでした",
    consolidateFailed: "整理に失敗しました",
    clear: "すべて削除",
    clearConfirm:
      "すべてのメモリ、観察中の話題、よく使う情報源が完全に削除され、元に戻せません。続行しますか？",
    deleteConfirm: "このメモリを完全に削除しますか？",
    add: "追加",
    addPlaceholder:
      "アシスタントに覚えておいてほしいことを1文で入力してください",
    addTitle: "メモリを追加",
    addKindLabel: "種類",
    addContentLabel: "内容",
    emptyTitle: "メモリはまだありません",
    emptyDescription:
      "会話で「...を覚えておいて」と伝えるか、上の入力欄から直接追加してください。",
    kinds: {
      profile: "あなたについて",
      preference: "好み",
      fact: "事実",
    ...
    kindHints: {
      ...
      interest:
        "あなたがよく尋ねる内容の理解に役立ちます。毎回のやり取りで必ず引用されるわけではありません",
    },
    origins: {
      explicit: "依頼による",
      extracted: "自動抽出",
  ...
  envVarSettings: {
    ...
    description:
      "スキルとサンドボックスで使う個人用のキーです。WeKnoraのシステム設定やデプロイ設定ではありません。",
    helpAria: "サンドボックスのシークレットについて",
    introPersonalTitle: "あなただけのもの",
    introPersonalBody:
      "あなた自身のチャットや実行にのみ注入されます。他のメンバーからは見えず、他のメンバーの値があなたの値を上書きすることもありません。",
    introRuntimeTitle: "実行するときに渡される",
    introRuntimeBody:
      "スキルの実行時、またはそのサンドボックスでコマンドを実行するときに注入されます。会話の中で渡すこともできます。保存した値が再表示されることはありません。",
    loading: "読み込み中…",
    loadFailed: "サンドボックスのシークレットを読み込めませんでした。",
    retry: "再試行",
    noConfigTitle: "サンドボックスが設定されていません",
    noConfigDescription:
      "このワークスペースにはまだサンドボックスのバックエンドがないため、キーを設定する対象がありません。",
    sandboxTitle: "特定のサンドボックスで常に渡す値",
    sandboxHint:
      "そのサンドボックスで実行するコマンドにのみ渡されます。ほとんどの場合は不要で、会話の中で値を渡すこともできます。",
    sandboxEmpty: "まだ追加されていません。",
    sandboxPick: "対象のサンドボックス",
    skillTitle: "スキルが必要とするキー",
    skillHint:
      "スキルごとに必要な項目が宣言されています。ここで事前に保存するか、会話の中で渡してください。ワークスペースの管理者がスキルのカードで共通の値を設定することもできます。",
    skillEmptyTitle: "キーを必要とするスキルはまだありません",
    skillEmptyDesc:
      "認証情報を宣言しているスキルをインストールすると、入力する項目がここに表示されます。",
    ...
    nameRule:
      "英大文字、数字、アンダースコアが使用できます。先頭は英字またはアンダースコアにしてください。",
    nameInvalid:
      "この名前は使用できません。PATHやWEKNORA_で始まる名前など、サンドボックスが予約している名前は指定できません。",
    ...
    delete: "削除",
    deleteConfirm:
      "{name}を削除しますか？このサンドボックスで実行するものには渡されなくなります。",
    deleteSuccess: "変数を削除しました。",
    clear: "自分の値を削除",
    clearConfirm:
      "{name}に設定した自分の値を削除しますか？ワークスペースの値がある場合は、以後そちらが適用されます。",
  ...
  memoryWorkspaceSettings: {
    title: "長期メモリ",
    description:
      "メンバーが会話で伝えた内容（本人の情報、仕事の進め方の好み、変わりにくい事実、取り組んでいること）を、会話をまたいでアシスタントが記憶できるようにします。",
    introTitle: "デフォルトは無効。手動で有効にする必要があります",
    introDescription:
      "長期メモリはメンバーが会話で話した内容を保持するため、初期状態では無効になっています。有効にすると、各メンバーは自分専用のメモリ領域を持ち、「マイメモリ」から内容の確認・編集・削除、または完全な無効化ができます。有効なプロフィールと好みのメモリは以降のすべてのやり取りに含まれ、事実と進行中のタスクは質問が関連する場合にのみ参照されます。",
    enableLabel: "このワークスペースで長期メモリを有効にする",
    enableDescription:
      "オフにすると、このワークスペースのどの会話でもメモリの読み書きは行われません。",
    writeModeLabel: "メモリの記録方法",
    writeModeDescription: "何を記憶するかを制御します。",
    writeModeExplicit: "明示的な依頼のみ",
    writeModeAuto: "自動で抽出",
    writeModeExplicitHint:
      "メンバーが明示的に依頼した内容と、手動で追加した項目のみを記録します。追加のモデル呼び出しは発生しません。",
    writeModeAutoHint:
      "さらに、会話の終了後にバックグラウンドでモデルを1回呼び出し、メンバーの発言から記録する価値のある内容を抽出します。",
    extractModelLabel: "抽出用モデル",
    extractModelDescription:
      "空欄にすると、その会話で使用されたモデルを使用します。",
    extractDelayLabel: "抽出までの待機時間",
    extractDelayDescription:
      "やり取りの終了から抽出を実行するまでの待機時間です。待つことで、ユーザが続けて送る複数のメッセージを1回のモデル呼び出しでまとめて処理できます。",
    extractMinIntervalLabel: "実行間隔の下限",
    extractMinIntervalDescription:
      "1人あたりの抽出実行の最短間隔で、コストを抑えるために使用します。この間隔内に発生したメッセージは破棄されず、次回の実行に持ち越されます。",
    vectorRecallLabel: "意味でメモリを照合する",
    vectorRecallDescription:
      "字句に加えて意味による照合を行うため、ユーザが話題を言い換えてもメモリが引き出されます（ほとんどのメモリはいずれ言い換えられます）。やり取りごとに埋め込みの呼び出しが1回発生し、タイムアウト時は字句のみの照合にフォールバックします。",
    embeddingModelLabel: "メモリ用の埋め込みモデル",
    embeddingModelDescription:
      "意味によるリコールはこのモデルのみを使用し、ナレッジベースが紐づけている埋め込みモデルとは独立しています。空欄の場合は字句のみの照合になります。変更すると、新しいメモリはすぐに新しいモデルを使用し、既存のメモリは再度埋め込まれるまで字句のみの照合のままです。",
    conditioningLabel: "メモリを検索に反映する",
    conditioningDescription:
      "メモリを回答用プロンプトに付け加えるだけでなく、クエリのリライトやドキュメントのランキングにも利用します。ナレッジベース製品でメモリが最も効果を発揮する部分です。",
    interestThresholdLabel: "関心として記録するまでの質問回数",
    interestThresholdDescription:
      "同じ話題がこの回数だけ質問されて初めて記録されます。1にするとその場限りの質問もすべて記録されるため、通常はノイズが多くなりすぎます。",
    instructionsLabel: "カスタム抽出ルール",
    instructionsDescription:
      "抽出プロンプトに追加されるワークスペースのルールです。「顧客名は記録しない」など、製品側では判断できないポリシーを指定します。",
    instructionsPlaceholder: "1行に1つのルール。例: 顧客名は記録しない",
    maxItemsLabel: "メンバーあたりのメモリ上限",
    maxItemsDescription:
      "これを超えると、重要度と新しさに基づいて下位のメモリがアーカイブされます。アーカイブされたメモリは「マイメモリ」で引き続き確認できます。",
    toasts: {
  ...
  chatHistorySettings: {
    title: "メッセージ管理",
    description:
      "チャット履歴のナレッジベースを設定し、会話メッセージを自動的にインデックス化して意味検索できるようにします",
    enableLabel: "メッセージのインデックス作成を有効化",
    enableDescription:
      "有効にすると、新しい会話メッセージがベクトル検索用にナレッジベースへ自動的にインデックス化されます",
    embeddingModelLabel: "埋め込みモデル",
    embeddingModelDescription:
      "チャットメッセージをベクトル化する埋め込みモデルを選択します",
    embeddingModelLocked:
      "メッセージがインデックス化済みのため、埋め込みモデルは変更できません（インデックスデータの削除が必要です）",
    statsTitle: "インデックスの統計",
    statsIndexedMessages: "インデックス済みメッセージ",
    statsNotConfigured: "メッセージのインデックス作成が未設定です",
    statsNotConfiguredDesc:
      "有効化して埋め込みモデルを選択すると、会話メッセージの自動インデックス作成が始まります",
    toasts: {
  ...
  retrievalSettings: {
    title: "検索設定",
    description:
      "ナレッジベース検索とメッセージ検索に共通する検索パラメータを設定します",
    ...
    rerankModelRequired:
      "リランクモデルを選択してください。検索結果のリランクにはこのモデルが必要です。",
    toasts: {
  ...
  graphSettings: {
    title: "ナレッジグラフの設定",
    description:
      "エンティティとリレーションの抽出を設定し、テキストからナレッジグラフを自動的に構築します（注: Wiki内の「ページリンクグラフ」とは別のものです。あちらはWikiページ間の参照関係を示し、こちらはLLMが抽出したエンティティとリレーションのグラフです）",
    enableLabel: "エンティティとリレーションの抽出を有効化",
    enableDescription:
      "有効にすると、テキストからエンティティとリレーションを自動的に抽出します",
    tagsLabel: "リレーションの種類",
    tagsDescription:
      "抽出するリレーションの種類のタグをカンマ区切りで定義します",
    tagsPlaceholder:
      "リレーションの種類を入力（例: works_at, colleague, friend）",
    generateRandomTags: "タグをランダム生成",
    sampleTextLabel: "サンプルテキスト",
    sampleTextDescription:
      "エンティティとリレーションの抽出をテストするためのサンプルテキスト",
    sampleTextPlaceholder: "エンティティとリレーションを含むテキストを入力...",
    customInstructionsLabel: "抽出の追加指示",
    customInstructionsDescription:
      "構造化出力の形式は維持したまま、対象分野の範囲、エンティティの絞り込み、属性の指針などを追加できます",
    customInstructionsPlaceholder:
      "例: 契約当事者、金額、履行期日、責任に注目する…",
    ...
    disabledWarning:
      "ナレッジグラフのデータベースが有効になっていないため、エンティティとリレーションの抽出は利用できません",
  ...
  inviteRegister: {
    ...
    bannerHint:
      "以下の項目を入力して登録してください。登録が完了すると自動的にチームに参加します。",
    bannerHintLogin: "ログインすると、このチームに自動的に参加します。",
    loading: "招待リンクを確認中…",
    invalidTitle: "招待リンクが無効か、取り消されています",
    invalidBody:
      "招待した方に新しいリンクの送付を依頼するか、既存のアカウントでログインしてください。",
    backToLogin: "ログインに戻る",
    title: "登録を完了",
  ...
  auth: {
    ...
    backToLogin: "ログインに戻る",
    loginHint:
      "ログインして続行してください。初めての方は下からアカウントを作成できます。",
    firstTime: "WeKnoraは初めてですか？",
    registerSuccess: "登録が完了しました。ログインしてください",
    registerFailed: "登録に失敗しました",
    subtitle:
      "RAG質問応答、ReActエージェント、Wiki。LLMが支える企業向けナレッジフレームワーク",
    ...
    workspaceOnboarding: {
      title: "ワークスペースを選択",
      description:
        "ワークスペースを作成して始めるか、招待を承諾して既存のワークスペースに参加してください。",
      create: "ワークスペースを作成",
      invitations: "招待を表示",
      loadingPolicy: "利用できるワークスペースの選択肢を確認中…",
      policyLoadFailed:
        "ワークスペースの権限を読み込めませんでした。接続を確認して再試行してください。",
      retry: "再読み込み",
      inviteOnlyTitle: "ワークスペースへの招待待ち",
      inviteOnlyDescription:
        "個人ワークスペースの作成は無効になっています。ワークスペース管理者からの招待を確認して承諾してください。",
      inviteOnlyNotice:
        "このアカウントは招待によってのみ既存のワークスペースに参加できます",
      help: "今すぐワークスペースを作成することも、後で戻って招待を承諾することもできます。",
      inviteOnlyHelp:
        "まだ招待がありませんか？登録したメールアドレスをワークスペース管理者に伝えて、招待を依頼してください。",
    },
  },
  authStore: {
    errors: {
  ...
  common: {
    ...
    github: "GitHub",
    githubStarTip:
      "GitHubでリポジトリを開きます。役に立ったらStarをお願いします",
    defaultUser: "ユーザ",
  },
  mentionDetail: {
    readOnlyFromAgent:
      "この会話内でのみ読み取り専用。ナレッジベース一覧には表示されません",
    faqCount: "Q&A{count}件",
    kbCount: "ドキュメント{count}件",
    belongsToKb: "ナレッジベース: ",
    belongsToOrg: "共有スペース: ",
    noCompatibleKbForAgent:
      "このエージェントのツールはスコープ内のナレッジベースの機能と一致しないため、参照できるナレッジベースがありません。",
  ...
  manualEditor: {
    ...
    form: {
      ...
      contentPlaceholder:
        "Markdownに対応しています。#見出し、リスト、コードブロックなどが使えます。",
    },
    noDocumentKnowledgeBases:
      "利用可能なドキュメント型ナレッジベースがありません。先に作成してください",
    status: {
      draftTag: "ステータス: 下書き",
  ...
  input: {
    ...
    placeholderWithContext:
      "質問を入力してください。上で選択したナレッジベース／ファイルに基づいて回答します",
    placeholderWebOnly: "質問を入力してください。Web検索に基づいて回答します",
    placeholderKbAndWeb:
      "質問を入力してください。ナレッジベースとWeb検索に基づいて回答します",
    ...
    messages: {
      ...
      webSearchNotConfigured:
        "Web検索エンジンが未設定です。設定でプロバイダと認証情報を設定してください。",
      webSearchEnabled: "Web検索を有効にしました",
      webSearchDisabled: "Web検索を無効にしました",
      sessionMissing: "セッションIDが存在しません",
      messageMissing:
        "メッセージIDを取得できません。ページを更新して再試行してください。",
      stopSuccess: "生成を停止しました",
      stopFailed: "停止に失敗しました。再試行してください。",
      steerAttachmentPending:
        "添付ファイルのアップロードが完了していません。しばらくしてから追加してください。",
      steerHasAttachments:
        "実行中の回答には添付ファイルを追加できません。先に削除するか、終了後に送信してください。",
      steerFailed: "メッセージの追加に失敗しました。再試行してください。",
      steerPromoteFailed: "今すぐ送信に失敗しました。再試行してください。",
      steerRemoveFailed:
        "待機中のメッセージを削除できませんでした。再試行してください。",
      steerAlreadyInjected:
        "このメッセージは既に現在の回答に取り込まれています。",
      steerFollowUpTimeout:
        "次の回答が時間内に始まりませんでした。もう一度送信してください。",
      steerNoActiveRun:
        "現在実行中の回答はありません。メッセージを直接送信してください。",
    },
    webSearchDisabledByAgent:
      "現在のエージェントによりWeb検索が無効になっています",
    kbLockedByAgent:
      "現在のエージェントによりナレッジベース設定がロックされています",
    kbDisabledByAgent:
      "現在のエージェントによりナレッジベースが無効になっています",
    modelLockedByAgent:
      "現在のエージェントによりモデル選択がロックされています",
    imageUploadDisabledByAgent:
      "このエージェントでは画像アップロードが有効になっていません",
  ...
  createChat: {
    ...
    messages: {
      ...
      createError:
        "セッションの作成に失敗しました。しばらくしてから再試行してください",
    },
  },
  knowledgeList: {
    create: "ナレッジベースを作成",
    subtitle:
      "ナレッジベースを管理・整理します。ドキュメント型とFAQ型のナレッジベースに対応しています",
    sharedToOrgs: "{count}件の共有スペースに共有中",
    uninitializedBanner:
      "一部のナレッジベースが初期化されていません。ドキュメントを追加する前に、設定でモデル情報を設定してください。",
    empty: {
      title: "ナレッジベースがまだありません",
      description:
        "右上の「ナレッジベースを作成」をクリックして、最初のナレッジベースを追加してください。",
      sharedTitle: "共有されたナレッジベースはありません",
      sharedDescription:
        "共有スペースに参加するか、他のメンバーにナレッジベースの共有を依頼してください",
      favoritesTitle: "お気に入りはまだありません",
      favoritesDescription:
        "ナレッジベースのカードからスターを付けると、ここに追加されます",
      recentsTitle: "まだ何もありません",
    ...
    uploadProgress: {
      ...
      completedDetail:
        "{total}件のファイルをすべてアップロードしました。解析ステータスを表示するため一覧を更新しています...",
  ...
  embedPublish: {
    ...
    channelKey: "チャネルキー",
    channelKeyDesc:
      "サードパーティサイト連携用の長期シークレットです。安全に保管してください",
    channelKeyHint:
      "チャネルキーの読み込みに失敗しました。このチャネルを閉じて開き直すか、ページを更新してください。",
    channelKeyLoadFailed: "チャネルキーの読み込みに失敗しました",
    channelKeyUnavailable: "キーを利用できません",
    resetKeyTitle: "チャネルキーをリセット",
    resetKeyConfirmOk: "リセット",
    resetKeyConfirmBody:
      "リセットすると、古いチャネルキーは直ちに失効します。設置済みの埋め込みスニペットは、動作を継続するためにすべて新しいキーを使用する必要があります。この操作は取り消せません。",
    resetKeySuccess:
      "チャネルキーをリセットしました。新しいキーは入力欄に表示されています",
    ...
    nameDefaultHint:
      "エージェントを選択すると「{agent} · Web埋め込み」がデフォルトになります。保存時に空欄のままにするとデフォルトの名前が使用されます。",
    ...
    welcomeMessageDesc:
      "訪問者が最初のメッセージを送る前に埋め込みチャットに表示されます。空欄にすると非表示になります",
    showSuggestedQuestions: "質問候補",
    showSuggestedQuestionsDesc:
      "訪問者の最初のメッセージの前に、エージェント設定と連携ナレッジベースをもとにした質問候補を表示します",
    originsHint:
      "WeKnora の URL（B）ではなく、埋め込みを許可するホストサイト（A）を入力します。1 行に 1 つの Origin（例: https://shop.example.com）。1 件以上必須。*.example.com に対応。",
    originsRequired: "許可オリジンを1件以上入力してください",
    originsInvalid: "無効なオリジン: {origin}",
    originsWildcardProd:
      "本番環境ではワイルドカードのオリジン「*」は使用できません",
    originsPlaceholder: "https://shop.example.com",
    rateLimitLabel: "1分あたりのリクエスト上限",
    rateLimitDesc:
      "訪問者のIPごとに、1分あたりの埋め込みAPIリクエストの上限です。超過したリクエストは一時的に拒否されます。デフォルトは30です。",
    rateLimitDayLabel: "1日あたりのリクエスト上限",
    rateLimitDayDesc:
      "チャネル全体（すべての訪問者IPの合計）で1日に許可するリクエスト数です。公開トークンが流出した場合の悪用コストを抑えます。デフォルトは10000です。",
    publishTokenWarning:
      "公開トークンは埋め込みページのソースに平文で表示されるため、設置サイトを訪れた誰もが読み取れます。シークレットではなく公開可能なキーとして扱ってください。機密データを扱うエージェントは埋め込まない、オリジンの許可リストとリクエスト上限を必ず設定する、流出した場合は直ちにトークンをローテーションする、といった運用を徹底してください。",
    primaryColor: "メインカラー",
    pageTitle: "ページタイトル",
    pageTitleDesc:
      "チャットのヘッダーとブラウザのタブに訪問者向けに表示されます。名前より優先されます",
    ...
    headerTitleModeDesc:
      "固定: 常にページタイトルを表示します。セッション: 最初のメッセージからタイトルを自動生成し、生成されるまではページタイトルを表示します。",
    tokenHint:
      "チャネルキーの読み込みに失敗しました。このチャネルを閉じて開き直してください。",
    createdWithToken:
      "埋め込みチャネルを作成しました。チャネルキーは下に表示されています",
    ...
    channelDisabled:
      "この埋め込みチャネルは無効です。エージェントエディタ → Webページ埋め込みから再度有効化してください",
    loading: "読み込み中...",
    tabIframe: "iframe",
    tabWidget: "ウィジェット",
    tabSecure: "セキュアモード",
    ...
    preview: "プレビュー",
    previewIframeHint:
      "サードパーティのページでiframe埋め込みがどのように表示されるかを示します（コピーしたスニペットと同じです）。",
    previewWidgetHint:
      "疑似的なホストページ上でフローティングウィジェットを表示します。実際のサイトでは、ホストがpostMessageでトークンを渡します。",
    previewMockPage: "疑似ホストページ",
    previewLoading: "プレビューを読み込み中…",
    previewUnavailable:
      "プレビューを利用できません。チャネルが有効になっているか、Redisが利用可能かをご確認ください。",
    ...
    allowWebSearchDesc:
      "有効にすると、訪問者の入力欄にWeb検索ボタンが表示され、訪問者が自分でオン・オフを切り替えられます。デフォルトはオフです。このボタンは、紐付けたエージェントでWeb検索が有効な場合のみ表示されます。",
    allowFileUpload: "ファイルアップロードを表示",
    allowFileUploadDesc:
      "有効にすると、訪問者は画像やドキュメントの添付をアップロードできます。紐付けたエージェントが画像アップロードに対応している必要があります。",
    webhookUrl: "Webhook URL",
    webhookUrlPlaceholder:
      "https://your-server.example.com/weknora/embed-events",
    webhookUrlDesc:
      "任意。WeKnoraがmessage_sent / message_receivedイベントをこのHTTPSエンドポイントにPOSTします。",
    webhookSecret: "Webhookシークレット",
    webhookSecretPlaceholder:
      "HMAC-SHA256シークレット（X-WeKnora-Signatureヘッダー）",
    webhookSecretKeep: "空欄のままにすると保存済みのシークレットを維持します",
    webhookSecretDesc:
      "任意。設定すると、リクエストボディに署名が付与され、サーバ側で検証できます。",
    agentWebSearchDisabledHint:
      "このエージェントではWeb検索が有効になっていません。エージェント設定で有効にするまで、訪問者にWeb検索ボタンは表示されません。",
    agentImageUploadDisabledHint:
      "このエージェントでは画像アップロードが有効になっていません。エージェント設定で有効にするまで、訪問者にアップロードボタンは表示されません。",
    ...
    stepDeploy: "埋め込み",
    deployIntro:
      "埋め込み方式を選び、下のスニペットをサイトにコピーしてください。認証情報が必要な場合は、下部でチャネルキーの表示やローテーションが行えます。",
    deployStepEmbed: "埋め込みコードをコピー",
    deployStepEmbedDesc:
      "埋め込み方式を選び、スニペットをサイトに貼り付けます。",
    embedIframeDesc: "ページ内の固定領域にチャット全体を埋め込みます。",
    embedWidgetDesc:
      "画面の隅にフローティングのランチャを表示し、クリックでチャットパネルを開きます。",
    embedSecureDesc:
      "推奨: 公開トークンは自社バックエンドにのみ保持され、ページは短期トークンだけを受け取るため、長期シークレットがブラウザに渡ることはありません。",
    deployAfterSaveHint:
      "保存すると、ここでチャネルキーと埋め込みコードをコピーできます。",
    widgetTokenNote:
      "ウィジェットスクリプトにはチャネルキーを含める必要があります。iframe埋め込みは読み込み時に自動で認証情報を交換します。",
    secureTokenNote:
      "ページは公開トークンを持たず、自社バックエンドのトークンエンドポイント（data-token-endpoint）を参照します。バックエンドが公開トークンを30分間有効な短期トークンと交換してページに返し、ウィジェットは有効期限前に自動更新します。",
    secureServerLabel:
      "サーバ側トークンエンドポイントの例（公開トークンはサーバに保持されます）",
    tabServerNode: "Node.js",
    tabServerGo: "Go",
    enabled: "チャネルを有効化",
    deleteConfirm:
      "この埋め込みチャネルを削除しますか？設置済みのスニペットは動作しなくなります。",
    defaultLocale: "デフォルト言語",
    defaultLocaleDesc:
      "チャットを開いたときの訪問者UIの言語です。空欄の場合はブラウザまたはホストのWidget setLocale()に従います。",
  ...
  knowledgeEditor: {
    activity: {
      title: "アクティビティ",
      description:
        "このナレッジベースの重要な変更履歴と、バックグラウンドタスクへの導線を表示します。保持期間は監査ログのポリシーに従います。",
      allOutcomes: "すべての結果",
      allActions: "すべての操作",
      refresh: "更新",
      retry: "再試行",
    ...
    errors: {
      vectorStoreBindingInvalid:
        "選択したベクトルストアは使用できません。別のストアを選択するか、システムのデフォルトを使用してください。",
      vectorStoreUnavailable:
        "選択したベクトルストアは現在利用できません。設定 → ベクトルストアで接続設定を確認してください。",
    },
    basic: {
      title: "基本情報",
      ...
      typeFAQ: "FAQ型",
      typeDescription:
        "FAQ型は構造化されたQ&Aデータに適しています。ドキュメント型はファイルの解析とチャンク分割に対応します。Wiki型はLLMで相互リンクされたナレッジページを自動構築します。",
      nameLabel: "ナレッジベース名",
    ...
    wiki: {
      ...
      contentInstructionsTip:
        "要約・ページ・インデックスの重点やトーンを制御します。引用、統合、事実性のルールはシステム側で固定されます。変更を反映するには既存コンテンツを再処理してください。",
      contentInstructionsPlaceholder:
        "例: 法務レビューのトーンで、担当者・期限・リスクを重視する…",
      extractionInstructionsLabel: "Wiki抽出の重点",
      extractionInstructionsTip:
        "システムのJSONおよび引用プロトコルは変更せずに、優先して抽出するドメイン固有のエンティティや概念を記述します。",
      extractionInstructionsPlaceholder:
        "例: 製品、バージョン、組織、担当者、中核となる技術概念を優先する…",
      extractionGranularityTip:
        "ドキュメントごとに抽出するWikiのエンティティ／概念の数を制御します。細かいほどインデックスは絞り込まれ、粗いほど網羅的になります",
      granularityFocused: "重点",
      granularityStandard: "標準",
      granularityExhaustive: "網羅",
      granularityFocusedHint:
        "ドキュメントの主題のみを抽出します（例: 履歴書なら本人とそのプロジェクト）。最もすっきりしますが、副次的なエンティティを取りこぼす場合があります。",
      granularityStandardHint:
        "主題に加えて、十分に言及されている副次的なエンティティや概念も抽出します。名前だけの言及は除外します。推奨のデフォルトです。",
      granularityExhaustiveHint:
        "技術スタックやツールへの軽微な言及も含め、名前付きのエンティティと概念をすべて抽出します。ナレッジベースを用語集として使う場合に適しています。",
    },
    indexing: {
      title: "インデックス戦略",
      description:
        "ドキュメント処理のパイプラインを設定します。各インデックス方式は個別に有効化・無効化できます。",
      searchTitle: "RAG検索",
      searchDesc:
        "ドキュメントをチャンク化し、ベクトル化とキーワードインデックスを作成してハイブリッド検索を行います",
      wikiTitle: "Wikiナレッジベース",
      wikiDesc:
        "相互リンクされたWikiページを自動生成し、構造化されたナレッジ体系を構築します",
      graphTitle: "ナレッジグラフ",
      graphDesc:
        "エンティティとリレーションを抽出してナレッジグラフを構築し、グラフベースの検索を行います",
      atLeastOne: "インデックス戦略を1つ以上有効にしてください",
      embeddingRequired: "RAG検索には埋め込みモデルが必要です",
      lockedTip:
        "ナレッジベースに内容がある間はインデックス戦略を変更できません。先にナレッジベースを空にしてください。",
      rebuildConfirmTitle: "インデックスを再構築",
      rebuildConfirmBody:
        "インデックス戦略が変更されました。既存の{count}件のドキュメントを再処理しますか？時間がかかる場合があります。",
    ...
    wikiBrowser: {
      ...
      deletePageBtn: "削除",
      deletePageConfirm:
        "ページ「{title}」を削除しますか？Wikiから表示されなくなります。",
      ...
      editContentPlaceholder:
        "Markdown本文。[[wiki-link]] 記法に対応しています",
      editSaveSuccess: "ページを保存しました",
      editSaveFailed: "保存に失敗しました",
      editConflictHint:
        "保存が競合しました。このページは他のユーザによってv{ver}に更新されています。最新版を読み込む（下書きは破棄されます）か、上書きしてください（上書きされた版は履歴に残ります）。",
      ...
      newPageSlugHint:
        "英数字とハイフンが使えます。「/」で階層を表します。後から変更できません",
      ...
      tabGraph: "グラフ",
      tabGraphTip:
        "Wikiページ間のリンクを表したグラフ（ページリンクグラフ）です。「ナレッジベース設定 → ナレッジグラフ」で設定する、LLMが抽出するエンティティ・リレーションのナレッジグラフとは異なります。",
      ...
      deleteFolderNotEmpty:
        "フォルダが空ではありません。先に中のページとサブフォルダを削除してください。",
      moveFolderSuccess: "フォルダを移動しました",
      moveFolderFailed: "フォルダの移動に失敗しました",
      moveFolderIntoSelf:
        "フォルダを自分自身またはその配下に移動することはできません",
      ...
      emptyDesc:
        "Wikiを有効にしてドキュメントをアップロードすると、ナレッジページが自動生成されます",
      ...
      indexEmpty:
        "Wikiページはまだありません。先にドキュメントをアップロードしてください。",
      graphNoData:
        "グラフのデータがまだありません。先にドキュメントをアップロードしてください。（この表示はWikiページ間のリンクを示すもので、「ナレッジベース設定 → ナレッジグラフ」で設定するエンティティ・リレーションのグラフとは異なります。）",
      showArrows: "矢印を表示",
      hideArrows: "矢印を非表示",
      ...
      cardOverviewHintTruncated:
        "ノードをダブルクリックすると、そのサブグラフに焦点を当てます",
      ...
      neighborsProgress:
        "{total}個の隣接ノードのうち{visible}個を表示中（{hidden}個は未読み込み）",
      neighborsAllShown:
        "{total}個の隣接ノードはすべてキャンバス上にあります（「隣接ノードを展開」でこのノードのサブグラフに焦点を当てられます）",
      neighborsNone: "このページにリンクされた隣接ノードはありません",
      neighborsCenterUnreachable:
        "{total}個の隣接ノードのうち{visible}個を表示中（{hidden}個は到達不可: リンク切れ、フィルタ対象外、または削除済み）",
      neighborsOverviewHidden:
        "{total}個の隣接ノードのうち{visible}個を表示中（{hidden}個は概要の範囲外です。「展開」をクリックするとここを起点に表示できます）",
      backToOverview: "概要に戻る",
      queueStatus: "Wikiキューに{count}件の保留中タスクがあります",
      issueTitle:
        "このページには{count}件の未処理のナレッジの競合またはエラーがあります",
      issueFixBtn: "AI自動修正",
      issueMixed: "情報の混在",
      issueConflict: "事実の矛盾",
      issueOutdated: "内容が古い",
    ...
    postCreateHint: {
      title: "作成しました",
      footer:
        "設定の調整を続け、共有やデータソースを設定してから「保存して閉じる」をクリックしてください。",
      followUpDesc:
        "左側でデータソースを設定するか、共有管理から共有スペースに公開してください",
    },
    share: {
      description:
        "ナレッジベースを共有スペースに共有して、メンバーが利用できるようにします",
      hintTitle: "共有に関する注意",
      addShare: "共有",
    ...
    messages: {
      ...
      indexModeRequired:
        "FAQ型ナレッジベースのインデックスモードを選択してください",
      storageChangeConfirm:
        "このナレッジベースには既にファイルがあります。ストレージエンジンを変更すると、既存のファイルにアクセスできなくなる可能性があります。続行しますか？",
    },
    document: {
      title: "ドキュメント管理",
      subtitle:
        "クリックまたはドラッグ＆ドロップでドキュメントをアップロードします。さまざまな形式を自動で解析し、インテリジェントにチャンク分割して検索可能なナレッジベースを構築します",
    },
    faq: {
      title: "FAQ設定",
      subtitle: "FAQエントリの一括インポート、編集、検索テストを行います",
      description:
        "FAQ型ナレッジベースのインデックス戦略とガイダンスを設定します",
      indexModeLabel: "インデックスモード",
      indexModeDescription:
        "質問のみをインデックスすると精度が向上し、質問と回答をインデックスするとリコールが向上します。",
      questionIndexModeLabel: "質問のインデックスモード",
      questionIndexModeDescription:
        "統合: 標準質問と類似質問をまとめてインデックスします。個別: 各質問を独立してインデックスするため検索精度は高まりますが、より多くのストレージが必要です。",
      entryGuide:
        "FAQエントリは、標準質問、類似質問、ネガティブ例、複数の回答で構成されます。FAQナレッジベースの詳細画面で管理できます。",
      ...
      standardQuestionDesc:
        "質問の標準的な言い回しを設定します。ユーザが最もよく使う表現にしてください。",
      answers: "回答",
      answersDesc:
        "完全で正確な回答内容を入力します。複数の回答を追加して、さまざまなケースに対応できます。",
      similarQuestions: "類似質問",
      similarQuestionsDesc:
        "意味は同じで言い回しが異なる質問を追加すると、ユーザの問い合わせとのマッチング精度が向上します。",
      negativeQuestions: "ネガティブ例",
      negativeQuestionsDesc:
        "この回答に一致させたくない質問を追加して、誤ヒットを除外します。",
      editorCreate: "FAQエントリを作成",
      editorEdit: "FAQエントリを編集",
      answerPlaceholder:
        "回答内容を入力してください。複数行に対応しています。Ctrl+Enterまたはボタンのクリックで追加します",
      similarPlaceholder:
        "類似質問を入力し、プラスアイコンをクリックして追加します",
      negativePlaceholder:
        "ネガティブ例を入力し、プラスアイコンをクリックして追加します",
      ...
      batchDelete: "選択項目を削除",
      confirmBatchDelete:
        "選択した{count}件のFAQエントリを削除しますか？この操作は取り消せません。",
    ...
    models: {
      ...
      embeddingLocked:
        "ナレッジベースに既にファイルがあるため、埋め込みモデルは変更できません",
      embeddingOptional: "（任意）",
      embeddingWikiOptionalDesc:
        "任意。設定すると、Wikiのディレクトリ分類における類似度マッチングに使用され、新しいページが既存のフォルダをより適切に再利用できます。未設定の場合はディレクトリツリー全体が使用されます。",
    },
    chunking: {
      title: "チャンク設定",
      description:
        "アップロードしたドキュメントを埋め込み前にどう分割するかを制御します。ほとんどの場合はデフォルトのままで問題ありません。検索品質が低い場合のみ調整してください。",
      sizeLabel: "チャンクサイズ",
      sizeDescription:
        "1チャンクあたりの最大文字数（100〜4000）。デフォルトの512は英語で約100〜130トークンです。FAQは小さめ（200〜400）、説明文中心のドキュメントは大きめ（1000〜2000）にします。",
      characters: "文字",
      overlapLabel: "チャンクの重なり",
      overlapDescription:
        "隣接するチャンク間で共有する文字数（0〜500）。デフォルトの80はサイズの約15%で、現在の研究では最適とされています。FAQや構造化データは0、長文の説明文は150〜200を使用します。",
      separatorsLabel: "区切り文字",
      separatorsDescription:
        "分割時に優先される文字または文字列です。優先度の高い区切り文字から順に試され、デフォルトの順序は段落 → 文 → 句読点の区切りを優先します。",
      ...
      parentChildDescription:
        "2階層のチャンク分割です。小さな子チャンクでベクトル一致を行い（高精度なヒット）、LLMには大きな親チャンクを返します（豊富なコンテキスト）。長文ドキュメント（10ページ超）に推奨です。短いFAQではストレージ節約のためオフにするとよいでしょう。",
      parentChunkSizeLabel: "親チャンクのサイズ",
      parentChunkSizeDescription:
        "LLMに返すコンテキストチャンクのサイズ（512〜8192）。デフォルトの4096は英語で約1000トークンで、最近のLLMのコンテキストウィンドウに十分収まります。",
      childChunkSizeLabel: "子チャンクのサイズ",
      childChunkSizeDescription:
        "ベクトル一致に使う埋め込み対象チャンクのサイズ（64〜2048）。デフォルトの384は約80トークンで、sentence-transformerやBGE系の埋め込みモデルに最適です。",
      strategyLabel: "チャンク分割戦略",
      strategyDescription:
        "ドキュメントをチャンクに分割する方法を選択します。自動モードはドキュメントごとに特性を分析し、最適な戦略を選びます。",
      strategyPlaceholder: "チャンク分割戦略を選択（空欄の場合は文字数で分割）",
      strategies: {
        auto: {
          label: "自動",
          tooltip:
            "ドキュメントの特性分析により、アップロードごとに見出しベース・構造ベース・文字数ベースの分割を選び分けます。",
        },
        heading: {
          label: "見出しベース",
          tooltip:
            "Markdownの見出し境界（#、##、###）で分割し、各チャンクに見出しのパスを保持します。構造の整ったMarkdownに最適です。",
        },
        heuristic: {
          label: "構造ベース",
          tooltip:
            "改ページ、番号付きセクション、多言語の章マーカー（DE／EN／ZH）、大文字のみのタイトルなど、検出した構造の手がかりで分割します。Markdown見出しのないPDFに最適です。",
        },
        legacy: {
          label: "文字数ベース",
          tooltip:
            "構造を無視し、文字数と区切り文字で再帰的に分割します（従来の動作）。構造ベースの戦略がうまく機能しない内容に使用してください。",
        },
      },
      overlapWarning:
        "チャンクサイズに対して重なりが大きすぎます。チャンク同士が内容の大半を共有することになります。",
      advancedLabel: "詳細オプション",
      tokenLimitLabel: "チャンクあたりのトークン上限",
      tokenLimitDescription:
        "1チャンクあたりのトークン数の上限（0〜8192）。0で無効（文字数のみで制御）。埋め込みモデルのトークン上限が小さい場合に設定します。MiniLM（256トークン）は200、BGE／Cohere（512トークン）は400が目安です。最近の埋め込みモデル（OpenAI、Voyage、Jina-v3）は2000トークン超に対応しているため、0のままで構いません。",
      languagesLabel: "言語のヒント",
      languagesDescription:
        "ヒューリスティックのパターンを指定した言語（DE／EN／ZH）に限定します。空欄の場合はサンプルから自動判定します。単一言語のコーパスでは明示的に指定すると、言語をまたいだ誤検出を防げます。",
      ...
      debug: {
        toggle: "チャンク分割をプレビュー",
        toggleHint:
          "再アップロードせずに、サンプルテキストでチャンク分割を試せます",
        sampleLabel: "サンプルテキスト",
        samplePlaceholder:
          "Markdownまたはプレーンテキストの断片を貼り付けると、現在の設定でどう分割されるか確認できます…",
        ...
        fallbackWarning:
          "戦略チェーンを使い切りました。現在の設定ではこの内容をうまく分割できません",
        profile: {
          lines: "行",
          chars: "文字",
    ...
    multimodal: {
      title: "画像処理の設定",
      description:
        "画像などの非テキストコンテンツを解析・検索するための画像内容理解を設定します",
    },
    asr: {
      title: "音声認識",
      description:
        "ASR（音声からテキストへの変換）を設定します。有効にすると、音声ファイル（mp3、wav、m4a、flac、oggなど）をアップロードしてテキストに書き起こせます。動画のアップロードには対応していません。",
      label: "音声認識を有効化",
      ...
      languageDescription:
        "任意。主要な言語のヒントを指定すると、一部のASRモデルで精度が向上します。空欄の場合は自動判定します。",
    ...
    advanced: {
      ...
      questionGeneration: {
        label: "AI質問生成",
        description:
          "ドキュメント解析時にLLMで各チャンクの関連質問を生成し、検索のリコールを向上させます。有効にするとドキュメントの解析時間が長くなります。",
        countLabel: "質問数",
        countDescription:
          "ドキュメントのチャンクごとに生成する質問の数（1〜10）",
        instructionsLabel: "質問生成の指示",
        instructionsDescription:
          "出力形式はシステム側で固定したまま、対象読者、利用シーン、表現を指定できます",
        instructionsPlaceholder:
          "例: カスタマーサポートで自然に出てくる質問を生成し、試験問題のような表現は避ける…",
      },
      autoTag: {
        label: "自動タグ付け",
        description:
          "解析後、ナレッジベースの既存タグから適切なものを選択します。タグの作成や削除は行いませんが、モデル呼び出しが1回追加で必要になります。",
        modelLabel: "分類モデル",
        modelDescription:
          "空欄の場合はナレッジベースの要約モデルを使用します。",
        modelPlaceholder: "分類モデルを選択",
        maxTagsLabel: "ドキュメントあたりの最大タグ数",
        maxTagsDescription:
          "ドキュメントごとに既存タグを1〜10件、自動で関連付けます。",
        skipIfTaggedLabel: "既にタグが付いたドキュメントをスキップ",
        skipIfTaggedDescription:
          "有効にすると、アップロード時に手動でタグ付けしたドキュメントはそのまま維持され、意図した分類が薄まりません。",
      },
      tableMetadataInstructions: {
        label: "テーブルメタデータの指示",
        description:
          "CSV／Excelの要約に業務コンテキストや項目の意味を追加し、検索精度を高めます",
        placeholder:
          "例: これは受注テーブルで、金額は人民元、ステータスは社内コードを使用している…",
      },
      multimodal: {
        label: "マルチモーダル機能",
        ...
        descriptionLanguageDescription:
          "空欄にすると中国語を強制せず、ドキュメントの言語に従います",
        descriptionLanguageAuto: "ドキュメントの言語に従う",
        customInstructionsLabel: "画像処理の指示",
        customInstructionsDescription:
          "OCRとMarkdown出力の仕様は固定したまま、視覚的に優先する対象を追加できます",
        customInstructionsPlaceholder:
          "例: 銘板、型番、アラームコード、表の単位を優先する…",
      },
    },
  },
  chat: {
    ...
    memoryHint:
      "この回答が参照した長期メモリです。削除すると以降は使用されません。",
    ...
    referencesDocAndWebCount:
      "{docCount}件のドキュメントと{webCount}件のWebページを参照",
    ...
    sandbox: {
      ...
      notStarted:
        "ターミナルはまだ起動していません。起動するとこの会話のサンドボックスに接続し、存在しないか一時停止中の場合は作成または再開します。",
      start: "ターミナルを起動",
      connecting: "サンドボックスに接続中…",
      needsProvision:
        "この会話には実行中のサンドボックスがありません。作成すると新しいサンドボックスが起動し、ワークスペースの設定に従って課金されます。",
      createAndStart: "作成して起動",
      noSandbox:
        "サンドボックスがまだなく、現在のエージェントにサンドボックスバックエンドが設定されていないため、作成先を決められません。サンドボックスが設定されたエージェントに切り替えるか、コードを実行するメッセージを送信してください。",
      unsupported:
        "現在のサンドボックスバックエンドは対話型ターミナルに対応していません",
      disconnected: "接続が切断されました",
      retry: "再接続",
      sessionEnded: "ターミナルセッションが終了しました",
      idleDisconnected:
        "アイドル状態のためターミナルが切断されました。サンドボックスは自身のTTLで一時停止します。再接続できます。",
      authRevoked:
        "ログイン状態が無効になったため、ターミナルが切断されました。再度サインインしてから接続してください。",
      ...
      paused:
        "この会話のサンドボックスは一時停止中です。ターミナルを起動すると再開します。",
    },
    ...
    fallbackHint:
      "ナレッジベースから関連する内容が見つかりませんでした。上記はモデルの直接回答です。",
  ...
  tenant: {
    ...
    create: {
      ...
      dialogSubtitle:
        "ワークスペースは独自のナレッジベースとメンバーを持ちます。作成するとあなたが新しいワークスペースのオーナーになります。",
      nameLabel: "ワークスペース名",
      namePlaceholder: "例: 新しいプロジェクト",
      nameRequired: "ワークスペース名を入力してください",
      descriptionLabel: "説明（任意）",
      descriptionPlaceholder:
        "このワークスペースの用途を簡単に入力してください",
      submit: "作成",
      cancel: "キャンセル",
      success: "ワークスペースを作成しました",
      failed: "ワークスペースの作成に失敗しました",
      disabled:
        "このシステムでは招待によるワークスペースへの参加のみが許可されています。自分で作成することはできません。",
    },
    details: {
      idLabel: "ワークスペースID",
    ...
    deleteDangerZone: {
      ...
      confirmBody:
        "「{name}」を削除し、そのナレッジベース、エージェント、メンバー、APIキーが利用できなくなります。この操作は取り消せません。",
      confirmHint:
        "削除を確認するには、ワークスペース名「{name}」を入力してください。",
      confirm: "ワークスペースを削除",
    ...
    api: {
      ...
      desktopPortDescription:
        "固定ポート（例: 37841）を使用すると、Chrome拡張機能などのツールが同じAPI URLを使い続けられます。0を指定すると起動ごとにランダムなポートになります。保存後はアプリを再起動してください。",
      desktopPortSave: "保存",
      desktopPortSaved:
      ...
      desktopBindPublicDescription:
        "有効にすると内蔵サーバが0.0.0.0でリッスンし、LAN上の他のデバイスから下記のアドレスでAPIにアクセスできます。公開範囲が広がるため、必要に応じてホストのファイアウォールやルーティング設定を利用してください。変更後はアプリを再起動してください。",
      desktopBindPublicSaved:
        "保存しました。反映するにはアプリを再起動してください。",
      desktopBindPublicSaveFailed: "保存に失敗しました",
      lanUrlLabel: "LAN用APIベースURL",
      lanUrlDescription:
        "「LANからのアクセスを許可」を有効にしてアプリを再起動すると表示されます。IPが正しくない場合は、システムのネットワーク設定で確認したこのマシンのIPv4アドレスにホスト部分を置き換えてください。",
      lanUrlCopyTitle: "LAN用API URLをコピー",
      lanUrlUnavailable:
        "APIはすべてのインターフェースでリッスンしていますが、LANのIPv4アドレスを自動検出できませんでした。ネットワーク設定でIPv4アドレスを確認し、http://YOUR_IP:PORT/api/v1の形式で手動で組み立ててください。",
    },
  },
  system: {
    title: "システム情報",
    sectionDescription:
      "システムのバージョン情報とユーザアカウント設定を表示します",
    loadingInfo: "情報を読み込み中...",
    retry: "再試行",
    versionLabel: "アプリバージョン",
    versionDescription: "アプリケーションサービス（weknora-app）のバージョン",
    vosAppVersionLabel: "VOS App Version",
    vosAppVersionDescription:
      "Version of the installed VOS application package",
    appImageVersionLabel: "App Image Version",
    appImageVersionDescription: "Version of the running WeKnora backend image",
    frontendImageVersionLabel: "UI Image Version",
    frontendImageVersionDescription: "Version of the running weknora-ui image",
    docreaderImageVersionLabel: "DocReader Image Version",
    docreaderImageVersionDescription:
      "Version of the running weknora-docreader image",
    sandboxImageVersionLabel: "Sandbox Image Version",
    sandboxImageVersionDescription:
      "Version of the configured weknora-sandbox image",
    ...
    dbMigrationFailedDesc:
      "起動時のデータベースマイグレーションが正常に完了しませんでした。一部のテーブルやインデックスが欠落し、Wikiの取り込みやナレッジグラフなどの機能が動作しない可能性があります。まず下記のトラブルシューティングガイドを確認し、解決しない場合はリンクから問題を報告してください。",
    ...
    globalSettings: {
      title: "システム設定",
      description:
        "プラットフォーム全体のランタイム設定です。保存するとすべてのワークスペースに即座に反映されます。システム管理者のみが表示・編集できます。",
      loading: "読み込み中...",
      ...
      badgeOverrideTooltip:
        "この値は管理者によってデータベースに保存されており、環境変数と組み込みのデフォルト値を上書きしています。",
      modifiedAt: "最終更新: {value}",
      tagInputPlaceholder:
        "Enterキーで項目を追加します。例: example.com / *.foo.com / 10.0.0.0/8",
      priorityHint: {
        disclosure: "設定のソースと優先順位",
        tier1:
          "このページで保存した項目（「上書き済み」表示）が常に優先され、環境変数は無視されます。",
        tier2:
          "ここで保存していない項目は環境変数の値が使われ、環境変数が未設定の場合は組み込みのデフォルト値が使われます。",
        tier3:
          "項目を環境変数の管理下に戻すには、その行の「リセット」ボタンをクリックしてください。",
      },
      sections: {
        access: {
          ...
          title: "アカウントとアクセス",
          description:
            "システム管理者、公開登録、ワークスペース作成のルールを管理します。",
        },
        tenant: {
          tab: "ワークスペースのデフォルト値{count}",
          title: "ワークスペースのデフォルト値",
          description:
            "既存のワークスペースを変更せずに、新規ワークスペースの初期クォータと互換動作を設定します。",
        },
        runtime: {
          tab: "ランタイムと並列実行{count}",
          title: "ランタイムと並列実行",
          description:
            "バックグラウンドのワーカプールとモデルサービスの並列実行数を設定します。",
        ...
        security: {
          ...
          title: "ネットワークセキュリティ",
          description:
            "SSRF許可リストと、Dockerサンドボックスの利用可否を管理します（ローカルのdocker.sockはホストのroot権限に相当します）。",
        },
        other: {
          tab: "その他{count}",
          title: "その他の設定",
          description:
            "このデプロイ環境に存在する、標準の製品グループに属さない設定です。",
        },
      },
      runtimeTable: {
        setting: "設定と用途",
      ...
      runtime: {
        title: "タスクキューのランタイム",
        description:
          "各ワーカプールのバックグラウンドキューの負荷とプロセスごとの容量をリアルタイムに表示します。タスクの詳細と安全な操作が可能で、5秒ごとに自動更新されます。",
        refresh: "更新",
        ...
        unavailable:
          "このデプロイ環境にはRedis / asynqキューがありません（Liteモード）。表示できる情報はありません。",
        empty: "キューのデータがありません",
        detailsTitle: "キューの詳細",
        detailsDescription:
          "各処理レーンのリアルタイムな負荷と待ち時間です。「失敗（停止）」はタスクが再試行の上限を超え、自動実行が停止したことを示します。",
        poolsTitle: "ワーカプール",
        poolsDescription:
          "各ステージには保証容量があり、コア解析とエンリッチメントは共有弾性プールも借用できます。",
        ...
        footnote:
          "カードの値はクラスタ全体の実行中/リアルタイムの容量です。プロセスごとの設定は変更後に再起動が必要です。共有弾性プールはコア解析とエンリッチメントのキューのみを処理します。",
        ...
        failedNotice: {
          ...
          description:
            "下の表で赤い「失敗」の件数を開くと原因を確認できます。原因を解消してから再試行してください。",
        },
        tasks: {
          title: "タスクの詳細 · {queue}",
          description:
            "すべてのタスク状態を確認できます。予約済みと再試行のタスクは次回実行が早い順、その他の状態は新しい順に表示されます。",
          ...
          loadMore: "さらに読み込む",
          loadedSummary:
            "{count}件を読み込みました。スクロールまたはタップでさらに読み込みます",
          ...
          health: "実行状態",
          orphaned:
            "実行インスタンスとの接続が切れています。復旧を待っています",
          cancel: "タスクを中止",
          cancelConfirm:
            "業務側の中止フローを使用し、同じドキュメントの関連タスクも停止します。中止しますか？",
          runNow: "今すぐ実行",
          runNowConfirm:
            "このタスクは再試行回数をリセットせずに、すぐ保留中に移動します。続行しますか？",
          deleteRecord: "レコードを削除",
          deleteConfirm:
            "このキューからレコードを削除するだけです。元のタスクが実行・完了されることはなく、履歴ログは残ります。削除しますか？",
          purgeArchived: "失敗したタスクをすべて削除",
          purgeArchivedConfirm:
            "このキューから失敗レコード{count}件をまとめて削除します。キュー内の失敗タスクのみを削除するもので、実行中や保留中のタスクには影響せず、すでに失敗したドキュメントの業務ステータスも戻りません。削除しますか？",
          ...
          guides: {
            active:
              "実行インスタンス、開始日時、実行期限、接続切れの状態を確認できます。業務ステータスを安全に更新できる場合にのみ中止できます。",
            pending:
              "保留中のタスクはまだ取得されていません。中止すると、Redisのデータを削除するだけでなく業務ステータスも更新されます。",
            scheduled:
              "予約済みのタスクは前倒しで実行できます。ドキュメント処理のタスクは業務側の安全な中止も利用できます。",
            retry:
              "最後のエラー、試行回数、次回実行日時をもとに、今すぐ実行するか中止するかを判断してください。",
            archived:
              "再実行する前に根本原因を解消してください。レコードを削除しても元の業務タスクは完了しません。",
            completed:
              "結果の保持期間が設定された最近の完了タスクのみを表示します。管理操作は利用できません。",
          },
          actionSuccess: {
            cancel: "タスクを中止しました",
        ...
        models: {
          title: "モデルの並列実行",
          description:
            "バックグラウンドタスクによるモデルサービスの実際の並列実行数です。上のセクションはタスクのスケジューリング、こちらは別段階のモデルサービスのレート制限を示します。",
          scope: "実行中はクラスタ全体 · 待機中は現在のインスタンス",
          disabled:
            "バックグラウンドのモデル並列実行の制御は無効です。モデルのデフォルトの並列実行上限はシステム設定で変更できます。",
          empty:
            "モデルの実行データはまだありません。モデルが初めてバックグラウンドで呼び出されると表示されます。",
          backgroundOnly:
            "バックグラウンドタスクのみが対象で、対話型のチャットは含まれません",
          columns: {
            model: "モデルID",
            active: "実行中",
            waiting: "レート制限待ち",
      ...
      keyDescriptions: {
        auth: {
          registration_mode:
            "セルフサービス登録のモードです。self_serveは誰でもアカウントを登録でき、invite_onlyは公開登録を無効にし、オーナー/管理者による招待のみを許可します。保存後すぐに反映されますが、self_serveはインターネットからのスパム登録を招くため慎重に利用してください。",
          default_tenant_mode:
            "公開登録後のワークスペース作成方式です。create_personalはオーナー権限のワークスペースを作成し、tenantlessはアカウントのみを作成して、ユーザが招待を承諾するかワークスペースを作成するまで待ちます。新規ユーザにのみ適用されます。",
          complex_password_enabled:
            "複雑なパスワードを必須にするかどうかです。有効にすると、パスワードに大文字・小文字・数字・特殊文字を含める必要があります。変更はすぐに反映され、新規登録ユーザおよび新たなパスワード変更・リセットにのみ適用されます。特殊文字は{specialChars}です",
        },
        ssrf: {
          whitelist:
            "SSRF保護の許可リストです。example.com / *.foo.com / 10.0.0.0/8 / 2001:db8::1のような項目を指定できます。保存後すぐに反映されます。SSRF_WHITELIST_EXTRA環境変数は引き続きデプロイ担当者が管理し、ここでは上書きされません。",
        },
        sandbox: {
          docker_enabled:
            "Dockerサンドボックスのバックエンドを許可します。ローカルのdocker.sockはホストのroot権限に相当するため、デフォルトでは無効です。有効化できるのはシステム管理者のみで、変更はすぐに反映されます。デーモンのソケットをマウントするプライベートな単一ノード環境、またはTLSで保護されたリモートのtcp://エンドポイントを使用する場合にのみ有効にしてください。",
        },
        tenant: {
          max_owned_per_user:
            "スーパーユーザ以外がセルフサービスで所有できるワークスペース数の上限です。ワークスペース作成のたびに参照され、保存後すぐに反映されます。0を指定すると組み込みのデフォルト値10が使われ、負の値を指定すると上限が無効になります（公開環境では非推奨）。",
          self_service_creation_enabled:
            "スーパーユーザ以外が自分でワークスペースを作成できるかどうかです。無効にすると、一般ユーザは招待によって既存のワークスペースに参加することしかできません。ワークスペース横断のスーパーユーザは対象外です。すぐに反映されます。",
          default_storage_quota_gb:
            "新規ワークスペースの作成時に割り当てられるデフォルトのストレージクォータ（GB）です。ベクトル、原本、テキスト、インデックスなどのデータが対象です。作成時にのみ参照されるため、変更は新規作成のワークスペースにのみ適用され、既存のワークスペースには遡って反映されません。0または負の値の場合は組み込みのデフォルト値10GBが使われます。",
          auto_create_api_key:
            "新規ワークスペースにfull_accessのAPIキーを自動作成し、作成レスポンスで平文のトークンを返します。従来の動作に依存する連携でのみ利用してください。デフォルトでは無効で、APIキーは明示的に作成することを推奨します。",
          auto_accept_invitation:
            "有効にすると、登録済みユーザをメールで招待した際に、受信確認を待たずにすぐメンバーとして追加されます。無効の場合、招待された側がメールから承諾する必要があります。すぐに反映されます。",
        },
        asynq: {
          core_concurrency:
            "ドキュメント解析と手動での再解析のプロセスごとの保証並列実行数です。コア解析は共有弾性プールも借用できます。最小値は1で、サービスの再起動が必要です。",
          postprocess_concurrency:
            "プロセスごとの並列実行数で、解析完了後の軽量な仕上げ処理とエンリッチメントの振り分け専用です。最小値は1で、サービスの再起動が必要です。",
          enrichment_concurrency:
            "要約、画像、グラフ、質問の生成のプロセスごとの保証並列実行数です。エンリッチメントは共有弾性プールも借用できます。最小値は1で、サービスの再起動が必要です。",
          maintenance_concurrency:
            "データソース同期、一括処理、クリーンアップのプロセスごとの並列実行数で、ユーザ向けのパイプラインから完全に分離されています。最小値は1で、サービスの再起動が必要です。",
          shared_concurrency:
            "コア解析とエンリッチメントが共有する、プロセスごとの弾性的な並列実行数です。バックログのある側が自動的に借用します。最小値は1で、サービスの再起動が必要です。",
          wiki_concurrency:
            "Wiki専用ワーカプールのプロセスごとの並列実行数で、上流のタスクから分離されています。最小値は1で、サービスの再起動が必要です。",
        },
        model: {
          max_concurrency:
            "単一モデルへのバックグラウンド（取り込み・エンリッチメント）呼び出しのデフォルトの並列実行上限です。モデルIDごとに管理され、すべてのレプリカで共有されます。呼び出しのたびに参照され、再起動なしですぐに適用されます。0または負の値の場合はデフォルトの上限が無効になります（各モデルはモデル管理で設定した独自の上限に従います）。対象はバックグラウンドタスクのみで、対話型のチャットには影響しません。",
        },
      },
      enumLabels: {
        auth: {
      ...
      confirm: {
        ...
        bodyAuthRegistrationMode:
          "「{label}」を次の値に変更します: {value}\n\nself_serveに切り替えると、インターネット上の誰でもアカウントを登録できるようになります。意図した変更かどうか確認してください。",
        bodySandboxDockerEnabled:
          "有効にすると、ワークスペース管理者がサンドボックスをローカルのDockerデーモンに接続できるようになります。ローカルのdocker.sockはホストのroot権限に相当します。デーモンをマウントするプライベートな単一ノード環境、またはTLSで保護されたリモートのtcp://エンドポイントを使用する場合にのみ利用してください。",
      },
      listConfirm: {
        ssrf: {
          whitelist: {
      ...
      reset: {
        label: "リセット",
        tooltip:
          "UIでの上書きを解除し、環境変数または組み込みのデフォルト値に戻します",
        confirmBtn: "リセットを確認",
        confirmBody:
          "「{label}」をリセットしますか？データベースの上書き設定を削除し、環境変数または組み込みのデフォルト値に戻します。",
      ...
      admins: {
        label: "システム管理者",
        description:
          "プラットフォームレベルの権限を持つユーザです。メールアドレスを入力してEnterキーを押すと権限を付与でき、タグの×をクリックすると取り消せます。あなた自身も管理者ですが一覧には表示されず、自分の権限を取り消すことはできません。",
        placeholder:
          "ユーザのメールアドレスを入力してEnterキーを押してください",
      ...
      passwordReset: {
        ...
        description:
          "ログインできない他のユーザに新しいパスワードを設定します。リセットに成功すると、そのユーザの現在のセッションはすべて無効になり、新しいパスワードで再度ログインする必要があります。",
        action: "パスワードをリセット",
        dialogTitle: "他のユーザのパスワードをリセット",
        warning:
          "これは高リスクの操作です。ユーザのメールアドレスをよく確認してください。ここで自分のパスワードをリセットすることはできません。",
        emailLabel: "ユーザのメールアドレス",
        emailPlaceholder:
          "リセット対象ユーザのメールアドレスを入力してください",
        ...
        confirmBtn: "リセットを確認",
        success:
          "パスワードをリセットし、そのユーザの既存セッションを無効にしました",
        failed: "パスワードのリセットに失敗しました",
      },
      createUser: {
        label: "ユーザを作成",
        description:
          "ローカルユーザアカウントを新規に作成します。プラットフォームのデフォルトのワークスペースモードが「個人ワークスペースを作成」の場合、自分で登録したユーザと同様に個人ワークスペースが作成されます。",
        action: "ユーザを作成",
        dialogTitle: "新しいユーザを作成",
        warning:
          "これは高リスクの操作です。ユーザ名とメールアドレスをよく確認してください。これらは新しいユーザのログインに使用されます。",
        usernameLabel: "ユーザ名",
        ...
        missingPassword:
          "ユーザは作成されましたが、生成されたパスワードが返されませんでした。パスワードをリセットしてアクセスを復旧してください。",
        ...
        generated: {
          ...
          successBody:
            "このユーザにランダムなパスワードを生成しました。パスワードは一度だけ表示されます。",
          usernameLabel: "ユーザ名",
          emailLabel: "メールアドレス",
      ...
      bulkApply: {
        ...
        tooltip:
          "値を保存してもデフォルトでは新規ワークスペースにのみ適用されます。ここをクリックすると既存のすべてのワークスペースも上書きします。",
        confirmBtn: "適用を確認",
        confirmBody:
          "既存のすべてのワークスペースのストレージクォータを{value}GBに上書きします。運用担当者が個別に調整したワークスペースも上書きされます。続行しますか？",
        success:
          "{count}件のワークスペースのストレージクォータを{gb}GBに更新しました",
        failed: "すべてのワークスペースへの適用に失敗しました",
      },
      audit: {
        tabLabel: "監査ログ",
        description:
          "プラットフォームレベルのイベントです。システム設定の変更、システム管理者の付与・解除、クォータの一括同期などを新しい順に表示します。",
        refresh: "更新",
        retry: "再試行",
        loading: "読み込み中…",
        end: "これ以上の履歴はありません。",
  ...
  mcp: {
    testResult: {
      ...
      requireApprovalTip:
        "有効にすると、エージェントはこのツールを呼び出す前に停止し、承認を待ちます。DBへの書き込みや削除などに利用してください",
      approvalSaveFailed: "承認設定の保存に失敗しました",
      toolEnabled: "ツールを有効化",
      toolEnabledTip:
        "無効にすると、エージェントはこのツールを認識も呼び出しもしません",
  ...
  model: {
    ...
    editor: {
      ...
      displayNameDesc:
        "UIでの表示にのみ使用されます。実行時の呼び出しには上のモデル名が使われます。",
      ...
      lkeap: {
        ...
        regionDesc:
          "RunRerankはap-beijing、ap-guangzhouなどに対応しています。デフォルト値: ap-guangzhou",
        rerankCredentialHint:
          "リランクはTencent CloudのAPI署名（OpenAI形式のLKEAP APIキーではありません）を使用します。SecretId/SecretKeyはCAMコンソールで作成してください。",
      },
      volcengine: {
        ...
        rerankCredentialHint:
          "リランクはArkのAPIキーではなく、VikingDBのAK/SK署名を使用します。推奨モデル: doubao-seed-rerank。",
      },
      customHeadersLabel: "カスタムリクエストヘッダー（任意）",
      customHeadersDesc:
        "リモートモデルAPIへのリクエストに追加するHTTPヘッダーです（企業ゲートウェイの認証やトレースなどに利用）。Authorization / Content-Typeなどの予約ヘッダーは無視されます。",
      ...
      dimensionOverrideDesc:
        "プロバイダのドキュメントでこのモデルがdimensionsパラメータに対応していると記載されている場合にのみ有効にしてください。デフォルトでは検出された実際の次元数のみを使用します。",
      supportsVisionLabel: "視覚・マルチモーダルに対応",
      supportsVisionDesc:
        "モデルが画像やマルチモーダル入力を受け付けるかどうか",
      desensitizeRulesLabel: "Enable rule-based redaction",
      desensitizeRulesDesc:
        "Replace structured sensitive data such as phone numbers, email addresses, IDs, and secrets before calling this model.",
      desensitizeNerLabel: "Enable NER redaction",
      desensitizeNerDesc:
        "After rule-based redaction, also detect names and locations. The redaction service must have its NER model ready.",
      desensitizeImageLabel: "Enable image redaction",
      desensitizeImageDesc:
        "Images uploaded in chat and images parsed through this model are masked by the redaction service first. The redaction service must support image OCR.",
      ...
      desensitizeFailureDesc:
        "When enabled, an unavailable redaction service blocks the model request instead of sending the original text.",
      desensitizeServiceUrlRequired:
        "A redaction service URL is required when redaction is enabled",
      desensitizeServiceUrlInvalid: "The redaction service URL is invalid",
      contextWindowLabel: "コンテキストウィンドウ",
      contextWindowPlaceholder: "デフォルト値{value}",
      contextWindowDesc:
        "1回のリクエストでこのモデルが受け付けられるトークン数です。エージェントの履歴圧縮はこの上限を基準にします。空欄の場合はデフォルト値の200000（200K）が使われます。プロバイダの実際のウィンドウサイズを指定してください。大きすぎる値を指定すると圧縮が働かず、プロバイダにリクエストを拒否されます。",
      ...
      maxConcurrencyDesc:
        "このモデルへのバックグラウンド（取り込み・エンリッチメント）呼び出しの並列数を制限します。モデルごとにすべてのレプリカで共有されます。0または空欄の場合はグローバルのデフォルト値が使われます。対話型のチャットには影響しません。",
      thinkingControlLabel: "思考モードのリクエスト形式",
      thinkingControlDesc:
        "エージェントの「思考モード」のオン/オフをAPIにどう送信するかを設定します。可能な場合はベンダやモデルに応じて自動選択されます。お使いのAPIドキュメントに合わせて変更してください。「送信しない」を選ぶと、エージェントの思考モードの切り替えは効果がありません。",
      thinkingControl: {
        none: {
      ...
      dimensionHint:
        "モデルを選択しました。「次元数を検出」をクリックするとベクトル次元数を自動取得できます。",
      ...
      testDraftEditHint:
        "現在の接続設定と、個別に保存された API キーを使用してテストします。",
      ...
      providers: {
        ...
        aliyun: {
          ...
          description:
            "qwen-plus、tongyi-embedding-vision-plus、qwen3-rerankなど",
        },
        zhipu: {
        ...
        litellm: {
          label: "LiteLLM",
          description:
            "100以上のプロバイダ（OpenAI、Anthropic、Gemini、Bedrockなど）へのセルフホスト型プロキシです。プレースホルダのURLを置き換えてください。ループバックのホストにはSSRF_WHITELISTの設定が必要です。",
        },
        requesty: {
          label: "Requesty",
        ...
        volcengine: {
          label: "Volcengine",
          description:
            "doubao-1-5-pro-32k-250115、doubao-embedding-vision-250615など",
        },
        deepseek: {
          label: "DeepSeek",
        ...
        moonshot: {
          label: "Moonshot",
          description:
            "kimi-k2-turbo-preview、moonshot-v1-8k-vision-previewなど",
        },
        qianfan: {
          label: "Baidu Qianfan",
          description:
            "ernie-5.0-thinking-preview、embedding-v1、bce-reranker-baseなど",
        },
        longcat: {
          label: "LongCat AI",
        ...
        nvidia: {
          label: "NVIDIA",
          description:
            "deepseek-ai-deepseek-v3_1、nv-embed-v1、rerank-qa-mistral-4bなど",
        },
        novita: {
          label: "Novita AI",
          description:
            "moonshotai/kimi-k2.5、zai-org/glm-5、minimax/minimax-m2.7、qwen/qwen3-embedding-0.6bなど",
        },
      },
      ollamaNotSupportRerank:
        "Ollamaはリランクモデルに対応していません。リモートAPIを使用してください",
    },
    builtinTag: "組み込み",
  },
  language: {
  ...
  theme: {
    theme: "テーマ",
    themeDescription:
      "インターフェースの表示テーマを選択します。システム設定に合わせた自動切り替えにも対応しています",
    light: "ライト",
    dark: "ダーク",
    system: "システムに従う",
    selectTheme: "テーマを選択",
  ...
  font: {
    uiFont: "インターフェースフォント",
    uiFontDescription:
      "メニュー、本文、ボタンなど、ほとんどのUIテキストに使用されるフォントです",
    monoFont: "コードフォント",
    monoFontDescription:
      "コードブロック、ターミナルコマンド、APIキー、ファイルパスなどの技術的なテキストに使用されます。すべての文字が同じ幅のため、0とO、1とlを見分けやすくなります。",
    selectFont: "フォントを選択",
    ...
    fontSize: "フォントサイズ",
    fontSizeDescription:
      "インターフェース全体（文字、アイコン、余白）を拡大縮小し、すぐに反映されます",
    size: {
      small: "小",
      normal: "標準",
      large: "大",
  ...
  platform: {
    ...
    description:
      "RAG検索、エージェント推論、Wikiナレッジベースにより、ドキュメントを本当に理解し活用できます",
    rag: "RAG拡張生成",
    agent: "ReActエージェント",
    wiki: "Wikiナレッジベース",
  ...
  mcpSettings: {
    title: "MCPサービス",
    description:
      "エージェントモードでツールやリソースを利用するための外部MCP（Model Context Protocol）サービスを管理します",
    enabled: "有効",
    disabled: "無効",
    ...
    deleteConfirmBody:
      "MCPサービス「{name}」を削除しますか？この操作は取り消せません。",
    unnamed: "名称未設定",
    builtin: "組み込み",
  ...
  modelSettings: {
    ...
    personalDesensitizationHint:
      "This applies only to your account and this exact model record. Other models with the same name or endpoint, and other users, are not changed. NER runs after rule-based redaction.",
    title: "モデル設定",
    description:
      "ローカルのOllamaやリモートAPIなど、さまざまな種類のAIモデルを管理します",
    typeShort: {
      chat: "チャット",
      embedding: "埋め込み",
      rerank: "リランク",
    ...
    builtinModels: {
      title: "組み込みモデル",
      description:
        "組み込みモデルはすべてのワークスペースに表示されます。機密情報は非表示で、編集や削除はできません。",
      descriptionAdmin:
        "組み込みモデルはすべてのワークスペースに表示されます。システム管理者は設定と認証情報を編集できますが、削除はデプロイ側で管理されます。",
    ...
    usage: {
      title: "モデルを削除できません",
      description:
        "モデル「{name}」は次の設定から参照されています。削除する前に各設定を開き、別のモデルを選択してください。",
    ...
    debug: {
      ...
      documentsHint:
        "空でない各行が個別のドキュメントとしてリランクモデルに送信されます",
      imageFile: "画像ファイル",
      audioFile: "音声ファイル",
      chooseFile: "ファイルを選択",
  ...
  ollamaSettings: {
    title: "Ollama設定",
    description:
      "ローカルのOllamaサービスを管理し、モデルの確認やダウンロードを行います",
    status: {
    ...
    address: {
      ...
      failed:
        "接続に失敗しました。Ollamaが起動しているか、URLが正しいか確認してください",
    },
    download: {
      title: "モデルをダウンロード",
    ...
    toasts: {
      connected: "接続しました",
      connectFailed:
        "接続に失敗しました。Ollamaが起動しているか確認してください",
  ...
  mcpServiceDialog: {
    ...
    oauthRefreshable:
      "トークンの有効期限が切れています。次回利用時に自動的に更新されます",
    oauthUnauthorized: "未認可",
    oauthAuthorize: "認可",
    oauthReauthorize: "再認可",
    oauthRevoke: "認可を取り消す",
    oauthAuthorizeHint:
      "「認可」をクリックすると現在の設定を保存してから認可を開始します（ユーザごとに個別に認可します）。",
    apiKeyHeader: "ヘッダー名",
    apiKeyHeaderDesc:
      "未入力の場合はX-API-Keyが使われます。Bearerの場合はAuthorizationを指定し、下の値に「Bearer <token>」を入力してください。生トークンを使うサービスではAuthorizationに生トークンを設定します。",
    ...
    toasts: {
      ...
      oauthRequired:
        "このサーバはOAuthが必要です。OAuth 2.0に切り替えました。保存してから「認可」をクリックしてください。",
    ...
    codeImport: {
      ...
      parse: "解析して入力",
      editOverwriteHint:
        "インポートすると現在のフォームが上書きされます（保存済みの認証情報は影響を受けません。適用するには保存をクリックしてください）",
      errors: {
        ...
        stdioUnsupported:
          "stdio（command/args）の設定には対応していません。urlを含むリモート設定を使用してください",
      },
      toasts: {
        filled: "フォームに入力しました。内容を確認して保存してください",
        multipleServers:
          "複数のサービスが見つかったため、最初の1件をインポートしました: {name}",
      },
    },
  },
  promptTemplate: {
  ...
  organization: {
    title: "共有スペース",
    subtitle:
      "共有スペースを作成したり参加したりすることで、複数のワークスペースがナレッジベースやエージェントを共有して協働できます",
    createOrg: "共有スペースを作成",
    joinOrg: "共有スペースに参加",
    name: "共有スペース名",
    ...
    rbac: {
      needTenantAdminTip:
        "この操作には、現在のワークスペースで管理者以上のロールが必要です。ワークスペースのオーナーにお問い合わせください。",
      cannotCreate:
        "このワークスペースでのロールでは権限が不足しているため、共有スペースを作成できません",
      cannotJoin:
        "このワークスペースでのロールでは権限が不足しているため、共有スペースへの参加や参加申請ができません",
      cannotManage:
        "このワークスペースでのロールでは権限が不足しているため、この共有スペースを管理できません",
    },
    join: {
      title: "共有スペースに参加",
    ...
    invite: {
      ...
      inputDesc:
        "招待コードを入力（または招待リンクから貼り付け）すると、共有スペースを確認して参加できます",
      previewAction: "表示",
      primaryJoin: "参加",
    ...
    leaveConfirmMessage:
      "共有スペース「{name}」から退出してもよろしいですか？この共有スペースで共有されているナレッジベースにアクセスできなくなります。",
    leaveSuccess: "共有スペースから退出しました",
    leaveFailed: "共有スペースからの退出に失敗しました",
    deleteConfirmTitle: "共有スペースを削除",
    deleteConfirmMessage:
      "共有スペース「{name}」を削除してもよろしいですか？すべてのメンバーがこの共有スペースから除外されます。この操作は取り消せません。",
    ...
    emptyDesc:
      "共有スペースを作成するか、招待コードで既存の共有スペースに参加してください",
    createdByMe: "自分が作成",
    joinedByMe: "自分が参加",
    emptyCreated: "まだ共有スペースを作成していません",
    emptyCreatedDesc:
      "「共有スペースを作成」をクリックして新規作成してください",
    ...
    detail: {
      removeMemberConfirm:
        "メンバー「{name}」を共有スペースから除外してもよろしいですか？",
      removeMember: "メンバーを削除",
    },
    settings: {
      editTitle: "共有スペース設定",
      membersDesc:
        "共有スペースのメンバーとロールを確認・管理します。各メンバーは1つのワークスペースを表し、同じワークスペースのすべてのユーザがこの共有スペースへのアクセスを共有します。",
      permissionsIconHint: "ロールの権限を表示",
      sharedDesc:
        "この共有スペースに共有されているすべてのナレッジベースを表示します",
      noSharedKB: "共有されているナレッジベースはまだありません",
      noSharedKBTip:
        "ナレッジベースの所有者は、ナレッジベース設定から自分のナレッジベースをこの共有スペースに共有できます",
      sharedAgents: "共有エージェント",
      noSharedAgents: "共有されているエージェントはまだありません",
      sharedAgentsDesc:
        "この共有スペースに共有されているエージェントです。メンバーはチャットで利用できます",
      sharedAgentsKbHint:
        "エージェントに紐づくナレッジベースは、メンバーが会話でそのエージェントを利用する場合（{'@'}経由）にのみ読み取り専用で利用できます。ナレッジベース一覧には表示されません。メンバーが一覧でナレッジベースを閲覧・編集できるようにするには、そのナレッジベースを個別にこの共有スペースへ共有してください。",
      sharedAgentsKbHintShort:
        "エージェントに紐づくナレッジはチャット内で読み取り専用です。メンバーが一覧で閲覧・編集できるようにするには、ナレッジベースをこの共有スペースに共有してください。",
      noSharedAgentsTip:
        "管理者はエージェント設定からエージェントをこの共有スペースへ共有できます",
      sharePermissionLabel: "共有スペースの権限",
      myPermissionLabel: "実効権限",
      permissionCalcFormula:
        "共有スペースの権限は共有時に設定します。実効権限は、その権限と共有スペースでのロールのうち低い方になります",
      permissionCalcTip:
        "実効権限は共有スペースの権限とここでのロールのうち低い方です。閲覧者はこのナレッジベースに対して最大でも読み取り専用となります。",
      inviteMembers: "メンバーを招待",
      inviteMembersDesc:
        "招待コードまたはリンクで他のユーザを共有スペースに招待します",
      inviteLink: "招待リンク",
      ...
      removeShareConfirm:
        "この共有スペースから「{name}」の共有を解除しますか？メンバーはこのナレッジベースにアクセスできなくなります。",
      removeAgentShareConfirm:
        "この共有スペースから「{name}」の共有を解除しますか？メンバーはこのエージェントにアクセスできなくなります。",
      removeShareSuccess: "共有スペースへの共有を解除しました",
      removeShareFailed: "削除に失敗しました。再試行してください",
      requireApproval: "承認を必須にする",
      requireApprovalDesc:
        "有効にすると、新しいメンバーの参加に管理者の承認が必要になります",
      searchable: "検索を許可",
      searchableDesc:
        "有効にすると、この共有スペースが「共有スペースに参加」の検索一覧に表示され、他のユーザが招待コードなしで検索して参加申請できるようになります",
      memberLimit: "メンバー上限",
      memberLimitDesc:
        "上限に達すると新しいメンバーを追加できません。0を指定すると無制限になります",
    ...
    editor: {
      ...
      nameTip:
        "チーム名やプロジェクト名にすると、メンバーが識別しやすくなります",
      descriptionTip:
        "メンバーが理解しやすいよう、共有スペースの目的や目標を記載してください",
      permissionsTitle: "メンバーの権限",
      permissionsDesc:
        "共有スペース内のナレッジベースとエージェントに対する、各ロールの権限範囲を確認します",
      permissionFeature: "権限項目",
      fullAccess: "フルアクセス",
      editAccess: "編集可能",
      viewAccess: "閲覧のみ",
      adminPerm1:
        "共有スペースの設定、メンバー、ナレッジベースとエージェントの共有を管理",
      ...
      ownerNote:
        "共有スペースの作成者として、自動的にすべての権限を持つ管理者になります。",
      joinTitle: "共有スペースに参加",
      joinDesc:
        "招待コードで既存の共有スペースに参加し、共有されているナレッジベースとエージェントを利用します",
      joinIllustration:
        "共有スペースの管理者から提供された招待コードを入力して参加してください",
      inviteCodeTip:
        "招待コードは共有スペースの管理者が生成します。管理者にお問い合わせください",
    ...
    addMember: {
      ...
      dialogTitle: "メンバーを追加",
      tipTenant:
        "メンバーの単位はワークスペースです。ワークスペースが参加すると、そのすべてのユーザがこの共有スペースへのアクセス権を持ちます。以下の検索結果はワークスペース単位で重複を除いています。",
      searchTenant: "ワークスペース ID",
      searchTenantPlaceholder: "完全なワークスペース ID を入力",
      searchTenantHint:
        "完全なワークスペース ID で検索するか、招待リンクを共有してください。",
      selectRole: "ロールを割り当て",
      confirmBtn: "追加",
      success: "メンバーを追加しました",
    ...
    share: {
      ...
      permission: "権限",
      permissionTip:
        "編集可能な権限ではメンバーがナレッジベースの内容を変更できます。読み取り専用の権限では検索と質問応答のみ行えます",
      ...
      agentShareDesc:
        "このエージェントを共有スペースへ共有し、メンバーが利用できるようにします",
      sharedFrom: "共有元",
  ...
  preview: {
    ...
    unsupportedHint:
      "ダウンロードして、ローカルのアプリケーションで開いてください",
    fullscreen: "全画面表示",
  ...
  kbSettings: {
    vectorStore: {
      title: "ベクトルストア",
      description:
        "このナレッジベースの書き込み先ベクトルストアを選択します。この紐づけは変更できません。既存のナレッジベースを別のストアへ移すには、新しいナレッジベースを作成してインデックスを再作成してください。",
      loading: "ベクトルストアを読み込み中...",
      engineLabel: "ベクトルストア",
      engineDesc:
        "グローバルのベクトルストア設定からストアを選択します。システムデフォルトのままにすると、ワークスペース全体のRETRIEVE_DRIVERエンジンが使用されます。",
      boundLabel: "紐づけ済みベクトルストア",
      systemDefault: "システムデフォルト",
      immutableHint:
        "作成後は変更できません。後から移行するには、目的のストアに紐づけた新しいナレッジベースを作成し、インデックスを再作成してください。",
      immutableEdit: "ベクトルストアの紐づけは作成後に変更できません。",
      unavailableHint:
        "紐づけられたベクトルストアは現在利用できません。設定 → ベクトルストアで接続設定を確認してください。",
      goGlobalSettings: "ベクトルストア設定へ移動",
    },
    storage: {
      title: "ストレージエンジン",
      selectDescription:
        "このナレッジベースを紐づけるストレージインスタンスを選択します。",
      defaultTag: "デフォルト",
      instanceLabel: "ストレージインスタンス",
      instanceDesc:
        "同じストレージ種別でも、エンドポイント、バケット、認証情報が異なる複数のインスタンスを持てます。",
      migrateHint:
        "このナレッジベースにはすでにファイルが含まれています。インスタンスを切り替えるにはストレージ移行フローを使用してください。",
    ...
    parser: {
      title: "解析エンジン",
      description:
        "ファイル形式ごとにドキュメントの解析エンジンを選択します。未設定のファイル形式には組み込みの解析エンジンが使用されます。",
      loading: "読み込み中...",
      noEngineAvailable:
        "利用できる解析エンジンがないか、ドキュメント解析サービスが設定されていません。",
      default: "デフォルト",
      goConfig: "設定へ移動 →",
  ...
  agentStream: {
    ...
    shellExec: {
      ...
      binarySuppressed:
        "バイナリ出力は省略されました。ダウンロードするには、成果物ディレクトリにファイルを書き込んでください。",
    },
    citation: {
      notFound: "コンテンツが見つかりません",
      loadFailed: "読み込みに失敗しました",
      noKbForWiki:
        "関連するナレッジベースを特定できないため、Wikiを開けません。",
    },
    toolSummary: {
    ...
    search: {
      ...
      candidatesBelowThreshold:
        "{count}件の候補が一致しましたが、関連性が不十分なため回答には使用しませんでした",
      foundResultsFromFiles:
        "{files}件のファイルから{count}件の結果が見つかりました",
      foundResults: "{count}件の結果が見つかりました",
      foundMixedResults:
        "{count}件の結果が見つかりました（ドキュメント{docCount}件、Web検索結果{webCount}件）",
      webResults: "{count}件のWeb検索結果が見つかりました",
      grepSummary:
        "{docs}件のドキュメントで{chunks}件の一致するチャンクが見つかりました",
    },
    grepResults: {
    ...
    attachmentParsing: {
      ...
      parsedWithSkipped:
        "{parsed}件の添付ファイルを解析し、{skipped}件はスキップしました（処理中）",
    ...
    saveToKb: {
      ...
      editorOpened:
        "エディタを開きました。ナレッジベースを選択して保存してください",
    },
    mcp: {
  ...
  agentEditor: {
    builtinHint:
      "これは組み込みエージェントです。名前と説明は変更できませんが、設定パラメータは調整できます。",
    navGroups: {
      basic: "基本",
      knowledge: "ナレッジと検索",
      capability: "拡張機能",
    ...
    questionSuggestions: {
      ...
      title: "会話の質問サジェスト",
      description:
        "開始質問と文脈に応じたフォローアップを、エージェント側の1つのポリシーとして設定します。チャネル側では非表示にできますが、ポリシーを上書きすることはできません。",
      startersTitle: "会話の開始質問",
      followUpsTitle: "回答後のフォローアップ",
      enableStarters: "開始質問を表示",
      enableStartersDesc:
        "最初のユーザメッセージの前に、キュレーション・ナレッジベース・ハイブリッドのいずれかのソースから表示されます。",
      enableFollowUps: "フォローアップ質問を生成",
      enableFollowUpsDesc:
        "回答が完了するたびに非同期で生成します。有効にするとモデルの使用量が増えます。",
      sourceMode: "ソースモード",
      count: "質問数",
      curatedItems: "キュレーション質問",
      curatedItemsDesc:
        "開始質問に使用され、ハイブリッドモードでは優先されます。",
      addItem: "質問を追加",
      model: "生成モデル",
      ...
      instructionPlaceholder:
        "例: 実践的な次のステップに関する質問を優先し、漠然とした質問や回答の繰り返しは避ける…",
    ...
    intentPrompts: {
      title: "インテントプロンプト",
      sectionDesc:
        "インテントごとのシステムプロンプトを設定します。未設定の場合はデフォルトが適用されます",
      intentLabel: "インテント",
    ...
    desc: {
      ...
      systemPrompt:
        "エージェントの動作と役割を定義するカスタムシステムプロンプト",
      promptInheritance:
        "テンプレートの原文は更新に追従し、編集した内容はカスタムプロンプトとして保存されます。エージェントモードでは役割と作業要件を定義します。ツール権限と各ターンの情報源選択は別途制御されます。",
      leaveEmptyDefault: "（空欄の場合はシステムのデフォルトを使用）",
      contextTemplate: "検索した内容をモデルに渡す前の整形方法を定義します",
      model: "エージェントが使用するLLMを選択します",
      temperature:
        "出力のランダム性を制御します。0が最も決定的、1が最もランダムです",
      maxTokens:
        "モデルの応答の最大トークン数。デフォルトは2048です。カスタム値は入力したとおりに保存されます。",
      maxTokensAgent:
        "推論の各ラウンドで生成される最大トークン数（ツール呼び出しのJSONを含む）。デフォルトは、サンドボックスなしの場合4096、サンドボックスがファイルの書き込みや編集を行える場合は24576です。カスタム値は入力したとおりに保存され、以降変更されません。",
      thinking: "拡張思考機能を有効にします（モデルの対応が必要）",
      conversationSection:
        "マルチターン会話とクエリのリライトに関するパラメータを設定します",
      conversationSectionAgent:
        "各ターンで引き継ぐ過去の会話の量。スマート推論は常にマルチターンです",
      multiTurn: "有効にすると、過去の会話のコンテキストが保持されます",
      historyRounds: "コンテキストとして保持する直近の会話ラウンド数",
      retainRetrievalHistory:
        "過去のターンのナレッジベース検索結果を保持します。無効にすると、ターンごとに再検索します",
      rewrite:
        "マルチターン会話でユーザの質問を自動的にリライトし、指示語や省略を補完します",
      memoryEnabled:
        "このエージェントが長期メモリを読み取り、追記できるようにします。無効にすると、このエージェントとの会話はメモリを読み取らず、新しいメモリも追加しません。ワークスペースまたは個人の設定が無効の場合、ここで有効にしても反映されません",
      queryUnderstandModel:
        "クエリ理解（リライトとインテント判定）に使用するモデル。空欄の場合はメインのチャットモデルを使用します。",
      rewriteSystemPrompt:
        "質問リライト用のシステムプロンプト（空欄でデフォルト）",
      rewriteUserPrompt:
        "質問リライト用のユーザプロンプトテンプレート（空欄でデフォルト）",
      selectTools: "エージェントが使用できるツールを選択します",
      maxIterations:
        "1つのタスクで実行できる推論ステップ数の上限。無制限にすると、モデルが自ら停止するか手動で停止するまで続行します。",
      kbScope: "エージェントがアクセスできるナレッジベースの範囲を選択します",
      webSearch:
        "有効にすると、エージェントがインターネットで情報を検索できます",
      webSearchProvider:
        "このエージェントで使用する検索エンジンを指定します。空欄の場合はデフォルトを使用します。",
      webSearchMaxResults: "1回の検索で返される結果の最大数",
      webFetchEnabled:
        "リランク後、上位のWeb検索結果からページ全文を自動取得し、回答精度を高めます",
      webFetchTopN: "リランク後に取得するWebページの最大数",
      retrievalSection:
        "ナレッジベースの検索、ランキング、FAQ優先戦略を設定します",
      ...
      fallbackStrategy:
        "ナレッジベースで関連する内容が見つからない場合の処理方法",
      fallbackResponse: "回答できない場合に返す固定テキスト",
      fallbackPrompt:
        "ナレッジベースで回答が見つからない場合に、モデルの応答を導くプロンプト",
    },
    tools: {
      thinking: "思考",
      ...
      grepChunks: "キーワード検索",
      grepChunksDesc:
        "特定のキーワードを含むドキュメントとチャンクを素早く特定します",
      ...
      requiresRagKb:
        "（ベクトル/キーワードインデックスが有効なナレッジベースが必要）",
      ...
      statusInactive:
        "選択済みの{count}個のツールは、現在の設定では有効になりません",
    ...
    embed: {
      title: "Webページ埋め込み",
      description:
        "このエージェントをお使いのWebサイトに埋め込み、ページ内ウィンドウやフローティングランチャから訪問者がチャットできるようにします。ナレッジベースの範囲はこのエージェントの設定に従います。",
    },
    im: {
      title: "IM連携",
      description:
        "WeCom、Feishu、Lark、Slack、Telegram、DingTalk、Mattermost、WeChat、QQBot、Yunzhijiaなどのインスタントメッセージングプラットフォームにエージェントを接続します",
      feishu: "Feishu",
      lark: "Lark",
      slack: "Slack",
      telegram: "Telegram",
      ...
      editChannel: "チャネルを編集",
      deleteConfirm:
        "このチャネルを削除してもよろしいですか？この操作は取り消せません。",
      channelName: "チャネル名",
      channelNamePlaceholder: "識別しやすい名前を入力してください",
      channelNameDefaultHint:
        "デフォルトはプラットフォーム名です。任意の名前に変更できます。空欄のまま保存するとプラットフォーム名が使用されます",
      platform: "プラットフォーム",
      mode: "接続モード",
      outputMode: "出力モード",
      ...
      yunzhijiaAppSecretPlaceholder:
        "YunzhijiaオープンプラットフォームのApp Secret",
      yunzhijiaAppCredentialHint:
        "appAccessTokenの取得と、ユーザが送信した画像のダウンロードに使用されます。",
      yunzhijiaTimeout: "HTTPタイムアウト（秒）",
      yunzhijiaTimeoutHint:
        "メッセージ送信URL経由で返信を送る際のタイムアウト。デフォルトは10秒",
      yunzhijiaAllowedHostSuffix: "許可するホストのサフィックス",
      yunzhijiaAllowedHostSuffixHint:
        "セキュリティのため、メッセージ送信URLのホストをこのサフィックスに制限します（例: yunzhijia.com）",
      yunzhijiaSendMsgUrlRequired:
        "Yunzhijiaのボット設定にあるメッセージ送信URLを入力してください",
      mattermostModeHint:
        "MattermostはWebhookモードのみ対応しています（送信Webhook + Botトークン）。",
      mattermostPostToMain: "チャネルのタイムラインに返信を投稿",
      mattermostPostToMainHint:
        "有効にすると、Botの返信はチャネル内の新しいトップレベル投稿になります。無効（デフォルト）の場合はスレッド内に留まり、メインビューには「N件の返信」とだけ表示されます。",
      modeHint: "設定が簡単なWebSocketを推奨します",
      consoleTip: "で認証情報を取得",
      wecomWSEndpointHint:
        "任意。WeComをセルフホストで導入している場合は、カスタムWebSocketアドレスを入力してください。空欄の場合はデフォルトのパブリッククラウドのエンドポイントを使用します。内部ネットワークのアドレスの場合は、ホスト名をSSRF_WHITELIST環境変数に追加してください。",
      wecomAPIBaseURLHint:
        "任意。WeComをセルフホストで導入している場合は、カスタムAPIベースURLを入力してください。空欄の場合はデフォルトのパブリッククラウドのエンドポイントを使用します。内部ネットワークのアドレスの場合は、ホスト名をSSRF_WHITELIST環境変数に追加してください。",
      feishuAPIBaseURLHint:
        "任意。サーバが直接インターネットに接続できる場合は空欄のままにしてください。Feishuへのアクセスにプロキシが必要な場合は、リバースプロキシのURL（例: nginx、http://host:port）を入力してください。内部ネットワークのアドレスの場合は、ホスト名をSSRF_WHITELIST環境変数に追加してください。",
      fileKnowledgeBase: "ファイル保存先ナレッジベース",
      fileKnowledgeBasePlaceholder: "ナレッジベースを選択（任意）",
      fileKnowledgeBaseHint:
        "設定すると、ユーザが送信したファイルがこのナレッジベースに自動的に保存されます",
      sessionMode: "セッションモード",
      sessionModeUser: "ユーザ単位（デフォルト）",
      sessionModeThread: "スレッド単位",
      sessionModeHint:
        "ユーザモード: 各ユーザが個別の会話を持ちます。/clearで新しく開始できます。スレッドモード: メッセージスレッドごとに個別の会話になります。同じスレッドで複数人が共同作業できます。",
      wechatScanBind: "スキャンしてWeChatを連携",
      wechatScanning: "WeChatでQRコードをスキャンしてください",
      wechatBindSuccess: "WeChatを連携しました",
      wechatRebind: "再連携",
      wechatHint:
        "iOS版WeChat 8.0.70以降が必要です。ダイレクトメッセージのみ対応しています",
    ...
    agentType: {
      ...
      kbIncompatibleWarn:
        "選択した{count}件のナレッジベースはこのタイプと互換性がありません。手動で調整してください。",
    },
    mcp: {
      label: "MCPサービス",
      ...
      authWaitTimeoutDesc:
        "会話中にOAuth認証を求められた際、完了を待機する最大秒数です。この時間を過ぎると、認証の確認は自動的にスキップされます（OAuthを使用するMCPサービスのみに影響します）。",
    ...
    imageUpload: {
      ...
      sectionDesc:
        "チャットでの画像・ドキュメント・音声の添付、および解析ルールと関連モデルを設定します",
      label: "画像アップロード",
      ...
      imageUnderstandingDesc:
        "画像のみのPDF/PPT（スキャンしたドキュメント）で、テキストを抽出できない場合にVLM OCRを実行します。解析に時間がかかるようになります。デフォルトは無効です。",
      ocrMaxPagesLabel: "スキャンOCRの最大ページ数",
      ocrMaxPagesDesc:
        "OCRのためVLMに送信するスキャンしたドキュメントの最大ページ数。ページ数を増やすとカバー範囲は広がりますが、解析は遅くコストも高くなります。0でグローバルのデフォルトを使用します。",
      useGlobalDefault: "0 = グローバルのデフォルト",
      storageProvider: "画像ストレージ",
      storageProviderDesc:
        "アップロードした画像のストレージエンジン。空欄の場合はシステムのデフォルトを使用します",
    ...
    audioUpload: {
      ...
      asrModel: "ASRモデル",
      asrModelDesc:
        "音声の文字起こしに使用する音声認識モデル。未設定の場合、音声ファイルはプレースホルダとして渡されます。",
    ...
    chatParser: {
      ...
      waitTimeoutDesc:
        "1回の会話ターンで、解析中の添付ファイルを待つ最長時間です。この時間を超えると、解析が完了したファイルだけで回答を続行します。大きなファイルやスキャン文書では長めに設定してください。0でグローバルのデフォルトを使用します。",
    },
    faq: {
      title: "FAQ優先戦略",
      enableLabel: "FAQ優先を有効化",
      enableDesc:
        "FAQの回答が通常のドキュメントより優先され、応答の正確性が向上します",
      thresholdLabel: "直接回答のしきい値",
      thresholdDesc:
        "質問とFAQの類似度がこの値を超えた場合、FAQの回答をそのまま使用します",
    ...
    dataAnalysis: {
      ...
      enableDesc:
        "検索されたチャンクがCSV/Excelファイル由来の場合、回答前にLLMにDuckDB SQLクエリを生成させます。LLMの呼び出しが1回増え、数秒の遅延が発生するため、SQLによる分析が本当に必要な場合のみ有効にしてください。",
    },
    fallback: {
      fixed: "固定応答",
      model: "モデル生成",
  ...
  datasource: {
    title: "データソース",
    description:
      "このナレッジベースにコンテンツを同期する外部データソースを設定します",
    add: "データソースを追加",
    empty: "データソースが設定されていません",
    edit: "編集",
    delete: "削除",
    deleteConfirm:
      "このデータソースを削除しますか？同期済みのナレッジは削除されません。",
    ...
    gitlab: {
      ...
      projects: "GitLabプロジェクト",
      projectsHint:
        "プロジェクトIDまたはネームスペースのパス（例: group/project）を入力します。ブランチとディレクトリは任意です。",
      project: "プロジェクト",
      projectId: "プロジェクトID",
      projectIdPlaceholder: "例: 12345またはgroup/project",
      ref: "ブランチ",
      refPlaceholder: "空欄の場合はデフォルトブランチを使用します",
      paths: "ディレクトリ",
      pathsPlaceholder:
        "1行に1つのディレクトリを入力します。空欄の場合はプロジェクト全体を同期します",
      addProject: "プロジェクトを追加",
      projectRequired: "GitLabプロジェクトを1つ以上追加してください",
    },
    ...
    noResourcesDesc:
      "コンテンツを取得するには、グループチャット経由でアプリにWikiのアクセス権限を付与する必要があります",
    noResourcesDesc_notion:
      "コンテンツを取得するには、アプリにNotionページのアクセス権限が必要です",
    retryLoadResources: "再試行",
    guideStep1:
      "Feishuでグループチャットを作成し、グループ設定でアプリをボットとして追加します",
    guideStep2:
      "Wikiの「設定」>「メンバー設定」>「メンバーを追加」を開き、グループチャットを検索して追加します",
    guideStep3:
      "グループチャットのロールが「閲覧可能」以上であることを確認し、戻って「再試行」をクリックします",
    guideStep1_notion: "同期したいページまたはデータベースをNotionで開きます",
    guideStep2_notion:
      "右上の「···」メニューをクリックし、「Connect to」または「Add connections」を選択します",
    guideStep3_notion:
      "作成したIntegrationアプリを検索して選択し、戻って「再試行」をクリックします",
    ...
    syncDeletions:
      "削除を同期（同期元で削除されたナレッジをナレッジベースからも削除）",
    createAndSync: "作成して今すぐ同期",
    createAndSyncSuccess: "データソースを作成し、同期タスクを送信しました",
    createButSyncFailed:
      "データソースを作成しましたが、同期の開始に失敗しました",
    updateSuccessSyncHint:
      "データソースを更新しました。編集しただけでは同期は自動的に開始されません。変更を取り込むには「同期」をクリックしてください。",
    saveFailed: "保存に失敗しました",
    step: {
      selectType: "タイプを選択",
      credentials: "認証情報",
    ...
    connectorDesc: {
      feishu:
        "Feishu Wikiからドキュメント、スプレッドシート、ファイルを同期します",
      lark: "Lark Wiki（Feishu国際版）からドキュメント、スプレッドシート、ファイルを同期します",
      feishu_drive:
        "Feishu Driveのフォルダからドキュメント、スプレッドシート、ファイルを同期します",
      lark_drive:
        "Lark Drive（Feishu国際版）のフォルダからドキュメント、スプレッドシート、ファイルを同期します",
    ...
    drive: {
      ...
      folderTokenPlaceholder:
        "folder_tokenまたはFeishu DriveのフォルダURLを入力してください",
      folderTokenRequired:
        "具体的なfolder_tokenを入力してください。クラウドスペースのルートは非対応です",
      rootNotSupportedHint:
        "ルートフォルダはページングに対応せず、ショートカットも返されません。具体的なフォルダを選択してください",
      load: "読み込み",
      shareHint:
        "先にDriveフォルダをアプリのグループに共有してください。共有しないとアプリはアクセスできません",
      placeholderTitle: "まずDriveフォルダを読み込んでください",
      placeholderDesc:
        "上部にfolder_token（またはFeishu DriveのフォルダURL）を入力し、「読み込み」をクリックしてください",
      loadForbiddenHint:
        "アプリにこのフォルダへのアクセス権がありません。Feishu Driveでフォルダをアプリのグループに共有してから再試行してください。",
      loadAuthHint:
        "アプリの認証情報が無効か、Driveのスコープが不足しています。App ID / App Secretとdrive:drive:readonly権限を確認してください。",
      loadNotFoundHint:
        "folder_tokenが存在しないか、削除されています。Feishu DriveのフォルダURLからコピーしたトークンを確認してください。",
    },
    field: {
      appId: "App ID",
      ...
      operatorIdHint:
        "このユーザーの権限でナレッジベースを読み取ります。DingTalkのユーザー詳細APIで取得してください。",
      ...
      baseUrl: "ベースURL（任意）",
      baseUrlHint:
        "空欄の場合はデフォルトのパブリッククラウドのアドレスを使用します。プライベート/エンタープライズ導入の場合や、リバースプロキシ経由でアクセスする場合は、カスタムアドレスを入力してください（例: https://api-proxy.example.com）。",
      feedUrls: "フィードURL",
      feedUrlsHint:
        "1行に1つのRSS / AtomフィードURLを入力します。複数のフィードを指定できます。",
      authHeaders: "カスタムヘッダー（任意）",
      authHeadersHint:
        "非公開フィード用です。1行に1つ「名前: 値」の形式で入力します（例: Authorization: Bearer xxxx）",
    },
    comingSoon: "近日対応予定",
    docHint: "認証情報の取得先:",
    openDoc: "ドキュメントを開く",
    ...
    prereqBarText_yuque:
      "初めてですか？クリックしてYuqueトークンの設定ガイドを表示",
    prereqStep1Brief_yuque: "Yuqueのパーソナルトークンを作成",
    prereqStep1Desc_yuque:
      "Yuqueにログイン → アバター → 設定 → トークン → 新しいトークン",
    prereqStep2Brief_yuque: "トークンに必要な権限を付与",
    prereqStep2Desc_yuque:
      "少なくともrepo:readとdoc:read（ナレッジベースとドキュメント内容の読み取り）にチェックを入れます",
    prereqStep3Brief_yuque:
      "（任意）エンタープライズ導入の場合はベースURLを入力",
    prereqStep3Desc_yuque:
      "パブリッククラウドの場合は空欄のままにします。Yuque Enterpriseやセルフホストの場合は、自社のドメインを入力してください。",
    prereqStep1Brief_feishu: "Feishuのカスタムアプリを作成",
    prereqStep1Desc_feishu:
      "Feishuオープンプラットフォームにログイン → 企業向けカスタムアプリを作成",
    prereqStep2Brief_feishu: "ボット機能を追加",
    prereqStep2Desc_feishu:
      "オープンプラットフォーム → 対象アプリ → アプリ機能を追加 → ボット",
    prereqStep3Brief_feishu: "アプリの権限を設定",
    prereqStep3Desc_feishu:
      "wiki:wiki:readonly、drive:drive:readonly、drive:export:readonly、docx:document:readonlyの権限を有効にします",
    prereqStep1Brief_lark: "Larkのカスタムアプリを作成",
    prereqStep1Desc_lark:
      "Larkオープンプラットフォームにログイン → 企業向けカスタムアプリを作成",
    ...
    prereqStep3Desc_feishu_drive:
      "drive:drive:readonly、drive:export:readonly、docx:document:readonlyの権限を有効にします",
    ...
    syncError: {
      dingtalk_document_failed:
        "DingTalkドキュメントを読み取れません。アクセス権限を確認して同期を再試行してください。",
      dingtalk_resource_failed:
        "DingTalkリソースを利用できません。アクセス権限と選択したリソースを確認して再試行してください。",
      deletion_lookup_failed:
        "削除前の項目の照会に失敗しました。サーバログを確認してください",
  ...
  integrations: {
    cli: {
      title: "WeKnora CLI",
      subtitle:
        "ターミナルからナレッジベースとドキュメントの管理、コンテンツの検索、質問ができます。CLIやMCPを通じてスクリプトやAIツールと連携できます。",
      docs: "CLIドキュメント",
      docsHint: "インストール手順と完全なコマンドリファレンス",
      quickstart: "クイックスタート",
      installTitle: "CLIをインストール",
      installDesc:
        "GitとGo 1.26以上を使ってソースからビルドします。このmacOS / Linuxの例ではPATHの設定は現在のターミナルでのみ有効です。継続的に使う場合は、バイナリをPATH上のディレクトリに配置してください。",
      connectTitle: "このサーバに接続",
      connectDesc:
        "weknoraという名前のプロファイルを作成して有効化し、メールアドレスとパスワードでサインインします。同名のプロファイルが既にある場合は別の名前を選び、MCPの例もそれに合わせて変更してください。",
      verifyTitle: "接続を確認",
      verifyDesc:
        "サーバと認証の状態を確認し、アカウントがアクセスできるナレッジベースを一覧表示します。",
      commandsTitle: "よく使うコマンド",
      commandsDesc:
        "KB_IDをナレッジベースIDに置き換え、ファイルパス・検索語・質問を必要に応じて変更してください。アップロードしたドキュメントは解析が完了するまで検索できません。",
      mcpTitle: "MCPクライアントに接続",
      mcpDesc:
        "サインイン後、この設定をstdio対応のMCPクライアントに追加してください。クライアントがweknoraを見つけられない場合は、commandをバイナリの絶対パスに変更してください。",
      copy: "コピー",
      copied: "コピーしました",
    },
    title: "公開と連携",
    ...
    api: {
      title: "API連携",
      subtitle:
        "REST APIで連携し、リクエストがエンドユーザをどのように識別するかを設定します。",
      ...
      directHostBaseUrl: "Direct host API URL",
      directHostBaseUrlDesc:
        "The VOS package maps the RAG API to host port 29081 by default, so LAN or external systems can call it directly. If the install port was changed, use the installed value.",
      externalGuideTitle: "External API quick reference",
      externalGuideDesc:
        "External services can call HybRAG through the VOS app path or through the direct host port. HybRAG supports both personal user API keys and VOS/OAuth bearer tokens.",
      externalGuideAuthTitle: "Authentication",
      externalGuideAuthDesc:
        "Option 1: an ordinary user creates a personal API key here, and the external app sends X-API-Key. A personal key only inherits that user’s knowledge-base scope and does not need an admin-issued key. Option 2: the external app obtains that user’s VOS/OAuth token and sends Authorization: Bearer <VOS token>; HybRAG verifies it and runs with the mapped user permissions.",
      externalGuideSessionTitle: "Session",
      externalGuideSessionDesc:
        "Create a session with POST /sessions first, then pass the returned id to /knowledge-chat/:session_id or /agent-chat/:session_id.",
      externalGuideKbTitle: "Knowledge scope",
      externalGuideKbDesc:
        "Pass knowledge_base_ids in the request body. API keys can also be restricted to selected knowledge bases when created.",
      externalGuideRagExample: "RAG Chat example",
      externalGuideRagStep:
        "# 2. RAG chat (SSE; replace <session_id> with the id returned by step 1)",
      externalGuideQuestion: "What are the key points in this knowledge base?",
      apiKeys: "APIキー",
      apiKeysDesc:
        "連携ごとに個別のキーを作成し、操作権限とナレッジベースへのアクセス範囲を制限できます。",
      createApiKey: "APIキーを作成",
      createApiKeyDialogDesc:
        "このキーに付与する権限とナレッジベースの範囲を選択します。",
      ...
      apiKeyCapabilitiesRequired:
        "範囲指定のAPIキーには権限を1つ以上選択してください",
      apiKeyAccessMode: "アクセスモード",
      apiKeyScopedAccess: "範囲指定アクセス",
      apiKeyAccessType: "アクセスタイプ",
      apiKeyAccessTypeHint:
        "「ナレッジベース」は下記の権限レベルでナレッジベースの範囲内のみ操作します。「ワークスペース全体」はモデルやデータソースなど、すべてのワークスペースレベルAPIも利用できます。",
      personalApiKeyAccessTypeHint:
        "Ordinary users create personal API keys. They only apply to the current account, can retrieve/chat/ingest selected knowledge bases, cannot grant full workspace access, and do not need an admin-issued key.",
      ...
      capabilityTenantFullHint:
        "モデル、ベクトルストア、データソース、チャネルを含むすべてのワークスペースレベルAPIを許可します。ナレッジベースの範囲指定は適用されません。",
      capabilityRetrieve: "ナレッジベースの検索",
      capabilityRetrieveHint:
        "選択したナレッジベースの範囲内でデータの読み取り、クエリ、検索を行います。セッションの作成やコンテンツの変更はできません。",
      capabilityChat: "チャット",
      capabilityChatHint:
        "このキーで会話を行い、自身のセッションを管理できます。ナレッジベースのコンテンツは変更できません。",
      capabilityReadAgents: "エージェントの読み取り",
      capabilityReadAgentsHint:
        "エージェントの一覧、詳細、プリセット、推奨質問を読み取ります。チャットやエージェントの編集はできません。",
      capabilityIngest: "ナレッジベースへの書き込み",
      capabilityIngestHint:
        "許可されたナレッジベースにコンテンツを書き込めます（ドキュメントのアップロード、チャンク・FAQ・タグ・Wikiの編集）。ナレッジベースやエージェントの作成、ナレッジベースの中身の一括削除はできず、選択したナレッジベースの範囲に限定されます。",
      capabilityManageKbs: "ナレッジベースの管理",
      capabilityManageKbsHint:
        "ナレッジベースのライフサイクル全体（作成、コピー、更新、削除、初期化・設定の変更）を管理できます。既存のナレッジベースへの操作（コピー・更新・削除）は選択した範囲に限定されます。新規作成に制限はありません（新しいナレッジベースはこのスペースに属します）。",
      capabilityManageAgents: "エージェントの管理",
      capabilityManageAgentsHint:
        "エージェントの作成、更新、削除、コピーができます。エージェント設定には機密性の高いモデルやMCPのバインドが含まれる場合があるため、デフォルトでは無効です。必要な場合のみ有効化してください。",
      capabilityMessageHistory: "メッセージ履歴",
      capabilityMessageHistoryHint:
        "ワークスペースのチャット履歴の検索と、チャット履歴の統計の読み取りができます。ワークスペース設定へのアクセス権は付与されません。",
      capabilityManageModels: "モデルの管理",
      capabilityManageModelsHint:
        "モデル定義、認証情報、接続確認、WeKnoraCloudの認証情報を管理します。",
      capabilityManageMcpServices: "MCPサービスの管理",
      capabilityManageMcpServicesHint:
        "このプリンシパルのMCPサービス、認証情報、ツール承認ポリシー、OAuth状態を管理します。",
      capabilityManageDatasources: "データソースの管理",
      capabilityManageDatasourcesHint:
        "データソースのコネクタ、認証情報、リソース選択、同期ジョブを管理します。ソースがナレッジベースにバインドされている場合は、ナレッジベースの範囲指定も適用されます。",
      capabilityManageChannels: "チャネルの管理",
      capabilityManageChannelsHint:
        "エージェントの埋め込みチャネル、IMチャネル、WeChatのQRコード連携フローを管理します。",
      capabilityManageVectorStores: "検索インフラの管理",
      capabilityManageVectorStoresHint:
        "ベクトルストアの設定に加え、パーサー、ドキュメントリーダー、ストレージエンジンの接続確認を管理します。",
      capabilityManageStorageBackends: "ストレージバックエンドの管理",
      capabilityManageStorageBackendsHint:
        "オブジェクト/ファイルストレージのバックエンドインスタンス（S3互換やローカルファイルストレージなど）について、作成・更新・削除、接続テスト、ワークスペースデフォルトの選択を管理します。",
      capabilityManageWebSearch: "Web検索の管理",
      capabilityManageWebSearchHint:
        "Web検索プロバイダの設定、認証情報、接続テストを管理します。",
      capabilityRunEvaluations: "評価の実行",
      capabilityRunEvaluationsHint:
        "評価ジョブを実行し、評価結果を読み取ります。",
      capabilityManageMembers: "メンバーの管理",
      capabilityManageMembersHint:
        "ワークスペースのメンバー、ロール、招待、招待リンクの一覧表示と管理を行います。APIキーの管理、ワークスペースの削除、オーナー権限の移譲は含まれません。",
      capabilityManageSpaces: "スペースの管理",
      capabilityManageSpacesHint:
        "組織スペース、参加フロー、スペースのメンバー、招待、共有スペースの公開範囲を管理します。ナレッジベースやエージェントの共有管理権限は付与されません。",
      capabilityManageTenantSettings: "ワークスペース設定の管理",
      capabilityManageTenantSettingsHint:
        "APIのエンドユーザ識別モード、リクエストヘッダー設定、ワークスペースのKV設定など、ワークスペースレベルの連携設定を読み取り・更新します。APIキーの管理、メンバー管理、ワークスペースの削除、オーナー権限の移譲は含まれません。",
      apiKeyKnowledgeScope: "ナレッジベース",
      apiKeyKnowledgeScopePlaceholder:
        "空欄の場合はすべてのナレッジベースを許可します",
      personalApiKeyKnowledgeScopePlaceholder:
        "Select the knowledge bases this personal API key may access",
      personalApiKeyKnowledgeScopeHint:
        "Personal API keys must be bound to selected knowledge bases visible to the current user.",
      personalApiKeyKnowledgeScopeRequired:
        "Select at least one knowledge base for a personal API key",
      allKnowledgeBases: "すべてのナレッジベース",
      editApiKeyScope: "APIキーを編集",
      editApiKeyScopeDesc: "APIキー「{name}」の名前と認可範囲を変更します。",
      editApiKeyScopeHint:
        "空欄の場合はこのワークスペース内のすべてのナレッジベースを許可します。変更はすべて即座に反映されます。",
      ...
      deleteApiKey: "削除",
      deleteApiKeyConfirm:
        "削除するとこのAPIキーは即座に無効化され、これを使用している連携は動作しなくなります。",
      ...
      principalModeDesc:
        "APIリクエストがエンドユーザをどのように識別するかを選択します。この識別情報により、会話セッションとMCPツールの認可がユーザごとに分離されます。",
      principalScope:
        "エンドユーザの識別はセッションとMCP OAuthを分離します。操作権限とナレッジベースの範囲は上記のAPIキーで制御します。",
      modeTenant: "ワークスペースのみ",
      modeDirect: "ユーザIDを直接指定",
      modeSigned: "署名付きトークン",
      directWarning:
        "ユーザIDの直接指定は、呼び出し元が渡すヘッダーを信頼します。信頼できるサーバ間通信でのみ使用してください。",
      directWarningDetail:
        "APIキーを持つ人であれば誰でもユーザIDヘッダーを書き換えて他の外部ユーザになりすまし、そのユーザのMCP OAuth認可を再利用・乗っ取ることができます。ブラウザや信頼できないクライアントからは使用せず、エンドユーザ向けアプリでは署名付きトークンを使用してください。",
      signedRecommended:
        "ユーザ向けアプリに推奨: 自社バックエンドで外部ユーザ用に有効期間の短いHS256 JWTを発行します。",
      signedFlowDetail:
        "HMACシークレットはWeKnoraと信頼できる自社バックエンドにのみ保存し、リクエストに含めたりブラウザに配布したりしないでください。リクエストヘッダーで送るのは、そのシークレットで署名したJWT文字列（発行ごと、または有効期限切れ後に変わります）であり、シークレット自体ではありません。JWTにはsub（外部ユーザID）、tenant_id、aud=weknora、exp（有効期間は最大24時間）を含める必要があります。",
      directHeader: "ユーザIDヘッダー",
      requireDirectHeader: "ユーザIDヘッダーを必須にする",
      requireDirectHeaderDesc:
        "有効にすると、ユーザIDヘッダーのないAPIキーリクエストは拒否されます。無効の場合、すべてのリクエストはユーザを区別せずワークスペース全体として扱われます。",
      tokenHeader: "トークンヘッダー",
      tokenHeaderDesc:
        "クライアントはバックエンドで署名したJWTをこの固定ヘッダーで送信します。",
      hmacSecret: "HMACシークレット",
      hmacSecretDesc:
        "WeKnoraに保存されているものと同じシークレットです。JWTの署名のためバックエンドでのみ使用し、リクエストヘッダーとして送信しないでください。",
      secretConfigured:
        "シークレットは設定済みです（再表示されません）。ローテーションするには新しい値を入力してください",
      secretSavedCopyHint:
        "シークレットを保存しました。このページを離れると再表示できないため、今すぐバックエンドにコピーしてください。",
      generateSecret: "シークレットを生成",
      hmacSecretResetConfirmTitle: "HMACシークレットをリセットしますか？",
      hmacSecretResetConfirmBody:
        "リセットすると、古いHMACシークレットは即座に無効化されます。古いシークレットでJWTに署名しているすべてのバックエンドサービスは、署名付きトークンでの呼び出しを継続するために新しいシークレットへ切り替える必要があります。この操作は取り消せません。",
      hmacSecretResetConfirmOk: "リセット",
      hmacSecretResetConfirmCancel: "キャンセル",
      tokenSignExample: "バックエンドでのJWT署名サンプル（Go）",
      signedRequestStep0:
        "# 0.バックエンドでJWTに署名（HS256、aud=weknora、sub=ユーザID、tenant_id={tenantId}、exp<=24h）",
      signedRequestStep0Hint:
        "#    HMACシークレットではなくJWTを{headerName}に設定します",
      requestExampleCreateSession: "# 1.セッションを作成",
      requestExampleAgentChat:
        "# 2.エージェントチャット（SSE。<session_id>はステップ1で取得したIDに置き換えてください）",
      requestExampleJwtPlaceholder: "<バックエンドで署名したJWT>",
      requestExample: "リクエスト例",
      playgroundTitle: "API Playground",
      playgroundDesc:
        "現在のAPIキーと識別モードで実際のリクエストを送信し、セッション作成、エージェントチャット、SSE出力を検証します。",
      playgroundOpen: "Playgroundを開く",
      playgroundDrawerDesc:
        "実際のAPI連携フローでセッション、エージェントチャット、SSE出力をデバッグします",
      ...
      playgroundTenantModeHint:
        "ワークスペースのみモードでは外部ユーザの識別情報を送信しません。すべてのAPIセッションが同じワークスペースレベルのプリンシパルを使用します。",
      playgroundDirectModeHint:
        "このユーザIDは{headerName}ヘッダーで送信されます。",
      playgroundSignedModeHint:
        "署名付きトークンモードでは、JWTのsubを外部ユーザとして使用します。PlaygroundはこのユーザID用に有効期間の短いテスト用JWTを発行します。",
      playgroundQuestion: "テスト用の質問",
      playgroundQuestionPlaceholder:
        "エージェントに送信する質問を入力してください",
      ...
      playgroundMintTokenFailed:
        "有効期間の短いテスト用JWTの作成に失敗しました。",
      playgroundMissingSessionId:
        "セッションの作成には成功しましたが、レスポンスにセッションIDが含まれていませんでした。",
      playgroundNoStream:
        "チャットAPIから読み取り可能なSSEストリームが返されませんでした。",
      ...
      playgroundEmptyResult:
        "テストを実行すると、セッションのレスポンス、生のSSE出力、抽出された回答がここに表示されます。",
      ...
      autoSaveNeedSecret:
        "署名付きトークンモードでは、自動保存の前にHMACシークレットが必要です。",
    },
    ...
    chrome: {
      title: "ナレッジアシスタント",
      subtitle:
        "セルフホスト版WeKnora向け: ブラウジング中にサイドバーで質問したり、Webページをクリップしたり、Markdownメモをナレッジベースに保存したりできます。",
    ...
    claw: {
      title: "WeKnora Skill",
      subtitle:
        "WeKnora REST API経由でドキュメントをインポートし、ハイブリッド検索（ベクトル＋キーワード）を実行します。ファイルのアップロード、URLインポート、Markdownでの登録、ナレッジベース横断検索に対応します。",
      ...
      ecosystemNote:
        "スキルはClawHub（{'@'}lyingbug/weknora）でホストされています。完全なAPIドキュメントとバージョン履歴はClawHubページをご覧ください。",
  ...
  credential: {
    ...
    confirmRemovePrompt:
      "この認証情報を削除してもよろしいですか？この操作は取り消せません。",
    confirmRemove: "削除",
  },
  userProfile: {
    title: "ユーザ情報",
    description:
      "アカウント情報（ユーザID、ユーザ名、メールアドレス、登録日時）を確認し、パスワードを変更できます。",
    changePassword: {
      label: "パスワードを変更",
      description:
        "現在のパスワードを確認してから新しいパスワードを設定します。ログイン中のすべてのセッションは無効化され、再度ログインが必要になります。",
      ...
      policyFailed:
        "新しいパスワードは8〜32文字で、英字と数字を含める必要があります",
      sameAsCurrent: "新しいパスワードは現在のパスワードと異なる必要があります",
      oidcOnlyDescription:
        "このアカウントはOIDCログインで作成されたため、ローカルパスワードが設定されていません。",
      oidcOnlyNotice:
        "システム管理者にパスワードのリセットを依頼するか、引き続きOIDCでログインしてください。セルフサービスでの変更には現在のパスワードが必要です。",
    },
  },
  tenantMember: {
    title: "メンバー管理",
    sectionDescription:
      "ワークスペースにメンバーを招待し、ロールを管理します。メンバーの追加と削除はオーナーのみ行えます。",
    ...
    remove: {
      button: "削除",
      confirmBody:
        "{name}をこのワークスペースから削除してもよろしいですか？このユーザはすぐにアクセスできなくなります。",
      confirm: "削除",
      success: "メンバーを削除しました",
    },
    leave: {
      ...
      confirmBody:
        "このワークスペース内のすべてのナレッジベースとエージェントにアクセスできなくなります。後で再度招待してもらうことは可能です。",
      confirm: "退出",
    ...
    errors: {
      ...
      userNotFound:
        "このメールアドレスで登録されたユーザはいません。先に登録を依頼してください。",
      lastOwner:
        "最後のオーナーの降格・削除・退出はできません。先に他のメンバーをオーナーに昇格させてください。",
      notFound: "メンバーシップが見つかりません。",
      invalidRole:
        "ロールはowner / admin / contributor / viewerのいずれかである必要があります。",
      generic: "問題が発生しました。もう一度お試しください。",
    },
    audit: {
      tabLabel: "監査ログ",
      description:
        "このワークスペース内のメンバー変更とアクセス拒否をすべて記録します。新しい順に表示され、1分以内に繰り返された拒否はまとめられます。",
      refresh: "更新",
      end: "ログの末尾です。",
  ...
  tenantInvitation: {
    ...
    shareLink: {
      ...
      description:
        "グループチャットなどに貼れる、複数人が使える登録リンクを生成します。リンクを開いた人は自分のメールアドレスで登録し、このワークスペースに参加できます。有効期限は{days}日で、一覧からいつでも取り消せます。",
      generate: "リンクを生成",
      resultTitle: "招待リンクを生成しました",
      resultBody:
        "下のリンクをコピーして、プライベートなチャネルで招待相手に共有してください。リンクは一覧にも保存されるため、後から再コピーや取り消しができます。",
      revokeConfirm:
        "取り消すと、まだ登録していない人はこのリンクを使用できなくなります。再共有するには新しいリンクを生成してください。",
    },
    revoke: {
      button: "取り消し",
      confirmBody:
        "取り消すと、{email}はこの招待を承諾できなくなります。必要に応じて新しい招待を送信してください。",
      confirm: "取り消し",
      success: "招待を取り消しました。",
    },
    columns: {
    ...
    myInbox: {
      title: "自分への招待",
      description:
        "他のワークスペースからの招待です。承諾すると、割り当てられたロールで参加します。",
      empty: "保留中の招待はありません。",
      acceptButton: "承諾",
      declineButton: "辞退",
  ...
  platformApiKeys: {
    title: "プラットフォームAPIキー",
    description:
      "ワークスペース横断の自動化のためのプラットフォーム認証情報を作成します。ワークスペースAPIを呼び出す際は、X-Tenant-IDで対象のワークスペースを指定します。",
    securityNotice:
      "プラットフォームAPIキーは任意のワークスペースを対象にできます。必要な権限のみを付与してください。平文は一度だけ表示されます。",
    create: "プラットフォームAPIキーを作成",
    createDescription:
      "プラットフォームキーは特定のワークスペースに紐づきませんが、すべての操作は付与された権限の範囲に制限されます。",
    loading: "読み込み中…",
    ...
    capabilityHint:
      "ワークスペース権限はX-Tenant-IDで指定した対象に適用され、システム権限はコントロールプレーンAPIに適用されます。",
    lastUsed: "最終使用",
    createdAt: "作成日時",
    actions: "操作",
    never: "未使用",
    ...
    capabilityHints: {
      tenantsRead:
        "すべてのワークスペースの一覧表示、検索、詳細確認を行います。",
      tenantsManage:
        "ワークスペースの作成、更新、削除と、グローバルなワークスペース設定の適用を行います。",
      settingsRead: "プラットフォームのランタイム設定を読み取ります。",
      settingsManage:
        "プラットフォームのランタイム設定を更新・リセットします。",
      runtimeRead: "タスクキューとタスクの詳細を確認します。",
      runtimeManage:
        "ランタイムタスクの再試行、実行、キャンセル、削除を行います。",
      auditRead: "プラットフォームの監査イベントを読み取ります。",
    },
    createdTitle: "プラットフォームAPIキーを作成しました",
    createdDescription:
      "このキーを今すぐコピーして保管してください。完全な値は再表示されません。",
    copy: "キーをコピー",
    copySuccess: "キーをコピーしました",
    deleteConfirm:
      "「{name}」を削除しますか？このキーを使用している自動化は即座に停止します。",
  ...
  mcpMetadata: {
    ...
    next: "次へ",
    policyLoadFailed:
      "ツール設定を読み込めません。編集前に再試行してください。",
    policySaveFailed: "ツール設定を保存できませんでした",
    tools: "Tools 一覧",
    cacheHint:
      "未同期の場合はこの手順で自動接続して保存します。以降は更新時のみ MCP サーバーに接続します。",
    refresh: "Tools を更新",
    fetch: "再取得",
    fetching: "接続して Tools を取得しています…",
    toolCount: "{count} 件のツール",
    stale:
      "接続または認証設定が変更されました。モデルで使用する前に一覧を更新してください。",
    notSynced: "未同期です。取得すると説明とパラメーター定義が保存されます。",
    syncRequired:
      "先に接続して Tools を取得してください。モデルは同期済みの一覧のみ使用できます。",
    needsRefresh: "更新が必要",
    saved: "保存済み",
    syncedAt: "同期日時：",
    serverDocumentation: "サーバーの元の説明",
    noServerDocumentation:
      "この MCP サーバーの initialize に instructions / serverInfo.description はありません（どちらも任意）。ツールの説明は下の各 description にあります。",
    policyHint:
      "ツールの有効化と承認設定は即時保存され、一覧の更新後も維持されます。",
    ...
    usage: "サービスの用途",
    usageHint:
      "モデルはこの概要を読んでから必要なツールを読み込みます。更新しても入力内容は保持されます。",
    summary: "用途の概要",
    summaryPlaceholder: "例：注文状況、配送状況、返金履歴を確認する。",
    usageInstructions: "使用方法",
    instructionsPlaceholder:
      "サービスの用途、利用場面、重要な制約を簡潔に記載してください。",
    generateUsage: "AI で生成",
    generateHint:
      "同期済みの有効なツールから簡潔な説明を生成します。編集して保存すると反映されます。",
    instructionsRequired: "使用方法を入力してください",
    generated: "生成しました。内容を確認して保存してください。",
    generateFailed:
      "生成に失敗しました。ツールの同期と利用可能なチャットモデルの設定を確認して再試行してください。",
    saveNext: "保存して次へ",
  },
};
