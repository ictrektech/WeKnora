export default {
  ...
  legalAssistant: {
    eyebrow: 'Юридическое рабочее пространство', title: 'Юридический помощник', description: 'Быстро находите основания в договорах, нормах и внутренних материалах и получайте проверяемые юридические ответы.', sessions: 'Юридические сессии', workspaceUnavailable: 'Юридическое рабочее пространство недоступно. Возвращаемся в базу знаний.', createFailed: 'Не удалось создать сессию юридического помощника.'
  },
