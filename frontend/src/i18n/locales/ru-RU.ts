export default {
  ...
  smartArchive: {
    ...
    mirrorRetryFailed: "Не удалось повторить синхронизацию зеркала.",
    mirrorErrorDetails: "Причина сбоя синхронизации",
    document: "Документ",
    type: "Тип",
    customer: "Клиент",
    ...
    taskProgress: "Этапы извлечения",
    taskProgressElapsed: "Примерно {seconds} с с момента последнего обновления записи",
    taskMirrorStatus: "Синхронизация базы знаний",
    stageLabels: {
      queued: "В очереди",
      content: "Обработка содержимого",
      fields: "Извлечение полей",
      linking: "Связывание",
