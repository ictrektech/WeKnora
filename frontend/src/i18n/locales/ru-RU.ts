export default {
  ...
  legalAssistant: {
    eyebrow: 'Юридическое рабочее пространство', title: 'Юридический помощник', homeGreeting: 'Здравствуйте, я LexAI. Чем помочь вам сегодня по юридическим вопросам?', description: 'Быстро находите основания в договорах, нормах и внутренних материалах и получайте проверяемые юридические ответы.', sessions: 'Юридические сессии', workspaceUnavailable: 'Юридическое рабочее пространство недоступно. Возвращаемся в базу знаний.', createFailed: 'Не удалось создать сессию юридического помощника.'
  },
  legalWorkspaceSettings: {
    ...
    introDescription: 'После включения участники пространства смогут открыть юридическое рабочее пространство в левой навигации и использовать проверку договоров.',
    enableLabel: 'Включить юридическое рабочее пространство',
    enableDescription: 'Отключение только скрывает пункт меню. Записи проверок и загруженные исходные документы сохраняются.',
    saveSuccess: 'Настройки юридического рабочего пространства сохранены',
    saveFailed: 'Не удалось сохранить настройки юридического рабочего пространства: {message}',
    deleteTitle: 'Удалить данные юридического рабочего пространства',
    deleteDescription: 'Безвозвратно удаляет все проверки договоров, исходные документы, пункты и результаты в этом пространстве. Отменить нельзя.',
    deleteButton: 'Удалить все данные',
    deleteConfirmTitle: 'Удалить данные юридического рабочего пространства?',
    deleteConfirmBody: 'Будут безвозвратно удалены все проверки договоров, загруженные исходные документы, пункты и результаты текущего пространства. Восстановление невозможно. Отключение переключателя выше эти данные не удаляет. Подтвердите продолжение.',
  ...
  contractReview: {
    ...
    subtitle: 'Загрузите договор, чтобы проверить риски, рекомендации и основания по пунктам.',
    ...
    bulkArchiveRunningConfirm: 'Некоторые проверки выполняются. Всё равно архивировать?',
    bulkRestoreConfirm: 'Восстановить выбранные проверки?',
    bulkDeleteConfirm: 'Удалить выбранные проверки?',
    bulkDeleteRunningConfirm: 'Некоторые проверки выполняются. Всё равно удалить?',
    ...
    readyDescription: 'Выберите настройки проверки, чтобы проанализировать договор.',
    ...
    modelsLoadFailed: 'Не удалось загрузить список моделей; будет использована модель по умолчанию',
    ...
    reconfigureDescription: 'Измените сторону, правила или модель и запустите снова.',
    cancel: 'Отмена',
    cancelReview: 'Отменить проверку',
    cancelReviewConfirm: 'Отменить эту проверку договора? Промежуточные результаты сохранятся, и проверку можно будет повторить.',
    ...
    evidenceLocatorUnsupported: 'Стабильные местоположения оснований недоступны; надежная подсветка отключена.',
    evidenceLocatorFailed: 'Не удалось загрузить местоположения оснований; стабильная подсветка временно недоступна.',
    ...
    summaryUnavailable: 'Обзор недоступен; проверьте подробности найденных проблем.',
    qualityWarnings: 'Примечания для проверки результата',
    summaryDetailsMismatch: 'Сводные количества рисков не совпадают с подробностями проблем.',
    issuesNotLoaded: 'Подробности проблем еще не загружены, поэтому отсутствие проблем нельзя подтвердить.',
