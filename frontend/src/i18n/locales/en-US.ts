export default {
  ...
  integrations: {
    ...
    api: {
      ...
      externalGuideDesc: 'External services can call the current HybRAG REST API directly. HybRAG supports both personal user API keys and VOS/OAuth bearer tokens.',
