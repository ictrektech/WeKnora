export default {
  ...
  integrations: {
    ...
    api: {
      ...
      externalGuideDesc: 'External services can call the current HybRAG REST API directly without opening the app inside VOS.',
      externalGuideAuthTitle: 'Authentication',
      externalGuideAuthDesc: 'Recommended: create a dedicated API key for the service and send X-API-Key. Browser login tokens can also use Authorization: Bearer <token>.',
