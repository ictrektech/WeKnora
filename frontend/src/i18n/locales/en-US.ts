export default {
  ...
  uploadConfirm: {
    ...
    tagsDescription:
      "Select one or more tags for every document in this import batch",
    ...
    multimodalSetupHint:
      "Images detected. Enable multimodal and select a model.",
    asrSetupHint:
      "Audio detected. Enable speech recognition and select a model.",
    ...
    asrModelSelectRequired:
      "Speech recognition is enabled. Please select an ASR model.",
    pdfForceScanned: {
  ...
  knowledgeEditor: {
    ...
    faq: {
      ...
      batchDelete: "Delete selected",
      confirmBatchDelete:
        "Delete the selected {count} FAQ entries? This action cannot be undone.",
