export default {
  ...
  smartArchive: {
    ...
    taskProgress: "Extraction stages",
    taskProgressElapsed: "Approx. {seconds}s since last record update",
    taskMirrorStatus: "Knowledge-base sync",
    stageLabels: {
      queued: "Queued",
      content: "Processing content",
      fields: "Extracting fields",
      linking: "Linking",
