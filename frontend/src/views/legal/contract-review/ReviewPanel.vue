...
.evidence-status{font-size:10px;color:var(--legal-text-secondary)}.evidence-status--located{color:var(--legal-ai-strong)}.evidence-status--legacy_exact,.evidence-status--pending,.evidence-status--multiple_matches{color:var(--legal-warning-strong)}.evidence-status--not_found,.evidence-status--version_mismatch,.evidence-status--unsupported,.evidence-status--error{color:var(--legal-risk-strong)}
