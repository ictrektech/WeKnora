...
BEGIN
    IF to_regclass('public.tenant_skill_snapshots') IS NULL THEN
        RAISE NOTICE '[Migration 000088] tenant_skill_snapshots is created by migration 000094; deferring planned_name';
        RETURN;
    END IF;

    RAISE NOTICE '[Migration 000088] Adding planned_name to tenant_skill_snapshots';
