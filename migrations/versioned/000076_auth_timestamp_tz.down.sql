DO $$ BEGIN RAISE NOTICE '[Migration 000076 down] Reverting authorization timestamps to timestamp...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000076 down] Authorization timestamps reverted'; END $$;
