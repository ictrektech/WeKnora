DO $$ BEGIN RAISE NOTICE '[Migration 000082] Applying chunk editing and MCP OAuth refresh lease...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000082] Chunk editing and MCP OAuth refresh lease ready'; END $$;
