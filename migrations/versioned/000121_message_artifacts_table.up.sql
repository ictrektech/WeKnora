-- Migration: 000121_message_artifacts_table
...
DO $$ BEGIN RAISE NOTICE '[Migration 000121] Creating message_artifacts table'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000121] Backfilling message_artifacts from messages.artifacts'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000121] Clearing legacy messages.artifacts'; END $$;
