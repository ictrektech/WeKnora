...
QA/VLM Ollama 默认模型名为 `qwen3.5:2b`。普通 profile 默认 QA 总槽位 `8`、聊天预留 `2`、后台共享 `6`；embedding Ollama 总槽位 `4`、文档 embedding 使用 `2`。`thor-spark` 使用更高默认值：QA 总槽位 `20`、聊天预留 `6`、后台共享 `14`、embedding 总槽位 `16`、文档 embedding 使用 `8`。
